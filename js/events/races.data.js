...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Porter plainte et le faire savoir", "en": "File a complaint and say so" },
      "effects": { "score": -3, "popularity": -2, "credibilite": 2, "reputation": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Écrire un texte de rassemblement", "en": "Write a text everyone can live with" },
      ...
      "failure": { "effects": {"score": -3, "standing": -5, "credibilite": -2, "energie": -1},
...

{
  ...
  "choices": [
    { "label": { "fr": "Promettre des postes", "en": "Promise posts" },
      ...
      "success": { "effects": {"strike": "appareil", "score": 8, "reputation": -2, "landscape": {"self": -0.4}},
      ...
      "failure": { "effects": {"score": -4, "standing": -8, "reputation": -2, "reseau": -3},
...

{
  ...
  "choices": [
    { "label": { "fr": "Le désavouer immédiatement", "en": "Disown him immediately" },
      ...
      "failure": { "effects": {"score": -3, "standing": -11, "popularity": -2, "reseau": -2, "strike": "traitre"},
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire le meeting quand même, à fond", "en": "Do the rally anyway, full force" },
      ...
      "success": { "effects": {"score": 6, "energie": -2, "eloquence": 1, "notoriete": 2},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire campagne contre son bilan", "en": "Campaign against his record" },
      ...
      "success": { "effects": {"score": 2, "popularity": 9, "reputation": 2, "strike": "intrepide", "credibilite": 2},
      ...
      "failure": { "effects": {"score": -8, "popularity": -4, "standing": -7, "reseau": -2},

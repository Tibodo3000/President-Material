...

{
  ...
  "choices": [
    { "label": { "fr": "Faire campagne sur la dissolution elle-même", "en": "Campaign on the dissolution itself" },
      ...
      "success": { "effects": { "score": 5, "popularity": 5, "eloquence": 1, "notoriete": 1 },
    ...
    { "label": { "fr": "Se rassembler avec ceux d'à côté, vite et mal", "en": "Form a bloc with the neighbours, fast and badly" },
      ...
      "success": { "effects": { "score": 8, "reseau": 1, "standing": -5, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Parler du dossier que vous connaissez par cœur", "en": "Talk about the file you know by heart" },
      "roll": { "base": 13, "stat": "eloquence", "plus": { "reputation": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
    ...
    { "label": { "fr": "Promettre ce qui ne dépend pas de vous", "en": "Promise what does not depend on you" },
      "effects": { "score": 7, "reputation": -1, "strike": "menteur" },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire campagne seul", "en": "Campaign alone" },
      "roll": { "base": 15, "stat": "notoriete", "plus": { "popularity": 0.06, "charisme": 0.3 }, "bonus": [ { "when": { "trait": ["bete_scene"] }, "value": 2 }, { "when": { "trait": ["couple_people"] }, "value": 1.5 }, { "when": { "trait": ["has_been"] }, "value": -2 }, { "when": { "trait": ["albinos"] }, "value": 1 } ], "dice": 16 },
      "success": { "effects": { "score": 3, "credibilite": 1, "reputation": 1, "standing": -5 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Porter plainte et le faire savoir", "en": "File a complaint and say so" },
      "effects": { "score": -3, "popularity": -2, "credibilite": 1, "reputation": 1 },
    ...
    { "label": { "fr": "Trouver qui l'a payé", "en": "Find out who paid for it" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "score": 6 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Écrire un texte de rassemblement", "en": "Write a text everyone can live with" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "reseau": 0.35, "credibilite": 0.25 }, "bonus": [ { "when": { "trait": ["appareil"] }, "value": 2 }, { "when": { "personality": ["calculating", "clever"] }, "value": 1.5 }, { "when": { "background": ["academia", "law"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"strike": "appareil", "score": 9, "standing": 5, "popularity": -3, "reputation": -1},
      ...
      "failure": { "effects": {"score": -3, "standing": -5, "credibilite": -1, "energie": -1},
        "result": { "fr": "Quatre pages qui ne fâchent personne, sauf qu'une phrase sur l'Europe a été relue par deux courants et qu'aucun des deux ne la lit pareil. Les deux votent contre, pour des raisons opposées.",
                    "en": "Four pages that upset nobody, except that one sentence on Europe was read over by two factions and neither reads it the same way. Both vote against, for opposite reasons." } } },
    { "label": { "fr": "Écrire ce que vous pensez vraiment", "en": "Write what you actually think" },
      "effects": { "score": -4, "standing": -2, "credibilite": 1, "reputation": 1, "notoriete": 1,
                   "appeal": { "self": 8 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Promettre des postes", "en": "Promise posts" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "charisme": 0.35, "standing": 0.04 }, "bonus": [ { "when": { "personality": ["calculating"] }, "value": 2 }, { "when": { "trait": ["appareil"] }, "value": 2 }, { "when": { "trait": ["menteur"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"strike": "appareil", "score": 8, "reputation": -1, "landscape": {"self": -0.4}},
      ...
      "failure": { "effects": {"score": -4, "standing": -8, "reputation": -1, "reseau": -2},
        "result": { "fr": "Vous promettez la même commission à deux personnes dans le même couloir, à quarante minutes d'intervalle, et elles déjeunent ensemble le lendemain. Le congrès entier le sait avant le vote.",
                    "en": "You promise the same committee to two people in the same corridor, forty minutes apart, and they have lunch together the next day. The whole conference knows before the vote." } } },
    ...
    { "label": { "fr": "Faire le tour des quatre mille avec votre carnet", "en": "Work all four thousand with your address book" },
      ...
      "effects": { "score": 6, "reseau": 1, "standing": 3, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout mettre sur les indécis", "en": "Put everything into the undecided" },
      "roll": { "base": 14, "stat": "energie", "plus": { "charisme": 0.4 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2 }, { "when": { "trait": ["athletique"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 }, { "when": { "trait": ["epuise"] }, "value": -2 } ], "dice": 16 },
    ...
    { "label": { "fr": "Sortir votre argent personnel", "en": "Put in your own money" },
      ...
      "failure": { "effects": { "score": -2, "money": -28000, "reputation": -1, "popularity": -3 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Aller chercher une figure locale qui vous déteste", "en": "Go and get a local figure who dislikes you" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "reseau": 0.4 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
    ...
    { "label": { "fr": "Aller chercher les noms qui ouvrent des portes", "en": "Go after the names that open doors" },
      ...
      "effects": { "score": 5, "reseau": 2, "money": 15000, "standing": -3, "popularity": -3,
                   "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Raconter votre histoire ici, en détail", "en": "Tell your story here, in detail" },
      "roll": { "base": 13, "stat": "eloquence", "plus": { "reputation": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
    ...
    { "label": { "fr": "Répondre par le passé de votre adversaire", "en": "Answer with your opponent's own record" },
      "effects": { "score": 4, "reputation": -1, "strike": "intrepide" },
    ...
    { "label": { "fr": "Emmener la presse là où vous avez grandi", "en": "Take the press to where you grew up" },
      ...
      "effects": { "score": 6, "popularity": 4, "reputation": 1, "energie": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Localiser la campagne de force", "en": "Force the campaign back to local ground" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "energie": 0.4 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
    ...
    { "label": { "fr": "Prendre publiquement vos distances avec la direction", "en": "Publicly distance yourself from the leadership" },
      "effects": { "score": 5, "standing": -11, "appeal": { "self": -4,  "others": 5 },
                   "strike": "intrepide", "landscape": { "self": -0.9 } },
    ...
    { "label": { "fr": "Faire de la vague votre sujet, et la retourner", "en": "Make the wave your subject, and turn it round" },
      ...
      "roll": { "base": 16, "stat": "eloquence", "plus": { "credibilite": 0.4, "notoriete": 0.2 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 8, "credibilite": 1, "eloquence": 1, "notoriete": 1, "standing": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Le désavouer immédiatement", "en": "Disown him immediately" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "credibilite": 0.35, "popularity": 0.04 }, "bonus": [ { "when": { "personality": ["principled"] }, "value": 2 }, { "when": { "minStanding": 60 }, "value": 1.5 }, { "when": { "trait": ["traitre"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"score": 5, "standing": -9, "reputation": 1, "popularity": 6},
      ...
      "failure": { "effects": {"score": -3, "standing": -11, "popularity": -2, "reseau": -1, "strike": "traitre"},
        "result": { "fr": "Vous le désavouez à onze heures, et à quinze heures la direction publie un communiqué de soutien à celui que vous venez de lâcher. Vous avez trois heures d'avance sur votre propre parti, ce qui n'est jamais bon.",
                    "en": "You disown him at eleven, and at three the leadership issues a statement backing the man you have just dropped. You were three hours ahead of your own party, which is never a good place to be." } } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Mobiliser votre base et elle seule", "en": "Mobilise your base and nobody else" },
      "roll": { "base": 14, "stat": "reseau", "plus": { "energie": 0.3, "charisme": 0.25 }, "bonus": [ { "when": { "background": ["activism"] }, "value": 2 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "personality": ["hardworking"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"score": 9, "appeal": {"self": 7, "others": -2}, "strike": "radical"},
      ...
      "failure": { "effects": {"score": -4, "energie": -3, "popularity": -3, "appeal": {"others": -4}},
        "result": { "fr": "Vous concentrez tout sur les vôtres et la participation tombe encore plus bas que prévu, y compris chez eux. On ne mobilise pas une base en lui répétant qu'elle est la seule qui compte.",
                    "en": "You concentrate everything on your own people and turnout falls even lower than forecast, theirs included. You do not mobilise a base by telling it over and over that it is the only one that matters." } } },
    { "label": { "fr": "Faire campagne pour la participation elle-même", "en": "Campaign for turnout itself" },
      "effects": { "score": -2, "reputation": 2, "energie": -2 },
    ...
    { "label": { "fr": "Transformer le scrutin en sanction du gouvernement", "en": "Turn the election into a verdict on the government" },
      "effects": { "score": 8, "reputation": -1, "landscape": { "ruling": -1.2 } },
    ...
    { "label": { "fr": "Aller chercher bureau par bureau ceux qui n'ont pas voté depuis deux scrutins", "en": "Go polling station by polling station after those who have not voted in two elections" },
      ...
      "effects": { "score": 5, "credibilite": 2, "reputation": 1, "energie": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Lui ouvrir vos archives et vos comptes", "en": "Open your files and your accounts to him" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "reputation": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 7, "reputation": 1 },
      ...
      "failure": { "effects": { "score": -6, "reputation": -1 },
    ...
    { "label": { "fr": "Acheter deux pages de publicité la même semaine", "en": "Buy two pages of advertising the same week" },
      ...
      "failure": { "effects": { "score": -3, "money": -14000, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire le meeting quand même, à fond", "en": "Do the rally anyway, full force" },
      "roll": { "base": 14, "stat": "eloquence", "plus": { "charisme": 0.35, "energie": 0.25 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2.5 }, { "when": { "personality": ["hardworking"] }, "value": 1.5 }, { "when": { "trait": ["voix"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"score": 6, "energie": -2, "eloquence": 1, "notoriete": 1},
      ...
      "failure": { "effects": {"score": -2, "energie": -3, "standing": -3, "notoriete": 1, "popularity": -2},
        "result": { "fr": "Cinquante minutes de discours pour soixante personnes dans quatre cents fauteuils, et le photographe du journal a cadré les fauteuils. La photo fait la page trois avec une légende exacte et cruelle.",
                    "en": "Fifty minutes of speech for sixty people in four hundred seats, and the paper's photographer framed the seats. The picture runs on page three with a caption that is accurate and cruel." } } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire campagne contre son bilan", "en": "Campaign against his record" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "credibilite": 0.35, "notoriete": 0.25 }, "bonus": [ { "when": { "personality": ["provocative"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"score": 2, "popularity": 9, "reputation": 1, "strike": "intrepide", "credibilite": 1},
      ...
      "failure": { "effects": {"score": -8, "popularity": -4, "standing": -7, "reseau": -1},
        "result": { "fr": "Attaquer un bilan devant ceux qui l'ont voté demande qu'ils vous croient plus qu'ils ne se croient eux-mêmes. Ils ne vous croient pas, et il parle de vous en partant, une seule fois, en trois mots.",
                    "en": "Attacking a record in front of the people who voted for it requires them to believe you more than they believe themselves. They do not, and on his way out he speaks about you once, in three words." } } },
    { "label": { "fr": "Lui promettre de garder ses équipes", "en": "Promise to keep his people" },
      "effects": { "score": 9, "standing": 3, "reputation": -1, "strike": "menteur" },
    ...
    { "label": { "fr": "Lui dire en face ce que vous direz en public", "en": "Tell him to his face what you will say in public" },
      ...
      "effects": { "score": 2, "reputation": 2, "credibilite": 1, "standing": -3, "sangfroid": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre les douze de la fédération", "en": "Take the federation's twelve" },
      ...
      "success": { "effects": { "score": 3, "standing": 6, "reseau": 1, "popularity": -2 },
    ...
    { "label": { "fr": "Composer votre liste vous-même", "en": "Pick your own list" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "reputation": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
    ...
    { "label": { "fr": "Négocier nom par nom", "en": "Negotiate name by name" },
      "roll": { "base": 17, "stat": "sangfroid", "plus": { "reseau": 0.35, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 4, "standing": 5, "reseau": 1, "energie": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire campagne sans permanence du tout", "en": "Campaign with no office at all" },
      "roll": { "base": 15, "stat": "energie", "plus": { "charisme": 0.35 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2 }, { "when": { "trait": ["athletique"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 }, { "when": { "trait": ["epuise"] }, "value": -2 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Aller {le} chercher chez {lui}", "en": "Go and see {him} at home" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "reputation": 0.35 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 6, "standing": 6, "reseau": 1 },
    ...
    { "label": { "fr": "{Le} mettre en tête d'affiche de votre campagne", "en": "Put {him} at the top of your campaign posters" },
      ...
      "failure": { "effects": { "score": -4, "popularity": -6, "notoriete": -1, "standing": -3 },
    ...
    { "label": { "fr": "Faire campagne contre vingt-deux ans d'immobilisme", "en": "Campaign against twenty-two years of standing still" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "notoriete": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 4, "popularity": 8, "standing": -10, "eloquence": 1, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "En faire toute votre campagne", "en": "Build the whole campaign on it" },
      ...
      "success": { "effects": { "score": 5, "charisme": 1, "notoriete": 1, "popularity": 7, "standing": -6 },
      ...
      "failure": { "effects": { "score": -4, "popularity": -7, "credibilite": -1, "standing": -4 },
    ...
    { "label": { "fr": "Ne rien faire et laisser courir", "en": "Do nothing and let it run" },
      ...
      "success": { "effects": { "score": 3, "notoriete": 1, "popularity": 3, "energie": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Promettre de la sauver, quoi qu'il en coûte", "en": "Promise to save it, whatever it takes" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "charisme": 0.35 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "score": -3, "popularity": -5, "credibilite": -2, "standing": -6 },
    ...
    { "label": { "fr": "Dire la vérité et parler de l'après", "en": "Tell the truth and talk about what comes next" },
      "roll": { "base": 16, "stat": "credibilite", "plus": { "reputation": 0.35 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "score": 3, "credibilite": 2, "popularity": 5, "standing": 5,
                                "reputation": 1, "landscape": { "self": 0.4 } },
    ...
    { "label": { "fr": "Éviter le sujet pendant toute la campagne", "en": "Avoid the subject for the whole campaign" },
      ...
      "success": { "effects": { "score": 1, "standing": 5, "energie": 2, "sangfroid": 1 },
      ...
      "failure": { "effects": { "score": -5, "popularity": -8, "reputation": -1, "standing": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Expliquer vraiment, pendant huit minutes", "en": "Actually explain it, for eight minutes" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "credibilite": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 4, "credibilite": 1, "popularity": 5, "reputation": 1 },
    ...
    { "label": { "fr": "Répondre en parlant de tout autre chose", "en": "Answer by talking about something else entirely" },
      ...
      "failure": { "effects": { "score": -3, "credibilite": -1, "popularity": -4, "standing": -2 },
    ...
    { "label": { "fr": "Dire que c'est une élection nationale, et l'assumer", "en": "Say it is a national election, and own it" },
      ...
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "reputation": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 4, "popularity": 7, "notoriete": 1, "reputation": 1,
                                "landscape": { "self": 0.5 } },
      ...
      "failure": { "effects": { "score": -5, "credibilite": -2, "standing": -6, "popularity": -3 },

...

{
  ...
  "choices": [
    { "label": { "fr": "Aller devant le commissariat", "en": "Stand outside the police station" },
      "effects": { "axis": {"social": -60, "power": -70}, "notoriete": 1, "reseau": 1, "reputation": -1,
                   "standing": 11, "popularity": 6, "credibilite": -1, "energie": -1,
                   "landscape": { "self": 0.7, "ruling": -0.6 } },
    ...
    { "label": { "fr": "Dénoncer les violences des deux côtés", "en": "Condemn violence on all sides" },
      "effects": { "reputation": 1, "reseau": -1, "standing": -9, "popularity": 10, "credibilite": 2,
                   "appeal": { "self": -6 } },
    ...
    { "label": { "fr": "Payer les avocats des interpellés", "en": "Pay for the detainees' lawyers" },
      ...
      "effects": { "money": -60000, "reseau": 1, "standing": 16, "reputation": 1 },
    ...
    { "label": { "fr": "Négocier leur libération avec la préfecture", "en": "Negotiate their release with the prefecture" },
      ...
      "success": { "effects": { "reseau": 1, "reputation": 1, "standing": 12 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Rejoindre les piquets de grève", "en": "Join the picket lines" },
      "effects": { "axis": {"economy": -85, "social": -50}, "landscape": { "radical_left": 1 },
                   "reseau": 1, "notoriete": 1, "standing": 9, "popularity": 7, "credibilite": -1 },
    ...
    { "label": { "fr": "Appeler à la négociation", "en": "Call for negotiation" },
      "effects": { "landscape": { "self": 0.7 }, "eloquence": 1, "reputation": 1, "popularity": 8,
                   "standing": -6, "credibilite": 2, "appeal": { "self": -6 } },
    ...
    { "label": { "fr": "Loger et nourrir les grévistes", "en": "House and feed the strikers" },
      ...
      "effects": { "axis": {"economy": -70}, "landscape": { "radical_left": 0.8 }, "money": -80000, "reseau": 1, "standing": 14, "popularity": 5 },
    ...
    { "label": { "fr": "Proposer une médiation technique", "en": "Offer technical mediation" },
      ...
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "eloquence": 0.4, "reseau": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "landscape": { "self": 1 }, "reputation": 2, "reseau": 1, "popularity": 14, "standing": 4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Écrire la synthèse", "en": "Draft the compromise" },
      "effects": { "landscape": { "self": 0.5 }, "reseau": 1, "notoriete": -1, "standing": 13, "popularity": -6, "trait": "appareil" },
    ...
    { "label": { "fr": "Choisir un camp", "en": "Pick a side" },
      ...
      "failure": { "effects": { "landscape": { "self": -1 }, "reseau": -1, "standing": -16 },
    ...
    { "label": { "fr": "Écrire une motion à votre nom", "en": "Table a motion in your own name" },
      ...
      "roll": { "base": 16, "stat": "eloquence", "plus": { "standing": 0.05, "reseau": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "landscape": { "self": 0.6 }, "eloquence": 1, "notoriete": 1, "standing": 13, "appeal": { "self": 5 } },
    ...
    { "label": { "fr": "Acheter la paix avec des postes", "en": "Buy peace with jobs" },
      "when": { "minStanding": 55 },
      "effects": { "reseau": 1, "standing": 11, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Pousser à l'accord", "en": "Push for the deal" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "sangfroid": 0.35, "standing": 0.05 }, "bonus": [ { "when": { "personality": ["calculating"] }, "value": 2 }, { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "partyLead": true }, "value": 2 } ], "dice": 16 },
      "success": { "effects": {"landscape": {"self": -1, "identitarians": 0.8}, "reseau": 1, "reputation": -1, "standing": 4, "popularity": -10, "appeal": {"identitarians": 7}, "credibilite": 1},
      ...
      "failure": { "effects": {"standing": -9, "credibilite": -1, "popularity": -5, "reseau": -1, "landscape": {"self": -0.8}},
        "result": { "fr": "L'accord capote à la quatrième réunion sur un ministère et deux circonscriptions. Vous l'avez porté pendant six semaines, il n'existe pas, et les deux camps expliquent séparément que c'est l'autre qui n'en voulait pas.",
                    "en": "The deal collapses at the fourth meeting over one ministry and two constituencies. You carried it for six weeks, it does not exist, and both camps explain separately that it was the other side that did not want it." } } },
    { "label": { "fr": "Défendre l'indépendance", "en": "Defend independence" },
      "effects": { "landscape": { "self": 1.2 }, "reputation": 1, "reseau": -1, "standing": -9, "popularity": 9, "appeal": { "identitarians": -9 } },
    ...
    { "label": { "fr": "Négocier en secret et démentir en public", "en": "Negotiate in secret and deny it publicly" },
      "effects": { "landscape": { "self": -0.8, "identitarians": 0.6 }, "standing": 8, "popularity": -3, "reputation": -1, "sangfroid": 1, "strike": "menteur" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Appeler à faire barrage", "en": "Call for a blocking vote" },
      "effects": { "axis": {"world": -70, "social": -40}, "reputation": 1, "notoriete": 1, "popularity": 11, "standing": -6 },
    ...
    { "label": { "fr": "Renvoyer les deux dos à dos", "en": "Refuse to choose" },
      "effects": { "axis": {"power": -60}, "reputation": -1, "popularity": 7, "standing": 7 },
    ...
    { "label": { "fr": "Négocier votre soutien contre des garanties", "en": "Trade your backing for guarantees" },
      ...
      "success": { "effects": { "reseau": 1, "standing": 13 },
      ...
      "failure": { "effects": { "reputation": -1, "popularity": -8, "standing": -5 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Ne rien lâcher", "en": "Give up nothing" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "credibilite": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "background": ["law"] }, "value": 2 }, { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["casserole"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"reputation": -1, "money": 30000, "popularity": -7, "standing": 9, "credibilite": 1, "sangfroid": 1},
        "result": { "fr": "« Tout est légal. » C'est vrai, et ça n'arrange rien.",
                  "en": "“It is all legal.” True, and it helps nothing." } },
      "failure": { "effects": {"popularity": -10, "credibilite": -2, "standing": -6, "reputation": -1, "strike": "casserole"},
        "result": { "fr": "La déclaration d'intérêts est publique et quelqu'un a fini par la lire en entier. Vous n'avez rien caché, vous n'avez rien déclaré de faux, et vous passez trois semaines à expliquer une ligne que vous auriez pu retirer en trois minutes.",
                    "en": "The register of interests is public and somebody eventually read it in full. You hid nothing, you declared nothing false, and you spend three weeks explaining one line you could have removed in three minutes." } } },
    { "label": { "fr": "Placer vos parts dans un aveugle", "en": "Put your holdings in a blind trust" },
      "when": { "background": ["business", "law"] },
      "effects": { "money": -20000, "reputation": 1, "popularity": 8, "standing": 4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Assumer la doctrine", "en": "Stand by the doctrine" },
      "effects": { "axis": {"economy": 80}, "standing": 9, "popularity": 9, "sangfroid": 1,
                   "credibilite": -1, "reputation": -1 },
    ...
    { "label": { "fr": "Reconnaître une erreur", "en": "Admit a mistake" },
      "effects": { "reputation": 1, "popularity": 10, "standing": -9, "credibilite": 2,
                   "appeal": { "self": -8 }, "landscape": { "self": -0.5 } },
    ...
    { "label": { "fr": "Proposer une régulation ciblée", "en": "Propose targeted regulation" },
      ...
      "roll": { "base": 14, "stat": "eloquence", "plus": { "standing": 0.04 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": {"economy": -35}, "reputation": 1, "popularity": 10, "standing": 4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Donner à la base ce qu'elle attend", "en": "Give the base what it wants" },
      "effects": { "axis": "self", "reseau": 1, "notoriete": 1, "reputation": -1, "standing": 9,
                   "popularity": 7, "credibilite": -1, "appeal": { "others": -6 },
                   "strike": "radical", "landscape": { "self": 0.5 } },
    ...
    { "label": { "fr": "Tenir une ligne modérée", "en": "Hold a moderate line" },
      "effects": { "axis": {"social": -10, "world": -60, "economy": 25, "power": 10}, "reputation": 1,
                   "reseau": -1, "standing": -8, "popularity": 11, "credibilite": 1,
                   "landscape": { "self": -0.5 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire de l'annulation un étendard", "en": "Turn the cancellation into a banner" },
      "effects": { "axis": "self", "notoriete": 1, "reputation": -1, "standing": 11, "popularity": 7, "strike": "radical" },
    ...
    { "label": { "fr": "Créer votre propre média", "en": "Launch your own outlet" },
      ...
      "effects": { "money": -220000, "notoriete": 2, "standing": 12, "popularity": -2 },
    ...
    { "label": { "fr": "Saisir le régulateur", "en": "Take it to the broadcasting regulator" },
      ...
      "success": { "effects": { "reputation": 1, "notoriete": 1, "popularity": 7, "standing": 8 },
...

{
  ...
  "choices": [
    { "label": { "fr": "L'exclure immédiatement", "en": "Expel him immediately" },
      "effects": { "reputation": 1, "popularity": 8, "standing": -13, "reseau": -1, "appeal": { "self": -8 } },
    ...
    { "label": { "fr": "Le convaincre de se retirer lui-même", "en": "Persuade him to step aside himself" },
      ...
      "roll": { "base": 14, "stat": "charisme", "plus": { "reseau": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Démentir, chaleureusement et sans ambiguïté", "en": "Deny it, warmly and without ambiguity" },
      "effects": { "standing": 8, "reputation": 1, "popularity": -5, "credibilite": 1 },
    ...
    { "label": { "fr": "Ne rien dire du tout et laisser courir", "en": "Say nothing at all and let it run" },
      "effects": { "popularity": 6, "notoriete": 1, "standing": -6, "sangfroid": 1 },
    ...
    { "label": { "fr": "Répondre que le pays choisira le moment venu", "en": "Answer that the country will choose when the time comes" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "sangfroid": 0.4, "popularity": 0.05 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 9, "credibilite": 1, "eloquence": 1, "notoriete": 1, "standing": -8 },
      ...
      "failure": { "effects": { "popularity": -4, "standing": -11, "reputation": -1, "strike": "traitre" },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Demander un ministère régalien, tout de suite", "en": "Ask for a great office of state, right now" },
      ...
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "popularity": 0.06, "credibilite": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "office": "ministre", "standing": 6, "credibilite": 1, "popularity": -3 },
    ...
    { "label": { "fr": "Lui dire la vérité : vous serez candidat", "en": "Tell him the truth: you will run" },
      "effects": { "popularity": 5, "credibilite": 1, "reputation": 1, "standing": -12, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Mener la fronde, et signer de votre nom", "en": "Lead the revolt, and sign your name to it" },
      "roll": { "base": 17, "stat": "reseau", "plus": { "popularity": 0.06, "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "flags": { "presidentRenonce": true }, "standing": 9, "credibilite": 1,
                                "notoriete": 1, "popularity": 4, "reputation": -1, "approval": -6 },
    ...
    { "label": { "fr": "Les laisser la mener et rester en dehors", "en": "Let them lead it and stay out of it" },
      "effects": { "sangfroid": 1, "credibilite": 1, "standing": -3, "popularity": 1 },
    ...
    { "label": { "fr": "Prévenir le président", "en": "Warn the president" },
      "effects": { "standing": 11, "reseau": 1, "reputation": -1, "popularity": -6, "approval": 3, "strike": "traitre" },

...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Y aller à l'instinct", "en": "Wing it" },
      ...
      "success": { "effects": { "landscape": { "self": -0.7 }, "charisme": 1, "notoriete": 1, "popularity": 12, "standing": 2 },
      ...
      "triumph": { "effects": { "landscape": { "self": -0.9 }, "charisme": 1, "notoriete": 1, "popularity": 15, "standing": 2, "trait": "bete_scene" },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Assumer sans trembler", "en": "Stand by it" },
      "effects": { "axis": "self", "notoriete": 1, "reputation": -1, "popularity": 7, "standing": -9 },
    ...
    { "label": { "fr": "En remettre une couche", "en": "Double down, harder" },
      ...
      "effects": { "axis": "self", "landscape": { "self": -1.2 }, "notoriete": 2, "reputation": -1, "popularity": 9, "standing": -14, "strike": "radical" },
...

{
  ...
  "choices": [
    { "label": { "fr": "En rire vous-même", "en": "Laugh at yourself" },
      ...
      "failure": { "effects": { "credibilite": -2, "reputation": -1, "popularity": -13, "standing": -6 },
    ...
    { "label": { "fr": "Assumer et répéter la phrase", "en": "Own it and say it again" },
      "when": { "personality": ["provocative"] },
      "effects": { "axis": "self", "landscape": { "self": -1.6 }, "credibilite": -2, "notoriete": 2, "reputation": -1, "popularity": 7, "standing": -12 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter l'accès total", "en": "Grant total access" },
      "roll": { "chance": 0.55 },
      "success": { "effects": { "landscape": { "self": -0.9 }, "notoriete": 1, "popularity": 12, "standing": -5, "trait": "bete_scene" },
      ...
      "failure": { "effects": { "notoriete": 1, "reputation": -1, "popularity": -12, "standing": -8 },
    ...
    { "label": { "fr": "Exiger un droit de regard au montage", "en": "Demand editorial control" },
      ...
      "success": { "effects": { "notoriete": 1, "popularity": 9, "standing": 4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Attaquer en justice", "en": "Sue" },
      "roll": { "base": 15, "stat": "credibilite", "plus": { "reputation": 0.35, "money": 0.4 }, "bonus": [ { "when": { "background": ["law"] }, "value": 2.5 }, { "when": { "legal": 1 }, "value": 2 }, { "when": { "trait": ["casserole"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"money": 6000, "notoriete": 1, "popularity": -6, "standing": 2, "reputation": 1},
      ...
      "failure": { "effects": {"money": -22000, "popularity": -7, "notoriete": 1, "reputation": -1},
        "result": { "fr": "La procédure dure onze mois, la photo est jugée d'intérêt public, et le jugement la republie en annexe. Vous payez les frais des deux parties et la photo a désormais une légende juridique.",
                    "en": "The case takes eleven months, the photograph is ruled to be of public interest, and the judgment reprints it as an annex. You pay both sides' costs and the photograph now comes with a legal caption." } } },
    ...
    { "label": { "fr": "Publier vous-même l'album complet", "en": "Publish the whole album yourself" },
      ...
      "effects": { "notoriete": 1, "popularity": 8, "reputation": -1 },

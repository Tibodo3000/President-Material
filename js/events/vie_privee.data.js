...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Demander à votre entourage d'appeler le journal", "en": "Have your staff call the paper" },
      ...
      "success": { "effects": { "popularity": 4, "reseau": 2, "standing": 3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Répondre sur le fond, sans relever", "en": "Answer on the substance, without acknowledging it" },
      "effects": { "credibilite": +2, "reputation": 2, "sangfroid": 1, "popularity": 4, "notoriete": -1,
    ...
    { "label": { "fr": "Rendre le coup, plus fort", "en": "Hit back, harder" },
      "roll": { "base": 15, "stat": "eloquence",
                ...
                "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 },
                           ...
                           { "when": { "personality": ["provocative"] }, "value": 1.5 } ],
                "dice": 16 },
      "success": { "effects": { "strike": "intrepide", "popularity": 11, "notoriete": 3, "standing": 2, "appeal": { "scene": -8, "self": 5 }, "landscape": { "self": 1.9, "scene": -1.9 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Tenir jusqu'à l'échéance", "en": "Hold on until the next election" },
      ...
      "success": { "effects": {"trait": "use", "standing": 6, "energie": -1, "credibilite": 2},
      ...
      "failure": { "effects": {"energie": -4, "standing": -4, "popularity": -5, "credibilite": -2, "strike": "epuise"},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Accepter et régler vos comptes internes", "en": "Accept, and settle your internal scores" },
      ...
      "success": { "effects": {"notoriete": 2, "popularity": 5, "standing": -12, "reputation": -1, "landscape": {"self": -0.6}},
      ...
      "failure": { "effects": {"popularity": -6, "standing": -11, "reseau": -2, "reputation": -1, "strike": "traitre"},

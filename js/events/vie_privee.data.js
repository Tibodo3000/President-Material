...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Les associer à la vie publique", "en": "Bring them into public life" },
      ...
      "roll": { "base": 13, "stat": "charisme", "plus": { "popularity": 0.03 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Communiquer avec dignité", "en": "Handle it with dignity" },
      "effects": { "energie": -1, "reputation": 1, "popularity": 8, "sangfroid": 1 },
    ...
    { "label": { "fr": "Vous jeter dans le travail", "en": "Throw yourself into work" },
      "effects": { "energie": -2, "reseau": 1, "standing": 12, "popularity": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Passer le coup de fil", "en": "Make the call" },
      ...
      "success": { "effects": {"reseau": 1, "reputation": -1, "standing": 3, "flags": {"dirtyMoney": true}},
      ...
      "failure": { "effects": {"reseau": -1, "reputation": -1, "standing": -3, "energie": -1},
    ...
    { "label": { "fr": "Refuser et perdre l'ami", "en": "Refuse and lose the friend" },
      "when": { "stat": { "energie": { "min": 8 } } },
      "effects": { "reputation": 1, "reseau": -1, "popularity": 3, "energie": -2 },
    ...
    { "label": { "fr": "Refuser en lui expliquant pourquoi", "en": "Refuse, and explain why" },
      ...
      "effects": { "reputation": 1, "eloquence": 1, "popularity": 4, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Répondre franchement non", "en": "Answer honestly: no" },
      "effects": { "reputation": 1, "popularity": 10, "standing": -7 },
    ...
    { "label": { "fr": "Dérouler le bilan", "en": "Run through the record" },
      ...
      "success": { "effects": {"standing": 6, "popularity": 6, "eloquence": 1, "notoriete": 1},
    ...
    { "label": { "fr": "Publier un livre de souvenirs", "en": "Publish a book of memoirs" },
      "effects": { "money": 40000, "notoriete": 1, "popularity": 4, "energie": -2, "standing": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Laisser faire", "en": "Let them" },
      "effects": { "notoriete": 1, "popularity": 7, "standing": -4, "reputation": -1 },
    ...
    { "label": { "fr": "Exiger une mesure sur chaque affiche", "en": "Insist on a policy line on every poster" },
      "effects": { "reputation": 1, "popularity": -2, "standing": 5, "eloquence": 1 },
    ...
    { "label": { "fr": "Refaire la maquette vous-même, en une nuit", "en": "Redo the artwork yourself, in one night" },
      ...
      "effects": { "popularity": 5, "credibilite": 1, "notoriete": 1, "energie": -2, "money": -8000 },
    ...
    { "label": { "fr": "En faire une campagne entièrement à l'image", "en": "Make the whole campaign about the image" },
      "roll": { "base": 14, "stat": "charisme", "plus": { "notoriete": 0.5 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "charisme": 1, "notoriete": 1, "popularity": 10, "standing": -6, "trait": "bete_scene" },
      ...
      "failure": { "effects": { "popularity": -5, "reputation": -1, "strike": "menteur" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Publier un livre de fond dans l'année", "en": "Publish a serious book within the year" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "energie": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "reputation": 2, "eloquence": 1, "energie": -2, "standing": 6, "trait": "orateur" },
    ...
    { "label": { "fr": "Travailler deux dossiers jusqu'à les connaître mieux que quiconque", "en": "Master two files better than anyone" },
      "effects": { "eloquence": 1, "reputation": 1, "energie": -3, "standing": 7, "popularity": -2 },
  ...
  "choices": [
    { "label": { "fr": "Lui acheter l'original et l'accrocher dans votre bureau", "en": "Buy the original and hang it in your office" },
      "roll": { "base": 14, "stat": "sangfroid",
                "plus": { "charisme": 0.35, "notoriete": 0.2 },
                "bonus": [ { "when": { "personality": ["charming"] }, "value": 2 },
                           { "when": { "background": ["celebrity", "comms"] }, "value": 1.5 },
                           { "when": { "personality": ["provocative"] }, "value": -1.5 } ],
                "dice": 16 },
      "success": { "effects": { "credibilite": +1, "money": -4000, "popularity": 8, "charisme": 1,
                                "sangfroid": 1, "trait": "teflon" },
      ...
      "failure": { "effects": { "money": -4000, "popularity": -5, "reputation": -1, "standing": -2 },
        "result": { "fr": "La photo de l'achat sort avant la vôtre. On n'y voit pas quelqu'un qui rit de soi, on y voit quelqu'un qui a payé pour en avoir l'air, et le dessinateur en tire un dessin de plus.",
                    "en": "The photograph of the purchase comes out before yours does. It does not show somebody laughing at themselves, it shows somebody who paid to look as if they were, and the cartoonist gets one more drawing out of it." } } },
    { "label": { "fr": "Demander à votre entourage d'appeler le journal", "en": "Have your staff call the paper" },
      "roll": { "chance": 0.38,
                "chanceBonus": [ { "when": { "stat": { "reseau": { "min": 13 } } }, "value": 0.14 },
                                 { "when": { "minStanding": 60 }, "value": 0.1 },
                                 { "when": { "background": ["journalism", "comms"] }, "value": 0.12 } ] },
      "success": { "effects": { "popularity": 4, "reseau": 1, "standing": 3 },
      ...
      "failure": { "effects": { "credibilite": -1, "popularity": -9, "reputation": -1, "notoriete": 1 },
    ...
    { "label": { "fr": "Lui commander une série et la publier vous-même", "en": "Commission a series from him and publish it yourself" },
      ...
      "effects": { "popularity": 8, "notoriete": 2, "reputation": 1, "money": -12000 },
    ...
    { "label": { "fr": "Ne rien faire du tout", "en": "Do nothing at all" },
      "effects": { "credibilite": +1, "sangfroid": 1, "popularity": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Reprendre le sport sérieusement", "en": "Take up sport seriously" },
      "roll": { "base": 20, "stat": "energie", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2 }, { "when": { "trait": ["athletique"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 }, { "when": { "trait": ["epuise"] }, "value": -2 } ], "dice": 16 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser et le dire", "en": "Refuse, and say so" },
      "effects": { "reputation": 2, "popularity": 6, "standing": -8, "sangfroid": 1, "chain": "position_impopulaire" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller", "en": "Go ahead" },
      ...
      "failure": { "effects": {"money": -48000, "popularity": -7, "notoriete": 1, "reputation": -1, "trait": "lifting"},
    ...
    { "label": { "fr": "Assumer le vieillissement", "en": "Own the ageing" },
      "effects": { "reputation": 2, "sangfroid": 1, "popularity": -2, "notoriete": -1 },
    ...
    { "label": { "fr": "En faire un sujet politique", "en": "Turn it into a political subject" },
      ...
      "effects": { "notoriete": 1, "popularity": 7, "reputation": 1, "standing": -6,
                   "landscape": { "self": 0.8 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Répondre sur le fond, sans relever", "en": "Answer on the substance, without acknowledging it" },
      "effects": { "credibilite": +1, "reputation": 1, "sangfroid": 1, "popularity": 4, "notoriete": -1,
                   "appeal": { "scene": -3, "self": -5 }, "landscape": { "self": 0.6, "scene": -0.6 } },
    ...
    { "label": { "fr": "Rendre le coup, plus fort", "en": "Hit back, harder" },
      "roll": { "base": 15, "stat": "eloquence",
                "plus": { "sangfroid": 0.4, "charisme": 0.25, "notoriete": 0.2 },
                "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 },
                           { "when": { "background": ["celebrity", "comms"] }, "value": 1.5 },
                           { "when": { "personality": ["provocative"] }, "value": 1.5 } ],
                "dice": 16 },
      "success": { "effects": { "strike": "intrepide", "popularity": 11, "eloquence": 1, "notoriete": 1, "standing": 2, "appeal": { "scene": -8, "self": 5 }, "landscape": { "self": 1.9, "scene": -1.9 } },
      ...
      "failure": { "effects": { "credibilite": -1, "strike": "intrepide", "popularity": -6, "reputation": -1, "landscape": { "scene": 0.8 } },
    ...
    { "label": { "fr": "Enchaîner sur une vanne meilleure que la sienne", "en": "Come back with a better joke than his" },
      "when": { "background": ["celebrity"] },
      "effects": { "popularity": 9, "notoriete": 2, "credibilite": -1, "standing": -2 },
    ...
    { "label": { "fr": "Prendre le pays à témoin", "en": "Take it to the country" },
      ...
      "effects": { "popularity": 10, "reputation": 1, "standing": -4, "notoriete": 1, "appeal": { "scene": -4 },
                   "landscape": { "scene": -1.4 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Tenir jusqu'à l'échéance", "en": "Hold on until the next election" },
      "roll": { "base": 15, "stat": "energie", "plus": { "sangfroid": 0.35, "reputation": 0.2 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2.5 }, { "when": { "personality": ["hardworking"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"trait": "use", "standing": 6, "energie": -1, "credibilite": 1},
      ...
      "failure": { "effects": {"energie": -4, "standing": -4, "popularity": -5, "credibilite": -1, "strike": "epuise"},
        "result": { "fr": "Vous tenez trois semaines de plus et vous lâchez sur un plateau, à une question facile, en cherchant un mot que vous connaissez. Les quarante secondes tournent, et personne ne parle du scrutin.",
                    "en": "You hold out three more weeks and you go on an easy question, live, hunting for a word you know perfectly well. The forty seconds go round, and nobody talks about the election." } } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Cacher le diagnostic", "en": "Hide the diagnosis" },
      ...
      "failure": { "effects": {"popularity": -9, "standing": -7, "credibilite": -2, "energie": -2},
...

{
  ...
  "choices": [
    { "label": { "fr": "Rappeler que vous l'aviez dit", "en": "Remind everyone you said it" },
      "roll": { "base": 13, "stat": "sangfroid", "plus": { "reputation": 0.5 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Fonder le courant", "en": "Found the faction" },
      "effects": { "standing": 12, "reseau": 1, "popularity": -4, "reputation": -1,
                   "landscape": { "self": 0.8 } },
    ...
    { "label": { "fr": "Refuser de faire écurie", "en": "Refuse to run a stable" },
      "effects": { "reputation": 1, "popularity": 4, "standing": -5 },
    ...
    { "label": { "fr": "Les placer un par un, sans rien fonder", "en": "Place them one by one, and found nothing" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "standing": 0.05, "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "standing": 10, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter et y parler du pays", "en": "Accept, and talk about the country" },
      "effects": { "notoriete": 1, "eloquence": 1, "popularity": 8, "energie": -2, "standing": -4 },
    ...
    { "label": { "fr": "Accepter et régler vos comptes internes", "en": "Accept, and settle your internal scores" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "sangfroid": 0.35, "standing": 0.04 }, "bonus": [ { "when": { "personality": ["provocative"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 2 }, { "when": { "partyLead": true }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"eloquence": 1, "notoriete": 1, "popularity": 5, "standing": -12, "reputation": -1, "landscape": {"self": -0.6}},
      ...
      "failure": { "effects": {"popularity": -6, "standing": -11, "reseau": -1, "reputation": -1, "strike": "traitre"},
        "result": { "fr": "Vous citez deux noms sans les nommer, ce qui revient à les nommer. Les deux répondent le lendemain, mieux préparés que vous, et la fédération demande à la direction ce qu'elle compte faire.",
                    "en": "You refer to two people without naming them, which amounts to naming them. Both answer the next day, better prepared than you, and the federation asks the leadership what it intends to do about it." } } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Envoyer votre suppléant partout où c'est possible", "en": "Send your deputy wherever you can" },
      "roll": { "base": 14, "stat": "reseau", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "energie": 3, "reseau": 1, "standing": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Rendre la boîte, sans commentaire non plus", "en": "Hand the box back, without comment either" },
      "effects": { "sangfroid": 1, "reputation": 1, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Répondre calmement, une fois de plus", "en": "Answer calmly, one more time" },
      "roll": { "base": 13, "stat": "sangfroid", "plus": { "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "popularity": -8, "reputation": -1, "notoriete": 1, "strike": "menteur", "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Entendre, et lever le pied pour de bon", "en": "Take it in, and genuinely ease off" },
      "effects": { "energie": 5, "sangfroid": 1, "reputation": 1, "standing": -9, "popularity": -3 },
    ...
    { "label": { "fr": "Répondre que c'est le métier", "en": "Answer that this is the job" },
      ...
      "failure": { "effects": {"energie": -3, "popularity": -3, "reputation": -1, "chain": "rupture"},
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre les trois mois", "en": "Take the three months" },
      "effects": { "untrait": "epuise", "energie": 6, "sangfroid": 1, "standing": -12, "popularity": -5,
    ...
    { "label": { "fr": "Prendre trois semaines et appeler ça trois mois", "en": "Take three weeks and call it three months" },
      ...
      "failure": { "effects": { "energie": -2, "sangfroid": -1, "popularity": -4, "standing": -5 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre l'avion, et laisser remplir la case", "en": "Take the plane, and let them fill in the box" },
      "roll": { "base": 20, "stat": "sangfroid", "plus": { "reseau": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "popularity": -12, "approval": -5, "credibilite": -1, "reputation": -1,
                                "standing": -4, "notoriete": 1 },
      ...
      "debacle": { "effects": { "popularity": -15, "approval": -7, "credibilite": -2, "reputation": -1,
                                "standing": -5, "notoriete": 2, "money": -23000, "strike": "casserole" },
    ...
    { "label": { "fr": "Prendre l'avion, écrire le vrai motif et rembourser le soir même", "en": "Take the plane, write the real reason and repay it that evening" },
      "effects": { "money": -23000, "credibilite": 2, "reputation": 1, "popularity": -5, "approval": -2,
    ...
    { "label": { "fr": "Renoncer, et l'appeler à la mi-temps", "en": "Give it up, and call him at half-time" },
      "roll": { "base": 16, "stat": "charisme", "plus": { "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "popularity": -10, "notoriete": 1, "reputation": -1, "energie": -2,
                                "approval": -2 },
    ...
    { "label": { "fr": "Envoyer votre directeur adjoint de cabinet à votre place", "en": "Send your deputy chief of staff instead" },
      "effects": { "energie": 1, "standing": 1, "popularity": -2, "reputation": -1 },
    ...
    { "label": { "fr": "Quitter le Conseil avant les conclusions", "en": "Leave the Council before the conclusions" },
      "effects": { "approval": -4, "credibilite": -1, "standing": -3, "popularity": 2, "energie": 1 },
    ...
    { "label": { "fr": "Prendre l'avion, et programmer une visite au centre de formation du club", "en": "Take the plane, and schedule a visit to the club's academy" },
      "when": { "background": ["comms"] },
      "effects": { "approval": 1, "notoriete": 1, "popularity": 4, "credibilite": -1, "reputation": -1,
                   "energie": -2 },

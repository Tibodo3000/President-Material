...

{
  ...
  "choices": [
    { "label": { "fr": "Se rendre sur place immédiatement", "en": "Go there immediately" },
      ...
      "success": { "effects": { "credibilite": +1, "notoriete": 1, "reputation": 1, "energie": -1, "popularity": 15, "standing": 4,
                                "appeal": { "ruling": -6 },
                                "landscape": { "self": 1.4, "ruling": -1.1 } },
      ...
      "failure": { "effects": { "credibilite": -1, "energie": -1, "popularity": -7, "reputation": -1,
                                "landscape": { "self": -0.9 } },
    ...
    { "label": { "fr": "Exiger une commission d'enquête", "en": "Demand a commission of inquiry" },
      "effects": { "credibilite": +1, "eloquence": 1, "standing": 9, "popularity": -5, "energie": -1,
                   "landscape": { "self": 0.5, "ruling": -0.9 } },
    ...
    { "label": { "fr": "Accuser nommément les responsables", "en": "Name and shame those responsible" },
      ...
      "success": { "effects": { "axis": {"power": -55, "economy": -50}, "credibilite": -1, "notoriete": 2, "popularity": 14, "standing": -8,
                                "landscape": { "self": 0.8, "ruling": -1.9 } },
      ...
      "failure": { "effects": { "credibilite": -2, "reputation": -1, "popularity": -9, "standing": -10 },
    ...
    { "label": { "fr": "Financer vous-même l'aide aux familles", "en": "Fund support for the families yourself" },
      ...
      "effects": { "money": -200000, "reputation": 2, "popularity": 15, "standing": -4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter, et rompre avec votre camp", "en": "Accept, and break with your own side" },
      "effects": { "office": "ministre", "money": 60000, "reseau": 1, "notoriete": 1, "reputation": -1, "popularity": 9, "standing": -14, "appeal": { "self": -13, "ruling": 6 },
                   "landscape": { "self": -2.1, "ruling": 1.6 }, "trait": "renegat" },
    ...
    { "label": { "fr": "Refuser publiquement et bruyamment", "en": "Refuse loudly and publicly" },
      "effects": { "strike": "intrepide", "reputation": 1, "notoriete": 1, "standing": 10, "popularity": -4,
                   "appeal": { "self": 8 }, "money": -20000, "landscape": { "self": 0.9, "ruling": -0.6 } },
    ...
    { "label": { "fr": "Négocier un soutien sans portefeuille", "en": "Negotiate support without a portfolio" },
      ...
      "success": { "effects": { "reseau": 1, "standing": 10, "popularity": 5,
                                "landscape": { "self": -0.5, "ruling": 1.1 } },
    ...
    { "label": { "fr": "Exiger l'Intérieur, et rompre avec votre camp", "en": "Demand the Interior Ministry, and break with your own side" },
      ...
      "success": { "effects": { "office": "ministre", "reseau": 2, "notoriete": 1, "money": 60000, "popularity": 7, "standing": -10, "appeal": { "self": -11, "ruling": 5 },
                                "landscape": { "self": -1.7, "ruling": 1.4 }, "trait": "renegat" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre la tête de la fronde", "en": "Lead the charge" },
      ...
      "success": { "effects": { "axis": {"power": -50}, "notoriete": 2, "reseau": 1, "popularity": 16,
                                "appeal": { "ruling": -14 }, "standing": 5, "censure": true,
                                "landscape": { "self": 1.7, "ruling": -2.4 } },
    ...
    { "label": { "fr": "Négocier votre voix contre un texte", "en": "Trade your vote for a bill" },
      "when": { "minStanding": 55 },
      "effects": { "reseau": 1, "standing": 9, "reputation": -1, "popularity": -5,
                   "landscape": { "self": -0.6, "ruling": 1.2 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Parler du fond, longuement", "en": "Talk substance, at length" },
      ...
      "success": { "effects": { "eloquence": 1, "reputation": 1, "popularity": 12, "standing": 6,
                                "landscape": { "self": 1.3 } },
      ...
      "failure": { "effects": { "popularity": -8, "notoriete": -1, "landscape": { "self": -0.8 } },
    ...
    { "label": { "fr": "Attaquer le gouvernement pendant deux heures", "en": "Attack the government for two hours" },
      "effects": { "notoriete": 1, "reputation": -1, "appeal": { "self": 9 }, "standing": 6,
                   "landscape": { "self": 1.1, "ruling": -0.7 } },
    ...
    { "label": { "fr": "Raconter votre milieu d'origine", "en": "Talk about where you come from" },
      "when": { "origin": ["modest"] },
      "effects": { "axis": {"economy": -50}, "reputation": 1, "popularity": 10, "standing": -6,
                   "landscape": { "self": 1.2 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Le garder et ne rien dire", "en": "Keep him and say nothing" },
      ...
      "success": { "effects": { "reseau": 1, "standing": 8 },
      ...
      "failure": { "effects": { "reseau": -1, "standing": -14, "popularity": -6 },
    ...
    { "label": { "fr": "Retourner la fuite contre son commanditaire", "en": "Turn the leak against whoever ordered it" },
      ...
      "success": { "effects": { "reseau": 1, "standing": 15, "notoriete": 1 },
    ...
    { "label": { "fr": "Le convoquer et lui dire les choses en face", "en": "Call him in and say it to his face" },
      ...
      "effects": { "sangfroid": 1, "reseau": 1, "standing": 9, "reputation": 1, "energie": -1 },

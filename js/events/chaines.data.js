...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre le meilleur avocat du pays", "en": "Hire the best lawyer in the country" },
      ...
      "debacle": { "effects": { "money": -150000, "reputation": -2, "popularity": -20, "standing": -17, "flags": { "onTrial": true }, "chain": "proces", "strike": "casserole" },
  ...
  "choices": [
    ...
    { "label": { "fr": "Plaider coupable pour limiter la peine", "en": "Plead guilty to limit the sentence" },
      ...
      "success": { "effects": { "flags": { "onTrial": false, "dirtyMoney": false }, "money": -150000,
                                "reputation": -2, "popularity": -14, "standing": -16, "sangfroid": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Fournir chaque justificatif", "en": "Produce every receipt" },
      ...
      "success": { "effects": { "reputation": 2, "popularity": 4, "credibilite": 3, "standing": 2,
                                "sangfroid": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Payer le redressement sans discuter", "en": "Pay the assessment without arguing" },
      "effects": { "money": -240000, "popularity": -6, "standing": -4, "credibilite": 2,
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Tenir coûte que coûte", "en": "Push through" },
      ...
      "success": { "effects": {"sangfroid": -1, "standing": 5, "flags": {"frailHealth": true}, "trait": "use", "credibilite": 2},
        "result": { "fr": "Vous tenez. Quelque chose s'est abîmé, sans bruit.",
                  "en": "You hold on. Something has worn down, quietly." } },
      "failure": { "effects": {"energie": -3, "standing": -5, "popularity": -6, "credibilite": -2, "strike": "epuise"},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Cacher l'épisode et continuer", "en": "Hide it and carry on" },
      ...
      "success": { "effects": {"sangfroid": 2, "standing": 7, "flags": {"frailHealth": true}, "chain": "rechute"},
        "result": { "fr": "Personne ne sait. Vous vivez désormais avec un compte à rebours.",
                  "en": "Nobody knows. You now live with a countdown." } },
      "failure": { "effects": {"popularity": -10, "standing": -8, "credibilite": -3, "energie": -3, "flags": {"frailHealth": true}},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Un texte technique et consensuel", "en": "A technical, consensual bill" },
      ...
      "success": { "effects": {"credibilite": 3, "standing": 5, "reputation": 1, "popularity": -6, "notoriete": -1},
  ...
  "choices": [
    { "label": { "fr": "Aller chercher les voix une par une", "en": "Chase the votes one by one" },
      "roll": { "base": 16, "stat": "reseau",
                ...
                "dice": 16 },
      "success": { "effects": { "notoriete": 1, "reputation": 2, "popularity": 12, "standing": 9,
                                "energie": -2 },
    ...
    { "label": { "fr": "Menacer les récalcitrants", "en": "Threaten the holdouts" },
      "roll": { "base": 15, "stat": "sangfroid",
                ...
                "dice": 16 },
      "success": { "effects": { "notoriete": 1, "popularity": 8, "standing": 15, "reputation": -2,
                                "reseau": -2, "landscape": { "self": 0.6 } },
      ...
      "failure": { "effects": { "standing": -10, "reputation": -2, "popularity": -6, "reseau": -1 },

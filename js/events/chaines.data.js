...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Dénoncer un acharnement politique", "en": "Denounce a political witch hunt" },
      "effects": { "notoriete": 1, "popularity": -9, "standing": 4, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre le meilleur avocat du pays", "en": "Hire the best lawyer in the country" },
      ...
      "debacle": { "effects": { "money": -150000, "reputation": -1, "popularity": -20, "standing": -17, "flags": { "onTrial": true }, "chain": "proces", "strike": "casserole" },
        "result": { "fr": "L'avocat obtient une chose : que la perquisition dure jusqu'au soir, sous vos fenêtres, devant des caméras prévenues avant vous. Mise en examen le lendemain, et la photo du carton scellé ressortira à chaque échéance qu'il vous reste.",
                    "en": "The lawyer wins one thing: that the search runs until evening, under your windows, in front of cameras tipped off before you were. Indicted the next day, and the photograph of the sealed box will resurface at every election you have left." } } },
    { "label": { "fr": "Coopérer totalement", "en": "Cooperate fully" },
      ...
      "failure": { "effects": { "reputation": -1, "popularity": -14, "standing": -18, "flags": { "onTrial": true }, "chain": "proces" },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Plaider coupable pour limiter la peine", "en": "Plead guilty to limit the sentence" },
      ...
      "success": { "effects": { "flags": { "onTrial": false, "dirtyMoney": false }, "money": -150000,
                                "reputation": -1, "popularity": -14, "standing": -16, "sangfroid": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Fournir les pièces et régulariser", "en": "Provide the receipts and put it right" },
      ...
      "failure": { "effects": { "money": -120000, "popularity": -9, "standing": -7, "reputation": -1 },
    ...
    { "label": { "fr": "Confier le dossier à vos avocats et ne rien dire", "en": "Hand it to your lawyers and say nothing" },
      ...
      "failure": { "effects": { "money": -70000, "popularity": -11, "standing": -6, "reputation": -1,
    ...
    { "label": { "fr": "Dénoncer une commission qui fait de la politique", "en": "Denounce a commission playing politics" },
      "effects": { "notoriete": 1, "popularity": -7, "standing": 3, "reputation": -1,
...

{
  ...
  "choices": [
    { "label": { "fr": "Fournir chaque justificatif", "en": "Produce every receipt" },
      ...
      "success": { "effects": { "reputation": 1, "popularity": 4, "credibilite": 2, "standing": 2,
                                "sangfroid": 1 },
    ...
    { "label": { "fr": "Publier vous-même toute la déclaration", "en": "Publish the whole declaration yourself" },
      "effects": { "reputation": 1, "popularity": 6, "standing": -9, "notoriete": 1,
                   "energie": -1, "appeal": { "self": -4 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Payer le redressement sans discuter", "en": "Pay the assessment without arguing" },
      "effects": { "money": -240000, "popularity": -6, "standing": -4, "credibilite": 1,
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Tenir coûte que coûte", "en": "Push through" },
      "roll": { "base": 16, "stat": "energie", "plus": { "sangfroid": 0.35, "reputation": 0.2 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2.5 }, { "when": { "personality": ["hardworking"] }, "value": 2 }, { "when": { "trait": ["fragile"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"sangfroid": -1, "standing": 5, "flags": {"frailHealth": true}, "trait": "use", "credibilite": 1},
        "result": { "fr": "Vous tenez. Quelque chose s'est abîmé, sans bruit.",
                  "en": "You hold on. Something has worn down, quietly." } },
      "failure": { "effects": {"energie": -3, "standing": -5, "popularity": -6, "credibilite": -1, "strike": "epuise"},
        "result": { "fr": "Vous tenez, et ce sont les autres qui le voient avant vous : deux rendez-vous manqués, un nom oublié en public, et une réunion où vous répondez à une question qu'on n'a pas posée.",
                    "en": "You hold on, and it is other people who notice before you do: two missed appointments, a name forgotten in public, and a meeting where you answer a question nobody asked." } } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Cacher l'épisode et continuer", "en": "Hide it and carry on" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "reseau": 0.3, "credibilite": 0.2 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2 }, { "when": { "personality": ["calculating"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"sangfroid": 1, "standing": 7, "flags": {"frailHealth": true}, "chain": "rechute"},
        "result": { "fr": "Personne ne sait. Vous vivez désormais avec un compte à rebours.",
                  "en": "Nobody knows. You now live with a countdown." } },
      "failure": { "effects": {"popularity": -10, "standing": -8, "credibilite": -2, "energie": -3, "flags": {"frailHealth": true}},
        "result": { "fr": "Le service des urgences tient un registre, et le registre est consultable par plus de monde qu'on ne croit. L'information sort quatre mois plus tard, avec la date, et le fait de l'avoir cachée devient l'information.",
                    "en": "The accident and emergency department keeps a register, and that register is open to more people than you would think. It comes out four months later, with the date, and the fact that you hid it becomes the story." } } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Publier votre dossier médical", "en": "Publish your medical file" },
      "effects": { "reputation": 1, "popularity": 6, "standing": -12, "flags": { "carefulHealth": true, "frailHealth": false } },
    ...
    { "label": { "fr": "Parler d'un simple coup de fatigue", "en": "Call it simple exhaustion" },
      ...
      "failure": { "effects": {"popularity": -10, "credibilite": -2, "standing": -6, "strike": "menteur"},
...

{
  ...
  "choices": [
    { "label": { "fr": "Un texte ambitieux et clivant", "en": "An ambitious, divisive bill" },
      "when": { "stat": { "energie": { "min": 8 } } },
      "effects": { "notoriete": 1, "energie": -2, "popularity": 9, "standing": -4, "chain": "bataille_amendements" },
    ...
    { "label": { "fr": "Un texte technique et consensuel", "en": "A technical, consensual bill" },
      "roll": { "base": 14, "stat": "credibilite", "plus": { "eloquence": 0.3, "reseau": 0.25 }, "bonus": [ { "when": { "background": ["law", "civil"] }, "value": 2.5 }, { "when": { "personality": ["hardworking"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"credibilite": 2, "standing": 5, "reputation": 1, "popularity": -6, "notoriete": -1},
      ...
      "failure": { "effects": {"credibilite": -1, "standing": -4, "energie": -2, "popularity": -2},
        "result": { "fr": "Le texte fait onze articles, dont sept de coordination. Il est adopté à l'unanimité un jeudi à minuit vingt devant dix-neuf députés, et le décret d'application n'est pas paru quatre ans plus tard.",
                    "en": "The bill runs to eleven clauses, seven of them consequential. It passes unanimously on a Thursday at twenty past midnight in front of nineteen members, and four years later the implementing decree has still not appeared." } } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tenir l'hémicycle nuit après nuit", "en": "Hold the chamber night after night" },
      ...
      "success": { "effects": { "notoriete": 1, "eloquence": 1, "energie": -2, "popularity": 12, "standing": 6, "chain": "vote_final" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Aller chercher les voix une par une", "en": "Chase the votes one by one" },
      "roll": { "base": 16, "stat": "reseau",
                "plus": { "charisme": 0.35, "standing": 0.05, "eloquence": 0.25 },
                "bonus": [ { "when": { "trait": ["memoire_des_noms"] }, "value": 2 },
                           { "when": { "trait": ["reseauteur"] }, "value": 2 },
                           { "when": { "personality": ["hardworking", "charming"] }, "value": 1.5 },
                           { "when": { "stat": { "energie": { "max": 7 } } }, "value": -1.5 } ],
                "dice": 16 },
      "success": { "effects": { "notoriete": 1, "reputation": 1, "popularity": 12, "standing": 9,
                                "energie": -2 },
    ...
    { "label": { "fr": "Menacer les récalcitrants", "en": "Threaten the holdouts" },
      "roll": { "base": 15, "stat": "sangfroid",
                "plus": { "standing": 0.05, "reseau": 0.3 },
                "bonus": [ { "when": { "trait": ["intrepide"] }, "value": 2 },
                           { "when": { "personality": ["provocative"] }, "value": 1.5 },
                           { "when": { "partyLead": true }, "value": 2 },
                           { "when": { "trait": ["lache"] }, "value": -2.5 } ],
                "dice": 16 },
      "success": { "effects": { "notoriete": 1, "popularity": 8, "standing": 15, "reputation": -1,
                                "reseau": -1, "landscape": { "self": 0.6 } },
      ...
      "failure": { "effects": { "standing": -10, "reputation": -1, "popularity": -6, "reseau": -1 },

   ...
   au congrès. La scène vaut donc partout sauf là. */
{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire savoir ce qu'{il} vaut vraiment", "en": "Let people know what {he} is really worth" },
      ...
      "success": { "effects": { "appeal": { "self": -3 }, "standing": 3, "reputation": -2, "notoriete": 1,
                                "landscape": { "self": -1.2 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire le tour des sections, une par une", "en": "Tour the branches, one by one" },
      "effects": { "strike": "appareil", "standing": 4, "energie": -3, "reseau": 2,
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser, et le dire en face", "en": "Refuse, and say so to {his} face" },
      ...
      "success": { "effects": {"reputation": 3, "standing": -3, "sangfroid": 1, "strike": "intrepide", "credibilite": 2},
      ...
      "failure": { "effects": {"standing": -10, "reseau": -3, "reputation": 1, "energie": -1},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Rendre service à ceux qui décident", "en": "Do favours for the people who decide" },
      ...
      "success": { "effects": {"standing": 7, "appeal": {"self": -3}, "reseau": 2, "reputation": -1},
      ...
      "failure": { "effects": {"standing": -5, "reseau": -1, "reputation": -2, "energie": -2},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Exiger un vote des adhérents, publiquement", "en": "Demand a members' ballot, in public" },
      ...
      "success": { "effects": { "popularity": 4, "appeal": { "self": 6 }, "standing": -4, "notoriete": 2,
                                "reputation": 2, "credibilite": 1, "landscape": { "self": -0.7 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Dire tout haut qu'un candidat naturel, ça n'existe pas", "en": "Say out loud that there is no such thing as a natural candidate" },
      ...
      "success": { "effects": { "popularity": 5, "appeal": { "self": 6 }, "notoriete": 2, "credibilite": 2,

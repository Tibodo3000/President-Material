...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Financer la fédération sur vos deniers", "en": "Fund the federation out of your own pocket" },
      ...
      "failure": { "effects": { "money": -40000, "appeal": { "self": -3 }, "standing": -4, "reputation": -1 },
    ...
    { "label": { "fr": "Les menacer de partir", "en": "Threaten to leave" },
      ...
      "roll": { "base": 17, "stat": "sangfroid", "plus": { "popularity": 0.07 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
    ...
    { "label": { "fr": "Publier le compte rendu de leurs quatre derniers dîners", "en": "Publish the minutes of their last four dinners" },
      ...
      "effects": { "standing": -8, "popularity": 7, "notoriete": 1, "credibilite": 1, "reputation": 1,
                   "appeal": { "self": 7 }, "landscape": { "self": -1.3 } },
   ...
   au congrès. La scène vaut donc partout sauf là. */
{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire savoir ce qu'{il} vaut vraiment", "en": "Let people know what {he} is really worth" },
      ...
      "success": { "effects": { "appeal": { "self": -3 }, "standing": 3, "reputation": -1, "notoriete": 1,
                                "landscape": { "self": -1.2 } },
      ...
      "failure": { "effects": { "standing": -12, "reputation": -1, "strike": "traitre" },
    ...
    { "label": { "fr": "Aller voir ailleurs pendant qu'{il} fait campagne", "en": "Look elsewhere while {he} campaigns" },
      "effects": { "standing": 2, "reseau": 1, "energie": -1, "appeal": { "self": 2 } },
    ...
    { "label": { "fr": "{Lui} proposer de tenir sa campagne", "en": "Offer to run {his} campaign" },
      ...
      "effects": { "reseau": 2, "standing": 6, "credibilite": 1, "energie": -2,
                   "appeal": { "self": -2 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire le tour des sections, une par une", "en": "Tour the branches, one by one" },
      "effects": { "strike": "appareil", "standing": 4, "energie": -3, "reseau": 1,
                   "appeal": { "self": -2 }, "landscape": { "self": 0.4 } },
    ...
    { "label": { "fr": "Monter une plateforme et récolter des signatures", "en": "Set up a platform and collect signatures" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "reseau": 0.4, "energie": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
    ...
    { "label": { "fr": "Appeler les onze mille, section par section, jusqu'au congrès", "en": "Call all eleven thousand, branch by branch, right up to conference" },
      ...
      "effects": { "standing": 9, "reseau": 2, "credibilite": 1, "energie": -5, "reputation": 1,
                   "appeal": { "self": 6 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser, et le dire en face", "en": "Refuse, and say so to {his} face" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "reputation": 0.35, "standing": 0.04 }, "bonus": [ { "when": { "personality": ["principled"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 2 }, { "when": { "trait": ["lache"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"reputation": 2, "standing": -3, "sangfroid": 1, "strike": "intrepide", "credibilite": 1},
      ...
      "failure": { "effects": {"standing": -10, "reseau": -2, "reputation": 1, "energie": -1},
        "result": { "fr": "Vous le dites en face, correctement, et il ne le prend pas correctement. Il a trente ans de fédération derrière lui et vous en avez quatre, et c'est cette arithmétique-là qui décide de la suite.",
                    "en": "You say it to his face, properly, and he does not take it properly. He has thirty years of the federation behind him and you have four, and it is that arithmetic which decides what happens next." } } },
    { "label": { "fr": "Accepter, et enregistrer la conversation", "en": "Accept, and record the conversation" },
      "when": { "personality": ["calculating"] },
      "effects": { "appeal": { "self": -3 }, "standing": 5, "reseau": 1, "reputation": -1, "sangfroid": 1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Servir de guide au parachuté", "en": "Show the newcomer around" },
      "effects": { "standing": 5, "reseau": 1, "reputation": -1, "energie": -1,
                   "landscape": { "self": 0.7 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Exiger de voir les chiffres", "en": "Demand to see the numbers" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "eloquence": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 15 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser et le faire savoir", "en": "Refuse it, and let it be known" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "standing": 0.05 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "standing": 3, "eloquence": 1, "notoriete": 1, "appeal": { "self": 4 }, "reputation": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Rejoindre le courant le mieux placé", "en": "Join the strongest faction" },
      "effects": { "standing": 6, "reseau": 1, "reputation": -1, "appeal": { "self": -2 } },
    ...
    { "label": { "fr": "Monter votre propre courant", "en": "Start a faction of your own" },
      "roll": { "base": 17, "stat": "charisme", "plus": { "eloquence": 0.4, "reseau": 0.3 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "standing": 8, "notoriete": 1, "energie": -2, "reseau": 1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Poser un ultimatum à la direction", "en": "Give the leadership an ultimatum" },
      "roll": { "base": 17, "stat": "sangfroid", "plus": { "standing": 0.06 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Rendre service à ceux qui décident", "en": "Do favours for the people who decide" },
      "roll": { "base": 14, "stat": "reseau", "plus": { "standing": 0.05, "sangfroid": 0.25 }, "bonus": [ { "when": { "trait": ["appareil"] }, "value": 2.5 }, { "when": { "personality": ["calculating"] }, "value": 2 }, { "when": { "personality": ["principled"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"standing": 7, "appeal": {"self": -3}, "reseau": 1, "reputation": -1},
      ...
      "failure": { "effects": {"standing": -5, "reseau": -1, "reputation": -1, "energie": -2},
        "result": { "fr": "Vous rendez onze services en dix-huit mois, dont neuf à des gens qui n'auront pas voix au chapitre le jour venu. Les deux autres s'en souviennent, et ils ne sont que deux.",
                    "en": "You do eleven favours in eighteen months, nine of them for people who will have no say when the day comes. The other two remember, and there are only two of them." } } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Aller les chercher une par une, en province", "en": "Go and get them one by one, in the provinces" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "energie": 0.4, "charisme": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 7, "reseau": 1, "energie": -3, "appeal": { "self": -2 } },
    ...
    { "label": { "fr": "Échanger vos signatures contre une place dans la future direction", "en": "Trade your signatures for a seat in the next leadership" },
      "effects": { "standing": 5, "reseau": 1, "credibilite": -1, "appeal": { "self": -2 }, "reputation": -1 },
    ...
    { "label": { "fr": "Publier la liste de ceux qui attendent", "en": "Publish the list of those who are waiting" },
      ...
      "effects": { "standing": -9, "popularity": 6, "notoriete": 1, "reputation": 1, "credibilite": 1,
                   "appeal": { "self": 8 }, "landscape": { "self": -1 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Exiger un vote des adhérents, publiquement", "en": "Demand a members' ballot, in public" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "popularity": 0.05, "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 4, "appeal": { "self": 6 }, "standing": -4, "eloquence": 1, "notoriete": 1,
                                "reputation": 1, "credibilite": 1, "landscape": { "self": -0.7 } },
    ...
    { "label": { "fr": "Ne rien dire et préparer le congrès suivant", "en": "Say nothing and prepare the next congress" },
      "effects": { "sangfroid": 1, "reseau": 1, "credibilite": 1, "standing": -2, "energie": -1 },
    ...
    { "label": { "fr": "Proposer un vote sur la ligne, pas sur les personnes", "en": "Propose a vote on the line, not on the people" },
      ...
      "effects": { "credibilite": 2, "standing": 2, "reseau": 1, "notoriete": 1,
                   "appeal": { "self": 5 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Dire tout haut qu'un candidat naturel, ça n'existe pas", "en": "Say out loud that there is no such thing as a natural candidate" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "popularity": 0.06, "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 5, "appeal": { "self": 6 }, "eloquence": 1, "notoriete": 1, "credibilite": 1,
                                "standing": -8, "landscape": { "self": -0.9 } },
      ...
      "failure": { "effects": { "popularity": -5, "standing": -11, "reputation": -1 },
    ...
    { "label": { "fr": "Demander par écrit la définition d'un candidat naturel", "en": "Ask in writing for a definition of a natural candidate" },
      "when": { "personality": ["clever"] },
      "effects": { "credibilite": 2, "notoriete": 1, "standing": -3, "reputation": 1,
                   "appeal": { "self": 6 }, "landscape": { "self": -0.4 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter, et faire campagne à fond", "en": "Accept, and campaign flat out" },
      "effects": { "standing": 10, "reseau": 1, "energie": -3, "appeal": { "self": -2 }, "credibilite": 1 },
    ...
    { "label": { "fr": "Exiger que ce soit écrit et contresigné", "en": "Insist it be put in writing and countersigned" },
      "roll": { "base": 17, "stat": "sangfroid", "plus": { "reseau": 0.4, "credibilite": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "standing": 12, "credibilite": 1, "reseau": 1, "reputation": -1 },
      ...
      "failure": { "effects": { "standing": -8, "reputation": -1, "appeal": { "self": -2 } },
    ...
    { "label": { "fr": "Refuser : on ne se vend pas avant le premier tour", "en": "Refuse: you do not sell yourself before the first round" },
      "effects": { "reputation": 2, "credibilite": 1, "sangfroid": 1, "standing": -7, "appeal": { "self": 3 } },

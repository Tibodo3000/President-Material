...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller, et faire la campagne pour de vrai", "en": "Go, and run a real campaign" },
      "effects": { "standing": 11, "energie": -3, "reputation": 1, "appeal": { "self": 5 },
    ...
    { "label": { "fr": "Trouver quelqu'un d'autre, et le convaincre vous-même", "en": "Find somebody else, and talk them into it yourself" },
      ...
      "success": { "effects": { "standing": 6, "reseau": 1, "energie": -1, "landscape": { "self": 0.7 } },
      ...
      "failure": { "effects": { "standing": -7, "reseau": -1, "reputation": -1, "landscape": { "self": -0.8 } },
    ...
    { "label": { "fr": "Y aller et payer la campagne de votre poche", "en": "Go, and pay for the campaign yourself" },
      ...
      "effects": { "money": -70000, "standing": 14, "notoriete": 1, "energie": -3,
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller vous-même", "en": "Go yourself" },
      "effects": { "popularity": 7, "notoriete": 2, "standing": -8, "landscape": { "self": -0.4 } },
    ...
    { "label": { "fr": "Laisser la place au porte-parole", "en": "Give the slot to the spokesperson" },
      "effects": { "standing": 9, "reseau": 1, "notoriete": -1, "popularity": -2, "landscape": { "self": 1.3 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "L'accueillir sans lui donner de place", "en": "Take {him} in without giving {him} anything" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "reseau": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter la mission", "en": "Accept the commission" },
      "effects": { "credibilite": 2, "notoriete": 1, "energie": -2, "approval": 5, "standing": -8,
    ...
    { "label": { "fr": "Accepter, et rendre un rapport qui les gêne", "en": "Accept, and hand in a report that embarrasses them" },
      "roll": { "base": 17, "stat": "credibilite", "plus": { "sangfroid": 0.4, "eloquence": 0.3 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "popularity": 5, "notoriete": 1, "approval": -7, "standing": 3,
      ...
      "failure": { "effects": { "credibilite": -1, "energie": -2, "approval": 4, "standing": -7,
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter le face-à-face", "en": "Take the head-to-head" },
      "effects": { "notoriete": 2, "popularity": 6, "credibilite": 1, "energie": -2,
    ...
    { "label": { "fr": "Accepter, à condition qu'ils soient quatre sur le plateau", "en": "Accept, on condition that four of them are on set" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "notoriete": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "notoriete": 1, "popularity": 3, "credibilite": 1, "standing": 2,
                                "landscape": { "scene": 0.3 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Porter la ligne dure, et la porter vous-même", "en": "Take the hard line, and carry it yourself" },
      "effects": { "axis": "self", "popularity": 9, "standing": 9, "notoriete": 1, "credibilite": -1,
    ...
    { "label": { "fr": "Tenir la ligne modérée et l'assumer devant les militants", "en": "Hold the moderate line and defend it to the members" },
      "effects": { "credibilite": 2, "reputation": 1, "popularity": 4, "standing": -7,
    ...
    { "label": { "fr": "Laisser le bureau politique se déchirer sans vous", "en": "Let the executive tear itself apart without you" },
      "effects": { "sangfroid": 1, "energie": 1, "standing": -4, "credibilite": -1,
                   "landscape": { "self": -0.9 } },
    ...
    { "label": { "fr": "Écrire vous-même une troisième ligne, et la faire voter", "en": "Write a third line yourself, and get it voted through" },
      "when": { "minStanding": 55 },
      "roll": { "base": 17, "stat": "eloquence", "plus": { "reseau": 0.4, "standing": 0.05 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "standing": 8, "eloquence": 1, "popularity": 3,
                                "landscape": { "self": 1.2 } },
      ...
      "failure": { "effects": { "standing": -9, "credibilite": -1, "energie": -2,
                                "landscape": { "self": -1.1 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout publier, vous-même et sous votre nom", "en": "Publish it all, yourself and under your own name" },
      "effects": { "notoriete": 2, "popularity": -4, "reputation": -1, "standing": 6,
    ...
    { "label": { "fr": "Le garder, et le faire savoir à l'intéressé", "en": "Keep it, and let the subject know you have it" },
      "effects": { "reseau": 2, "standing": 7, "reputation": -1, "sangfroid": 1 },
    ...
    { "label": { "fr": "Le donner à un journal et n'y être pour rien", "en": "Give it to a newspaper and have nothing to do with it" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "reseau": 0.45 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "reputation": -2, "popularity": -8, "standing": -6, "strike": "menteur",
    ...
    { "label": { "fr": "Le rendre à celui qui vous l'a apporté", "en": "Hand it back to whoever brought it" },
      ...
      "effects": { "reputation": 2, "credibilite": 1, "standing": -5, "reseau": -1 },

...

{
  ...
  "choices": [
    { "label": { "fr": "Le suspendre immédiatement et le dire publiquement", "en": "Suspend him immediately, and say so publicly" },
      "effects": { "axis": {"social": -60}, "reputation": 2, "popularity": 9, "standing": -12, "credibilite": 1, "notoriete": 1,
                   "landscape": { "self": 0.6 } },
    ...
    { "label": { "fr": "Rappeler qu'il faut laisser la justice faire son travail", "en": "Insist that the courts must be allowed to do their work" },
      "effects": { "axis": {"social": 55}, "reputation": -1, "standing": 8, "popularity": 6, "credibilite": -1,
    ...
    { "label": { "fr": "Aller la voir, l'écouter, et l'accompagner jusqu'au bout", "en": "Go and see her, listen, and stay with it to the end" },
      "when": { "minStanding": 40 },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "reputation": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "reputation": 2, "credibilite": 2, "popularity": 7, "standing": -6, "energie": -2,
                                "landscape": { "self": 1 } },
      ...
      "failure": { "effects": { "reputation": 1, "standing": -14, "popularity": -3, "energie": -2, "chain": "vss_presse" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Reconnaître qu'on n'a pas su faire", "en": "Admit that you failed" },
      "effects": { "reputation": 1, "credibilite": 1, "popularity": -5, "standing": -8 },
    ...
    { "label": { "fr": "Défendre la procédure suivie", "en": "Defend the process that was followed" },
      ...
      "success": { "effects": {"reputation": -1, "popularity": -13, "standing": 4, "credibilite": 1, "strike": "menteur", "landscape": {"self": -1.2, "identitarians": 0.5}},
      ...
      "failure": { "effects": {"popularity": -13, "credibilite": -2, "standing": -4, "reputation": -1, "appeal": {"others": -5}},
    ...
    { "label": { "fr": "Faire porter la responsabilité à la direction sortante", "en": "Pin it on the outgoing leadership" },
      "effects": { "popularity": 4, "standing": -10, "reputation": -1, "strike": "traitre",
                   "landscape": { "self": -0.6 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Refuser : ce n'est pas là qu'on fait de la politique", "en": "Refuse: that is not where politics happens" },
      "effects": { "credibilite": 1, "standing": 3, "notoriete": -1, "popularity": -5 },
    ...
    { "label": { "fr": "Laisser l'équipe s'en occuper à votre place", "en": "Let the team run it for you" },
      "effects": { "notoriete": 2, "popularity": 4, "reputation": -1, "credibilite": -1 },
    ...
    { "label": { "fr": "S'y mettre soi-même, sans filet", "en": "Do it yourself, with no safety net" },
      ...
      "success": { "effects": { "charisme": 1, "notoriete": 2, "popularity": 12, "credibilite": -1, "energie": -1,
                                "landscape": { "self": 1.1 } },
      ...
      "failure": { "effects": { "notoriete": 2, "popularity": -9, "credibilite": -2, "reputation": -1,
                                "landscape": { "self": -0.6 } },
    ...
    { "label": { "fr": "Payer une agence spécialisée", "en": "Pay a specialist agency" },
      "when": { "minMoney": 70000 },
      "effects": { "money": -55000, "notoriete": 2, "popularity": 6, "reputation": -1, "credibilite": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Porter plainte et faire expertiser", "en": "File a complaint and get it examined" },
      "effects": { "reputation": 1, "credibilite": 1, "popularity": -3, "energie": -1, "money": -15000 },
    ...
    { "label": { "fr": "En rire et republier la vidéo vous-même", "en": "Laugh, and repost the video yourself" },
      ...
      "success": { "effects": { "charisme": 1, "notoriete": 1, "popularity": 11, "credibilite": 1, "trait": "teflon",
                                "landscape": { "self": 0.7 } },
      ...
      "failure": { "effects": { "notoriete": 1, "popularity": -8, "credibilite": -1,
                                "landscape": { "self": -0.5 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Renoncer publiquement à l'avion", "en": "Publicly give up the plane" },
      "effects": { "reputation": 2, "popularity": 10, "energie": -4, "credibilite": 1, "standing": -5,
                   "landscape": { "self": 0.6 } },
    ...
    { "label": { "fr": "Expliquer les contraintes d'agenda", "en": "Explain the diary constraints" },
      "roll": { "base": 15, "stat": "credibilite",
                "plus": { "sangfroid": 0.35, "standing": 0.04 },
                "bonus": [ { "when": { "background": ["civil", "law"] }, "value": 1.5 },
                           { "when": { "trait": ["clairvoyant"] }, "value": 1.5 },
                           { "when": { "position": ["premier", "ministre"] }, "value": 1.5 } ],
                "dice": 16 },
      "success": { "effects": { "popularity": -3, "standing": 5, "credibilite": 1, "energie": 1 },
        "result": { "fr": "Vous sortez l'agenda de la journée, minute par minute, et il se trouve qu'il tient. Le sujet meurt en trente-six heures, votre cabinet respire, et personne ne vous en saura gré.",
                    "en": "You produce the day's diary, minute by minute, and it happens to hold up. The story dies within thirty-six hours, your office breathes again, and nobody will thank you for it." } },
      "failure": { "effects": { "popularity": -11, "standing": 2, "reputation": -1, "credibilite": -1,
                                "landscape": { "self": -0.9, "identitarians": 0.6 } },
    ...
    { "label": { "fr": "Retourner l'attaque contre ceux qui la portent", "en": "Turn the attack back on those making it" },
      "roll": { "base": 17, "stat": "eloquence", "plus": { "sangfroid": 0.35 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "eloquence": 1, "notoriete": 1, "popularity": 10, "standing": 6, "credibilite": -1,
                                "landscape": { "self": 0.8 } },
      ...
      "failure": { "effects": { "popularity": -11, "reputation": -1, "credibilite": -1,
                                "landscape": { "self": -0.8 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Un coup d'éclat, quitte à tout risquer", "en": "A dramatic gesture, whatever the risk" },
      "roll": { "base": 14, "stat": "charisme", "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "charisme": 1, "notoriete": 1, "popularity": 18, "standing": -5 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Occuper le terrain comme un vainqueur", "en": "Act like the winner" },
      "roll": { "base": 16, "stat": "charisme", "plus": { "popularity": 0.05, "notoriete": 0.25 }, "bonus": [ { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "personality": ["provocative"] }, "value": 1.5 }, { "when": { "trait": ["teflon"] }, "value": 2 } ], "dice": 16 },
      "success": { "effects": {"charisme": 1, "notoriete": 1, "popularity": 6, "standing": 8},
      ...
      "failure": { "effects": {"popularity": -12, "credibilite": -1, "standing": -4, "reputation": -1},
        "result": { "fr": "Vous parlez comme si c'était fait, et une caméra vous filme en train de dire « quand nous serons au pouvoir » à six mois du scrutin. Le mot arrogance apparaît dans quatre éditoriaux la même semaine.",
                    "en": "You speak as though it were settled, and a camera catches you saying « when we are in government » six months out. The word arrogance appears in four editorials in the same week." } } },
    { "label": { "fr": "Composer votre gouvernement à l'avance", "en": "Draw up your government in advance" },
      "effects": { "reseau": 1, "standing": 9, "popularity": -7, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Assumer votre réussite", "en": "Own your success" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "charisme": 0.35, "credibilite": 0.25 }, "bonus": [ { "when": { "background": ["business"] }, "value": 2 }, { "when": { "origin": ["modest"] }, "value": 2 }, { "when": { "party": ["radical_left", "socdem"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"sangfroid": 1, "standing": 8, "popularity": 5, "credibilite": 1},
      ...
      "failure": { "effects": {"popularity": -11, "standing": -5, "reputation": -1, "appeal": {"self": -7}},
        "result": { "fr": "Vous expliquez que vous avez travaillé, ce qui est vrai, devant des gens qui travaillent aussi. La phrase est reprise sans le contexte, et il n'y a pas de contexte qui la sauve.",
                    "en": "You explain that you worked for it, which is true, in front of people who also work. The line is quoted without the context, and there is no context that saves it." } } },
    { "label": { "fr": "Reverser une part à une fondation", "en": "Give a share to a foundation" },
      "effects": { "money": -350000, "reputation": 1, "popularity": 12, "standing": -5 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire campagne sans un sou", "en": "Campaign without a penny" },
      ...
      "effects": { "energie": -2, "reputation": 1, "popularity": 6, "standing": -4 },
    ...
    { "label": { "fr": "Prendre une place dans un conseil d'administration", "en": "Take a seat on a company board" },
      "roll": { "base": 14, "stat": "reseau", "plus": { "credibilite": 0.3, "standing": 0.04 }, "bonus": [ { "when": { "background": ["business"] }, "value": 2.5 }, { "when": { "origin": ["bourgeois", "dynasty"] }, "value": 1.5 }, { "when": { "personality": ["principled"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": {"money": 40000, "reseau": 2, "credibilite": 1, "reputation": -1, "popularity": -6, "flags": {"dirtyMoney": true}},
      ...
      "failure": { "effects": {"money": 60000, "popularity": -10, "credibilite": -1, "reputation": -1, "strike": "casserole"},
        "result": { "fr": "Le mandat est déclaré, publié, et parfaitement légal. La société obtient un agrément quatorze mois plus tard, sur un dossier que vous n'avez pas suivi, et le rapprochement se fait tout seul dans un article de six cents signes.",
                    "en": "The directorship is declared, published and entirely lawful. The company obtains a licence fourteen months later, on a file you had nothing to do with, and the connection makes itself in a six-hundred-character article." } } }
  ]
},
...

{
  ...
  "choices": [
    { "label": { "fr": "Reconnaître le privilège", "en": "Acknowledge the privilege" },
      ...
      "success": { "effects": { "reputation": 1, "popularity": 12 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Expliquer sérieusement", "en": "Explain it properly" },
      "effects": { "credibilite": +1, "eloquence": 1, "reputation": 1, "popularity": 5, "standing": 7,
                   "notoriete": -1, "energie": -2 },
    ...
    { "label": { "fr": "Simplifier à l'extrême", "en": "Simplify brutally" },
      "effects": { "credibilite": -1, "notoriete": 2, "reputation": -1, "popularity": 10, "standing": -4,
                   "landscape": { "self": 0.7 } },
    ...
    { "label": { "fr": "Publier une note technique détaillée", "en": "Publish a detailed technical note" },
      ...
      "effects": { "credibilite": +2, "eloquence": 1, "reputation": 1, "standing": 8, "popularity": -3 },
    ...
    { "label": { "fr": "Proposer votre expertise au gouvernement", "en": "Offer your expertise to the government" },
      ...
      "roll": { "base": 14, "stat": "reseau", "plus": { "eloquence": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": +1, "reseau": 1, "reputation": 1, "standing": 9, "popularity": 5 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Lâcher la phrase qui fâche", "en": "Say the line that will hurt" },
      "roll": { "base": 14, "stat": "charisme", "plus": { "eloquence": 0.35, "notoriete": 0.25 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2.5 }, { "when": { "background": ["celebrity"] }, "value": 1.5 }, { "when": { "minPopularity": 60 }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"axis": "self", "charisme": 1, "notoriete": 1, "reputation": -1, "popularity": 7, "standing": -9},
      ...
      "failure": { "effects": {"popularity": -10, "reputation": -1, "credibilite": -1, "standing": -6, "strike": "radical"},
        "result": { "fr": "La phrase sort telle que vous l'aviez pensée et elle est reprise sans la seconde partie, celle qui l'expliquait. Vous passez la semaine à réclamer qu'on la cite en entier, ce que personne n'a jamais obtenu.",
                    "en": "The line comes out exactly as you meant it and is quoted without the second half, the half that explained it. You spend the week demanding it be quoted in full, which nobody has ever achieved." } } },
    { "label": { "fr": "Vous retenir, pour une fois", "en": "Hold back, for once" },
      "effects": { "sangfroid": 1, "standing": 8, "popularity": -4, "reputation": 1 },
    ...
    { "label": { "fr": "Lâcher la phrase, puis s'excuser à moitié", "en": "Say it, then half-apologise" },
      "effects": { "notoriete": 1, "popularity": 5, "standing": -3, "reputation": -1, "strike": "menteur" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Renouveler tout l'état-major", "en": "Replace the entire leadership team" },
      ...
      "failure": { "effects": { "reseau": -1, "standing": -16, "popularity": -5 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire fuiter un sondage encore meilleur", "en": "Leak an even better poll" },
      ...
      "roll": { "base": 14, "stat": "reseau", "plus": { "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      ...
      "failure": { "effects": { "reputation": -1, "standing": -8 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Écrire un texte clivant", "en": "Write something divisive" },
      "roll": { "base": 14, "stat": "eloquence", "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "landscape": { "self": -0.8 }, "eloquence": 1, "notoriete": 1, "reseau": -1, "popularity": 10, "standing": -8 },
    ...
    { "label": { "fr": "Une tribune cosignée par des chercheurs", "en": "An op-ed co-signed by academics" },
      ...
      "effects": { "landscape": { "self": 0.6 }, "eloquence": 1, "reputation": 1, "popularity": 6, "standing": 5, "energie": -1 },
    ...
    { "label": { "fr": "Écrire sur votre parti lui-même", "en": "Write about your own party" },
      ...
      "effects": { "landscape": { "self": -1.5 }, "reputation": 1, "notoriete": 1, "popularity": 8, "standing": -13 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Voter contre, en conscience", "en": "Vote your conscience" },
      "effects": { "reputation": 1, "reseau": -1, "popularity": 12, "standing": -18, "appeal": { "self": -7 } },
    ...
    { "label": { "fr": "Faire changer la consigne de vote", "en": "Get the whip changed" },
      "when": { "position": ["chef"] },
      "roll": { "base": 15, "stat": "reseau", "plus": { "standing": 0.05, "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
    ...
    { "label": { "fr": "Voter contre et l'expliquer au groupe", "en": "Vote against and explain it to the group" },
      "when": { "personality": ["principled"] },
      "effects": { "reputation": 2, "eloquence": 1, "popularity": 12, "standing": -10 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Écrire un vrai essai", "en": "Write a serious essay" },
      ...
      "effects": { "money": 20000, "eloquence": 1, "reputation": 1, "energie": -1, "popularity": 5, "standing": 6 },
    ...
    { "label": { "fr": "Le faire écrire par quelqu'un d'autre", "en": "Have someone else write it" },
      ...
      "success": { "effects": { "money": 55000, "notoriete": 1, "popularity": 7 },
      ...
      "failure": { "effects": { "reputation": -2, "popularity": -9, "standing": -6 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Passer trois nuits sur le terrain", "en": "Spend three nights on the ground" },
      "when": { "stat": { "energie": { "min": 8 } } },
      "effects": { "reputation": 1, "notoriete": 1, "energie": -2, "popularity": 16, "standing": 2 },
    ...
    { "label": { "fr": "Coordonner depuis la mairie", "en": "Coordinate from the town hall" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "credibilite": 0.35, "energie": 0.25 }, "bonus": [ { "when": { "background": ["civil"] }, "value": 2.5 }, { "when": { "personality": ["hardworking"] }, "value": 1.5 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"sangfroid": 1, "reputation": -1, "popularity": 8, "standing": 5, "credibilite": 2},
      ...
      "failure": { "effects": {"popularity": -6, "credibilite": -1, "energie": -3, "standing": -2},
        "result": { "fr": "La cellule de crise siège en salle du conseil avec onze personnes, dont quatre qui n'ont aucune compétence pour être là et deux qui en ont et qu'on n'écoute pas. Le préfet reprend la main le lendemain à sept heures, ce qui règle le problème et le vôtre.",
                    "en": "The crisis unit sits in the council chamber with eleven people, four of whom have no business being there and two of whom know what they are doing and are not listened to. The prefect takes over at seven the next morning, which solves the problem and yours." } } },
    ...
    { "label": { "fr": "Débloquer un fonds sur vos deniers", "en": "Open a fund from your own money" },
      ...
      "effects": { "money": -120000, "reputation": 1, "popularity": 15, "standing": -3 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser et continuer normalement", "en": "Refuse and carry on" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "reputation": 0.3, "energie": 0.25 }, "bonus": [ { "when": { "trait": ["intrepide"] }, "value": 2.5 }, { "when": { "personality": ["principled"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"strike": "intrepide", "reputation": 1, "notoriete": 1, "popularity": 7, "sangfroid": 1, "energie": -1},
        "result": { "fr": "Le courage est remarqué. Votre famille, elle, ne dort plus.",
                  "en": "The courage is noticed. Your family stops sleeping." } },
      "failure": { "effects": {"energie": -3, "popularity": -3, "standing": -3, "credibilite": -1},
        "result": { "fr": "Vous continuez normalement, ce qui veut dire une permanence, un marché et deux réunions publiques par semaine. La préfecture propose une protection, vous la refusez par écrit, et c'est cette lettre-là qu'on citera si quelque chose arrive.",
                    "en": "You carry on as normal, which means one surgery, one market and two public meetings a week. The prefecture offers protection, you decline in writing, and it is that letter that will be quoted if anything happens." } } },
    { "label": { "fr": "En faire un sujet politique", "en": "Make it a political subject" },
      "when": { "personality": ["provocative"] },
      "effects": { "notoriete": 2, "popularity": 7, "standing": -6, "sangfroid": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Écrire à la préfecture avec les bons articles", "en": "Write to the prefecture citing the right articles" },
      ...
      "effects": { "credibilite": 2, "reputation": 1, "popularity": 4, "energie": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Repartir avec les onze dossiers qu'on vous a glissés", "en": "Leave with the eleven files people slipped you" },
      "effects": { "reputation": 1, "popularity": 3, "reseau": 1, "energie": -2 },
    ...
    { "label": { "fr": "Faire les deux cents photos qu'on vous demande", "en": "Take all two hundred photographs people ask for" },
      ...
      "effects": { "notoriete": 1, "popularity": 6, "energie": -2, "credibilite": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Chercher qui l'a écrite", "en": "Find out who wrote it" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "sangfroid": 0.35 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "standing": 4, "sangfroid": 1, "credibilite": 1 },
      ...
      "failure": { "effects": { "reseau": -1, "standing": -3, "energie": -1 },
    ...
    { "label": { "fr": "La faire sortir en entier, avec la mise en page d'origine", "en": "Get it out in full, with the original layout" },
      ...
      "effects": { "notoriete": 1, "popularity": 3, "credibilite": 1, "standing": -6, "reputation": -1 },

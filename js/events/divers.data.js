...

{
  ...
  "choices": [
    { "label": { "fr": "Renoncer publiquement à l'avion", "en": "Publicly give up the plane" },
      "effects": { "reputation": 3, "popularity": 10, "energie": -4, "credibilite": 1, "standing": -5,
                   "landscape": { "self": 0.6 } },
    ...
    { "label": { "fr": "Expliquer les contraintes d'agenda", "en": "Explain the diary constraints" },
      "roll": { "base": 15, "stat": "credibilite",
                ...
                "dice": 16 },
      "success": { "effects": { "popularity": -3, "standing": 5, "credibilite": 2, "energie": 1 },
      ...
      "failure": { "effects": { "popularity": -11, "standing": 2, "reputation": -1, "credibilite": -2,
    ...
    { "label": { "fr": "Retourner l'attaque contre ceux qui la portent", "en": "Turn the attack back on those making it" },
      ...
      "success": { "effects": { "notoriete": 3, "popularity": 10, "standing": 6, "credibilite": -1,
                                "landscape": { "self": 0.8 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Occuper le terrain comme un vainqueur", "en": "Act like the winner" },
      ...
      "success": { "effects": {"notoriete": 2, "popularity": 6, "standing": 8},
      ...
      "failure": { "effects": {"popularity": -12, "credibilite": -2, "standing": -4, "reputation": -2},
...

{
  ...
  "choices": [
    { "label": { "fr": "Assumer votre réussite", "en": "Own your success" },
      ...
      "success": { "effects": {"sangfroid": 1, "standing": 8, "popularity": 5, "credibilite": 2},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Prendre une place dans un conseil d'administration", "en": "Take a seat on a company board" },
      ...
      "success": { "effects": {"money": 40000, "reseau": 3, "credibilite": 1, "reputation": -2, "popularity": -6, "flags": {"dirtyMoney": true}},
      ...
      "failure": { "effects": {"money": 60000, "popularity": -10, "credibilite": -2, "reputation": -1, "strike": "casserole"},
...

{
  ...
  "choices": [
    { "label": { "fr": "Expliquer sérieusement", "en": "Explain it properly" },
      "effects": { "credibilite": +2, "eloquence": 1, "reputation": 2, "popularity": 5, "standing": 7,
    ...
    { "label": { "fr": "Simplifier à l'extrême", "en": "Simplify brutally" },
      "effects": { "credibilite": -1, "notoriete": 4, "reputation": -1, "popularity": 10, "standing": -4,
                   "landscape": { "self": 0.7 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Lâcher la phrase qui fâche", "en": "Say the line that will hurt" },
      ...
      "success": { "effects": {"axis": "self", "notoriete": 3, "reputation": -2, "popularity": 7, "standing": -9},
      ...
      "failure": { "effects": {"popularity": -10, "reputation": -2, "credibilite": -2, "standing": -6, "strike": "radical"},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Coordonner depuis la mairie", "en": "Coordinate from the town hall" },
      ...
      "success": { "effects": {"sangfroid": 1, "reputation": -1, "popularity": 8, "standing": 5, "credibilite": 3},
      ...
      "failure": { "effects": {"popularity": -6, "credibilite": -2, "energie": -3, "standing": -2},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser et continuer normalement", "en": "Refuse and carry on" },
      ...
      "success": { "effects": {"strike": "intrepide", "reputation": 2, "notoriete": 1, "popularity": 7, "sangfroid": 1, "energie": -1},

...

{
  ...
  "choices": [
    { "label": { "fr": "Déposer une loi : l'ombre ne se vend pas", "en": "Table a bill: shade is not for sale" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "credibilite": 0.4, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": { "economy": -70, "power": -30 }, "popularity": 9, "eloquence": 1, "notoriete": 1,
                                "credibilite": 1, "landscape": { "self": 0.9 } },
    ...
    { "label": { "fr": "Négocier une tarification sociale avec l'exploitant", "en": "Negotiate a social tariff with the operator" },
      "effects": { "credibilite": 1, "reseau": 1, "reputation": 1, "popularity": 2, "energie": -1 },
    ...
    { "label": { "fr": "Assumer : la ville n'avait pas d'autre solution", "en": "Own it: the town had no other option" },
      "effects": { "axis": { "economy": 75 }, "popularity": 6, "credibilite": 1, "standing": 4, "reputation": -1 },
    ...
    { "label": { "fr": "Passer l'après-midi dans la file, avec les autres", "en": "Spend the afternoon in the queue, with everyone else" },
      ...
      "effects": { "popularity": 8, "notoriete": 1, "energie": -2, "credibilite": -1, "standing": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Rétablir le porc, et une seule barquette pour tout le monde", "en": "Put pork back, one tray for everybody" },
      "effects": { "axis": { "social": 65, "world": 40 }, "popularity": 8, "standing": 5, "notoriete": 1,
                   "reputation": -1 },
    ...
    { "label": { "fr": "Maintenir la décision et refuser d'en faire un sujet", "en": "Stand by the decision and refuse to make it a story" },
      "effects": { "axis": { "social": -60, "world": -40 }, "popularity": 7, "credibilite": 1, "standing": -6,
                   "energie": -1 },
    ...
    { "label": { "fr": "Mettre deux menus, et laisser chacun choisir", "en": "Offer two menus and let everyone choose" },
      "effects": { "credibilite": 1, "reputation": 1, "money": -25000, "popularity": 3, "standing": -2,
                   "appeal": { "self": -3 } },
    ...
    { "label": { "fr": "Recevoir les bouchers, et sortir avec eux devant les caméras", "en": "Receive the butchers, and come out with them in front of the cameras" },
      ...
      "success": { "effects": { "reseau": 1, "popularity": 5, "standing": 6, "credibilite": 1, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre un arrêté municipal et couper l'eau du golf", "en": "Issue a municipal order and cut the golf course off" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "credibilite": 0.4, "popularity": 0.05 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": { "economy": -55, "power": -40 }, "popularity": 12, "notoriete": 2,
      ...
      "failure": { "effects": { "popularity": -5, "credibilite": -1, "reputation": -1, "energie": -2,
                                "money": -15000 },
    ...
    { "label": { "fr": "Attaquer la dérogation devant le tribunal administratif", "en": "Challenge the exemption in the administrative court" },
      "effects": { "credibilite": 2, "reputation": 1, "money": -20000, "popularity": 2, "energie": -1,
    ...
    { "label": { "fr": "Emmener la presse au bord du green, à sept heures", "en": "Take the press to the edge of the green, at seven in the morning" },
      "effects": { "axis": { "economy": -60 }, "popularity": 10, "notoriete": 2, "reseau": -1,
...

{
  ...
  "choices": [
    { "label": { "fr": "En faire une conférence de presse", "en": "Hold a press conference about it" },
      "effects": { "popularity": 5, "credibilite": 1, "notoriete": 1, "energie": -1 },
    ...
    { "label": { "fr": "Le garder pour l'été prochain", "en": "Keep it for next summer" },
      "effects": { "sangfroid": 1, "credibilite": 1, "standing": 2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Voter pour, et l'assumer sur le marché samedi", "en": "Vote yes, and defend it at the market on Saturday" },
      "effects": { "axis": { "economy": 60 }, "popularity": 5, "standing": 8, "reseau": 1,
    ...
    { "label": { "fr": "Voter contre, et le faire savoir", "en": "Vote no, and let it be known" },
      "effects": { "axis": { "economy": -55, "social": -35 }, "popularity": 9, "standing": -11,
                   "notoriete": 1, "reputation": 1, "landscape": { "self": -0.6 } },
    ...
    { "label": { "fr": "Voter contre et laisser croire que vous avez voté pour", "en": "Vote no and let them believe you voted yes" },
      ...
      "failure": { "effects": { "standing": -13, "reputation": -1, "popularity": -6, "strike": "menteur" },
    ...
    { "label": { "fr": "Obtenir la forêt d'à côté en compensation, et voter pour", "en": "Get the neighbouring woodland protected in exchange, and vote yes" },
      ...
      "roll": { "base": 16, "stat": "reseau", "plus": { "credibilite": 0.4, "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "standing": 6, "reputation": 1, "popularity": 4,
                                "reseau": 1, "energie": -2 },
      ...
      "failure": { "effects": { "standing": -6, "credibilite": -1, "energie": -2, "popularity": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Le dire tout haut, avec le montant", "en": "Say it out loud, with the figure" },
      "effects": { "popularity": 9, "notoriete": 1, "standing": -9, "reputation": 1,
                   "appeal": { "self": -4 } },
    ...
    { "label": { "fr": "Défendre l'art dans la ville, sans rire", "en": "Defend art in the public realm, with a straight face" },
      "effects": { "standing": 7, "reseau": 1, "popularity": -6, "credibilite": -1 },
    ...
    { "label": { "fr": "Proposer de la revendre et de rendre l'argent", "en": "Propose selling it off and giving the money back" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "standing": 0.04 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 7, "credibilite": 1, "standing": -4, "notoriete": 1 },
    ...
    { "label": { "fr": "L'inaugurer vous-même, très sérieusement", "en": "Unveil it yourself, with total seriousness" },
      ...
      "effects": { "notoriete": 2, "popularity": 6, "standing": -5, "credibilite": -1, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Démonter la méthode, point par point", "en": "Take the methodology apart, point by point" },
      "roll": { "base": 15, "stat": "credibilite", "plus": { "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "popularity": 5, "notoriete": 1, "reputation": 1 },
      ...
      "failure": { "effects": { "popularity": -6, "credibilite": -1, "notoriete": 1 },
    ...
    { "label": { "fr": "Commander une campagne d'image", "en": "Commission an image campaign" },
      ...
      "effects": { "money": -80000, "popularity": 4, "notoriete": 1, "reputation": -1, "credibilite": -1 },
    ...
    { "label": { "fr": "Assumer, et en faire le nom de la ville", "en": "Own it, and make it the town's name" },
      "roll": { "base": 16, "stat": "charisme", "plus": { "eloquence": 0.45 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 11, "charisme": 1, "notoriete": 2, "standing": -3, "credibilite": -1,
                                "landscape": { "self": 0.6 } },
    ...
    { "label": { "fr": "Inviter la rédaction à passer trois jours sur place", "en": "Invite the newsroom to spend three days in town" },
      "effects": { "money": -12000, "reseau": 1, "credibilite": 1, "popularity": 3, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout annuler et refaire la billetterie au nom", "en": "Void everything and reissue named tickets" },
      "effects": { "popularity": 8, "credibilite": 1, "energie": -3, "money": -18000, "reseau": -1,
                   "standing": -2 },
    ...
    { "label": { "fr": "Racheter des places sur la revente pour les jeunes de la ville", "en": "Buy tickets back off the resale sites for local young people" },
      "when": { "minMoney": 60000 },
      "effects": { "money": -40000, "popularity": 6, "notoriete": 1, "credibilite": -2, "reputation": -1 },
    ...
    { "label": { "fr": "Trouver qui a vendu les six mille places en douze secondes", "en": "Find out who sold six thousand tickets in twelve seconds" },
      ...
      "roll": { "base": 17, "stat": "reseau", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "popularity": 9, "notoriete": 1, "reputation": 1,
...

{
  ...
  "choices": [
    { "label": { "fr": "Porter l'interdiction, et la porter en votre nom", "en": "Carry the ban, and carry it in your own name" },
      "roll": { "base": 17, "stat": "credibilite", "plus": { "eloquence": 0.4, "reseau": 0.3 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "axis": { "power": -45, "economy": -40 }, "popularity": 12, "notoriete": 2,
                                "credibilite": 2, "reputation": 1, "landscape": { "self": 1.2 } },
      ...
      "failure": { "effects": { "popularity": -6, "credibilite": -1, "energie": -3, "standing": -5,
                                "appeal": { "self": -4 } },
    ...
    { "label": { "fr": "Négocier une vérification d'âge et un algorithme bridé", "en": "Negotiate age verification and a throttled algorithm" },
      "effects": { "credibilite": 2, "reseau": 2, "reputation": 1, "popularity": 3, "energie": -2,
    ...
    { "label": { "fr": "Défendre les quinze mille emplois de la région", "en": "Defend the region's fifteen thousand jobs" },
      "effects": { "axis": { "economy": 65 }, "popularity": 5, "standing": 6, "reseau": 1,
                   "credibilite": -1, "reputation": -1, "chain": "ep_ecrans_retour" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Rappeler ce qu'ils avaient promis, avec les dates", "en": "Recall what they promised, with the dates" },
      "effects": { "popularity": 6, "credibilite": 1, "notoriete": 1, "reputation": 1, "standing": -2 },
    ...
    { "label": { "fr": "Ne pas revenir dessus et travailler la reconversion", "en": "Let it go and work on redeployment" },
      "effects": { "reseau": 2, "credibilite": 1, "energie": -2, "standing": 3, "popularity": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Publier vos propres notes le jour même", "en": "Publish your own claims the same day" },
      "effects": { "reputation": 2, "credibilite": 1, "popularity": 9, "standing": -10,
                   "appeal": { "self": -4 }, "notoriete": 1 },
    ...
    { "label": { "fr": "Invoquer la vie privée, et fermer le sujet", "en": "Invoke privacy, and close the subject" },
      "effects": { "standing": 9, "reseau": 1, "popularity": -8, "credibilite": -1, "reputation": -1 },
    ...
    { "label": { "fr": "Demander sa démission de la présidence du groupe", "en": "Demand that {he} stand down as chair of the group" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "standing": 0.05, "popularity": 0.05 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 8, "standing": 6, "credibilite": 1, "reputation": 1,
    ...
    { "label": { "fr": "Proposer que l'enveloppe soit contrôlée et publiée", "en": "Propose that the allowance be audited and published" },
      "effects": { "axis": { "power": -50 }, "popularity": 10, "credibilite": 2, "standing": -12,
                   "reputation": 1, "chain": "position_impopulaire" },
...

{
  ...
  "choices": [
    { "label": { "fr": "En faire une affaire nationale", "en": "Make it a national story" },
      ...
      "roll": { "base": 22, "stat": "charisme", "plus": { "sangfroid": 0.6, "notoriete": 0.25 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "charisme": 1, "notoriete": 2, "popularity": 10, "standing": 4, "credibilite": 1,
      ...
      "failure": { "effects": { "reputation": -1, "popularity": -8, "credibilite": -1, "standing": -3,
                                "energie": -2 },
      ...
      "triumph": { "effects": { "charisme": 1, "notoriete": 2, "popularity": 13, "standing": 5, "credibilite": 1,
      ...
      "debacle": { "effects": { "reputation": -2, "notoriete": 1, "popularity": -11, "credibilite": -1,
    ...
    { "label": { "fr": "Multiplier les contrôles jusqu'à ce qu'il renonce", "en": "Send in the inspectors until he gives up" },
      "roll": { "base": 17, "stat": "sangfroid", "plus": { "reseau": 0.5 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "credibilite": -2, "popularity": -6, "reputation": -1, "standing": -2,
                                "energie": -2 },
      ...
      "debacle": { "effects": { "credibilite": -2, "popularity": -9, "reputation": -1, "standing": -3,
    ...
    { "label": { "fr": "Laisser le dossier suivre son cours", "en": "Let the file take its course" },
      "roll": { "base": 8, "stat": "sangfroid", "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 12 },
      ...
      "failure": { "effects": { "popularity": -3, "credibilite": -1, "standing": -2,
    ...
    { "label": { "fr": "Attaquer l'ouverture sur le changement de destination", "en": "Challenge the opening on the change of use" },
      ...
      "success": { "effects": { "money": -12000, "credibilite": 1, "reputation": 1, "popularity": 4,
                                "standing": 2 },
    ...
    { "label": { "fr": "Le défendre publiquement : c'est un commerce qui embauche", "en": "Defend him publicly: it is a business that hires" },
      ...
      "success": { "effects": { "axis": { "economy": -60, "social": -25 }, "popularity": 10, "eloquence": 1, "notoriete": 1,
      ...
      "failure": { "effects": { "axis": { "economy": -50 }, "popularity": 3, "credibilite": -1,
    ...
    { "label": { "fr": "Réunir le franchisé et les riverains dans votre bureau", "en": "Get the franchisee and the residents into your office" },
      "roll": { "base": 18, "stat": "charisme", "plus": { "eloquence": 0.55 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 8, "credibilite": 2, "reseau": 1, "standing": 2,
                                "reputation": 1, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Se baigner devant les caméras", "en": "Swim in front of the cameras" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "popularity": 0.05, "charisme": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 12, "notoriete": 2, "standing": 2, "credibilite": -1,
                                "energie": -1 },
      ...
      "failure": { "effects": { "popularity": -7, "credibilite": -2, "notoriete": 1, "reputation": -1,
                                "energie": -3 },
      ...
      "debacle": { "effects": { "popularity": -9, "credibilite": -2, "notoriete": 2, "reputation": -1,
    ...
    { "label": { "fr": "Publier toutes les analyses, prélèvement par prélèvement", "en": "Publish every sample, one by one" },
      "effects": { "credibilite": 2, "reputation": 1, "popularity": -5, "standing": -4 },
    ...
    { "label": { "fr": "Voter un plan rivière et reporter l'ouverture", "en": "Vote a river plan through and postpone the opening" },
      "effects": { "money": -55000, "credibilite": 1, "standing": 3, "popularity": -3, "energie": -1 },
    ...
    { "label": { "fr": "S'attaquer à l'amont : la station d'épuration de la commune voisine", "en": "Go after the source: the neighbouring town's treatment plant" },
      "roll": { "base": 16, "stat": "credibilite", "plus": { "reseau": 0.4, "eloquence": 0.3 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "axis": { "economy": -50, "power": -30 }, "popularity": 9, "credibilite": 1,
                                "reseau": -1, "landscape": { "self": 0.6 }, "energie": -1 },
      ...
      "failure": { "effects": { "popularity": -4, "credibilite": -1, "reseau": -2, "standing": -2,
                                "energie": -1 },
    ...
    { "label": { "fr": "Faire refaire les analyses par un laboratoire indépendant, et publier le protocole", "en": "Have an independent laboratory redo the testing, and publish the protocol" },
      ...
      "effects": { "money": -18000, "credibilite": 2, "reputation": 1, "popularity": 2, "standing": -3 },

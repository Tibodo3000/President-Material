...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Couper l'affichage et rentrer dans les clous", "en": "Cut the advertising and stay inside the limit" },
      "effects": { "poll": -4, "standing": -3, "credibilite": 2, "reputation": 1,
                   "flags": { "comptesRelus": true } },
  ...
  "choices": [
    { "label": { "fr": "Faire le déplacement complet", "en": "Do the whole trip" },
      ...
      "failure": { "effects": {"poll": -3, "energie": -4, "popularity": -3, "credibilite": -1},
        "result": { "fr": "Vingt-deux heures d'avion aller-retour, quatre jours d'agenda et un décalage horaire qui vous rattrape en plein débat régional. On retient la fatigue à l'écran plutôt que les quatre jours.",
                    "en": "Twenty-two hours in the air there and back, four days of engagements and a time difference that catches up with you in the middle of a regional debate. What people remember is the tiredness on screen, not the four days." } } },

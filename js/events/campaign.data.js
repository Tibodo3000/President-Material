...

{
  ...
  "choices": [
    { "label": { "fr": "Attaquer frontalement", "en": "Go on the attack" },
      ...
      "triumph": { "effects": { "credibilite": 1, "poll": 11, "notoriete": 2, "popularity": 11 },
      ...
      "debacle": { "effects": { "credibilite": -3, "poll": -11, "reputation": -2, "popularity": -11 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Couper l'affichage et rentrer dans les clous", "en": "Cut the advertising and stay inside the limit" },
      ...
      "success": { "effects": {"poll": -4, "standing": -3, "credibilite": 2, "reputation": 1, "flags": {"comptesRelus": true}},
...

{
  ...
  "choices": [
    { "label": { "fr": "Crier au complot", "en": "Cry conspiracy" },
      ...
      "success": { "effects": {"poll": 2, "notoriete": 2, "standing": 4},
      ...
      "failure": { "effects": {"poll": -8, "popularity": -11, "credibilite": -3, "reputation": -2},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Continuer la campagne discrètement", "en": "Quietly keep campaigning" },
      "effects": { "poll": -1, "reputation": -1, "standing": 5, "credibilite": 2, "energie": 1 },
    ...
    { "label": { "fr": "Accuser le gouvernement d'impréparation", "en": "Blame the government for being unprepared" },
      "effects": { "axis": "self", "poll": 2, "notoriete": 2, "popularity": 6, "reputation": -2,
                   "standing": 4, "credibilite": -2, "energie": -1 },
  ...
  "choices": [
    { "label": { "fr": "Donner un chiffre et l'assumer", "en": "Give a figure and stand by it" },
      "roll": { "base": 15, "stat": "credibilite",
                ...
                "dice": 16 },
      "success": { "effects": { "poll": 4, "popularity": 5, "credibilite": 2, "notoriete": 1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Y aller, écouter, et ne rien promettre", "en": "Go, listen, and promise nothing" },
      "effects": { "poll": 0, "popularity": 3, "credibilite": 2, "reputation": 1, "energie": -1,
                   "appeal": { "self": -5 } },
    ...
    { "label": { "fr": "Ne pas y aller et recevoir les délégués", "en": "Stay away and receive the shop stewards" },
      "effects": { "poll": -2, "popularity": -4, "credibilite": 2, "standing": 4, "energie": 2,
                   "reseau": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Signer le pacte", "en": "Sign the pact" },
      ...
      "failure": { "effects": {"poll": -4, "standing": -6, "credibilite": -2, "appeal": {"self": -8}},
    ...
    { "label": { "fr": "Reprendre ses mesures sans rien signer", "en": "Take the policies and sign nothing" },
      "effects": { "poll": 4, "reputation": -2, "reseau": -2, "credibilite": -1,
                   "appeal": { "scene": -5 } },
    ...
    { "label": { "fr": "Refuser : vous ne devrez rien à personne", "en": "Refuse: you will owe nobody anything" },
      "effects": { "poll": -3, "credibilite": 2, "reputation": 2, "standing": 3,
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter et poser en famille", "en": "Accept and pose with the family" },
      ...
      "success": { "effects": {"poll": 3, "popularity": 8, "credibilite": -2, "reputation": -1},
      ...
      "failure": { "effects": {"poll": -3, "popularity": -6, "reputation": -2, "energie": -1},
...

{
  ...
  "choices": [
    { "label": { "fr": "Aller le voir avant qu'il ne sorte", "en": "Go and see him before it gets out" },
      ...
      "success": { "effects": { "poll": 2, "reseau": 2, "sangfroid": 1, "standing": 3, "energie": -1 },

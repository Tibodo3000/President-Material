...

{
  ...
  "choices": [
    { "label": { "fr": "Attaquer frontalement", "en": "Go on the attack" },
      "roll": { "base": 13, "stat": "eloquence", "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "credibilite": -1, "poll": -6, "reputation": -1, "popularity": -7 },
      ...
      "triumph": { "effects": { "credibilite": 1, "poll": 11, "eloquence": 1, "notoriete": 1, "popularity": 11 },
        "result": { "fr": "La réplique tombe à la neuvième minute et le plateau se tait une seconde de trop. Les six autres passent le reste de la soirée à y répondre, ce qui revient à la répéter. On ne parlera que de ça pendant trois jours.",
                    "en": "The line lands in the ninth minute and the set goes quiet a second too long. The other six spend the rest of the evening answering it, which amounts to repeating it. Nothing else will be discussed for three days." } },
      "debacle": { "effects": { "credibilite": -2, "poll": -11, "reputation": -1, "popularity": -11 },
        "result": { "fr": "Vous élevez la voix sur quelqu'un qui ne l'élève pas, et la caméra reste sur vous pendant qu'il attend, poliment, que vous ayez fini. C'est cet extrait-là qui tournera, et il tournera contre vous.",
                    "en": "You raise your voice at someone who does not raise theirs, and the camera stays on you while they wait, politely, for you to finish. That is the clip that will circulate, and it will circulate against you." } } },
    { "label": { "fr": "Jouer la hauteur présidentielle", "en": "Play presidential" },
      "roll": { "base": 14, "stat": "sangfroid",
                "plus": { "credibilite": 0.35, "eloquence": 0.25, "standing": 0.03 },
                "bonus": [ { "when": { "trait": ["stature"] }, "value": 1.5 },
                           { "when": { "background": ["civil", "academia"] }, "value": 1.5 },
                           { "when": { "personality": ["provocative"] }, "value": -1.5 } ],
                "dice": 16 },
      "success": { "effects": { "credibilite": +2, "poll": 5, "reputation": 1, "popularity": 5,
                                "notoriete": -1 },
    ...
    { "label": { "fr": "Sortir un dossier sur votre adversaire", "en": "Produce a file on your opponent" },
      ...
      "roll": { "base": 14, "stat": "reseau", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "poll": 8, "notoriete": 1, "reputation": -1 },
      ...
      "failure": { "effects": { "poll": -7, "reputation": -1 },
    ...
    { "label": { "fr": "Parler technique et chiffres", "en": "Go technical, with numbers" },
      ...
      "effects": { "credibilite": +1, "poll": 4, "eloquence": 1, "reputation": 1, "popularity": -4 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Remplir la salle avec des cars payés", "en": "Fill the hall with bussed-in crowds" },
      ...
      "failure": { "effects": { "poll": -1, "money": -90000, "popularity": -4, "reputation": -1 },
    ...
    { "label": { "fr": "Annoncer une mesure que rien ne finance", "en": "Announce a measure nothing pays for" },
      "effects": { "poll": 6, "popularity": 7, "reputation": -1, "standing": -4, "strike": "menteur" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Répondre point par point", "en": "Answer point by point" },
      "roll": { "base": 12, "stat": "sangfroid", "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
    ...
    { "label": { "fr": "Faire sortir une enquête sur l'adversaire", "en": "Have a story published about your opponent" },
      "when": { "personality": ["calculating"] },
      "effects": { "poll": 4, "notoriete": 1, "reputation": -1, "standing": 3, "strike": "casserole" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Puiser dans votre fortune personnelle", "en": "Dip into your personal fortune" },
      ...
      "failure": { "effects": { "money": -250000, "poll": -2, "popularity": -5, "reputation": -1 },
    ...
    { "label": { "fr": "Lancer un appel aux dons militants", "en": "Call for grassroots donations" },
      "roll": { "base": 12, "stat": "charisme", "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
    ...
    { "label": { "fr": "Solliciter vos anciens réseaux d'affaires", "en": "Call on your old business network" },
      ...
      "failure": { "effects": { "poll": -2, "reputation": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Couper l'affichage et rentrer dans les clous", "en": "Cut the advertising and stay inside the limit" },
      "roll": { "base": 13, "stat": "credibilite", "plus": { "sangfroid": 0.3, "reseau": 0.2 }, "bonus": [ { "when": { "background": ["law", "business"] }, "value": 2 }, { "when": { "legal": 1 }, "value": 2 }, { "when": { "personality": ["calculating"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"poll": -4, "standing": -3, "credibilite": 1, "reputation": 1, "flags": {"comptesRelus": true}},
      ...
      "failure": { "effects": {"poll": -6, "credibilite": 1, "standing": -6, "energie": -2},
        "result": { "fr": "Deux mille panneaux annulés à onze jours du vote, et le prestataire facture quand même la pose. Le plafond est respecté, la trésorerie ne l'est plus, et il faut choisir entre les tracts et le local.",
                    "en": "Two thousand billboards cancelled eleven days out, and the contractor bills for the installation anyway. The spending cap is respected, the cash flow is not, and it comes down to a choice between the leaflets and the office." } } },
    { "label": { "fr": "Ne rien changer, on verra après le vote", "en": "Change nothing, we will see after the vote" },
      "effects": { "energie": 1, "reputation": -1, "credibilite": -1,
                   "flags": { "comptesForces": true } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Parler d'un montage sorti de son contexte", "en": "Call it an edit, taken out of context" },
      ...
      "failure": { "effects": { "poll": -8, "reputation": -1, "popularity": -6 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Acheter la campagne en ligne", "en": "Buy the campaign online" },
      ...
      "success": { "effects": { "poll": 5, "money": -180000, "notoriete": 1, "reputation": -1, "energie": 1 },
      ...
      "failure": { "effects": { "poll": -1, "money": -180000, "notoriete": 1, "reputation": -1, "energie": 1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Publier un chiffrage écrit par un cabinet ami", "en": "Publish costings written by a friendly firm" },
      ...
      "roll": { "base": 14, "stat": "credibilite", "plus": { "reseau": 0.3 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      ...
      "failure": { "effects": { "poll": -3, "money": -80000, "credibilite": -1, "reputation": -1 },
    ...
    { "label": { "fr": "Expliquer qu'on financera par la croissance", "en": "Explain that growth will pay for it" },
      "effects": { "axis": {"economy": 50}, "poll": 2, "popularity": 6, "reputation": -1, "standing": 2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Commander votre propre sondage", "en": "Commission your own poll" },
      ...
      "failure": { "effects": { "poll": -2, "money": -60000, "credibilite": -1, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Crier au complot", "en": "Cry conspiracy" },
      "roll": { "base": 16, "stat": "charisme", "plus": { "notoriete": 0.3, "popularity": 0.05 }, "bonus": [ { "when": { "personality": ["provocative"] }, "value": 2 }, { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["casserole"] }, "value": -3 } ], "dice": 16 },
      "success": { "effects": {"poll": 2, "charisme": 1, "notoriete": 1, "standing": 4},
      ...
      "failure": { "effects": {"poll": -8, "popularity": -11, "credibilite": -2, "reputation": -1},
        "result": { "fr": "Vous nommez trois responsables et deux journaux. Les trois répondent, les deux journaux publient leurs sources, et il reste onze jours de campagne pour parler d'autre chose, ce qui n'arrivera pas.",
                    "en": "You name three culprits and two newspapers. All three answer, both papers publish their sources, and there are eleven days of campaign left to talk about something else, which will not happen." } } },
    { "label": { "fr": "Tout publier vous-même", "en": "Publish everything yourself" },
      "effects": { "poll": -6, "reputation": 1, "popularity": -4, "flags": { "dirtyMoney": false } },
    ...
    { "label": { "fr": "Sortir un dossier sur l'adversaire le lendemain", "en": "Drop a file on your opponent the next day" },
      "effects": { "poll": 3, "notoriete": 1, "reputation": -1, "strike": "casserole" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Un appel solennel au pays", "en": "A solemn address to the country" },
      "roll": { "base": 12, "stat": "eloquence", "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
    ...
    { "label": { "fr": "Un dernier direct sans filtre", "en": "One last unfiltered live" },
      ...
      "roll": { "base": 13, "stat": "charisme", "plus": { "notoriete": 0.4 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 7, "charisme": 1, "notoriete": 1 },
      ...
      "failure": { "effects": { "poll": -6, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Répondre sur le même terrain", "en": "Answer in kind" },
      ...
      "failure": { "effects": { "poll": -5, "reputation": -1 },
    ...
    { "label": { "fr": "Refuser d'entrer là-dedans", "en": "Refuse to go there" },
      "effects": { "poll": 3, "reputation": 1, "popularity": 4, "notoriete": -1, "standing": -3 },
    ...
    { "label": { "fr": "Porter plainte en direct", "en": "Announce a lawsuit on air" },
      "effects": { "poll": -1, "notoriete": 1, "standing": 4, "popularity": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Suspendre et se rendre sur place", "en": "Suspend and go there" },
      "when": { "stat": { "energie": { "min": 8 } } },
      "effects": { "poll": 4, "reputation": 1, "energie": -2, "popularity": 6 },
    ...
    { "label": { "fr": "Continuer la campagne discrètement", "en": "Quietly keep campaigning" },
      "effects": { "poll": -1, "reputation": -1, "standing": 5, "credibilite": 1, "energie": 1 },
    ...
    { "label": { "fr": "Financer les secours sur vos fonds de campagne", "en": "Fund the relief effort from campaign money" },
      ...
      "success": { "effects": { "poll": 3, "money": -120000, "reputation": 1, "popularity": 5, "standing": -2 },
      ...
      "failure": { "effects": { "poll": -2, "money": -120000, "popularity": -4, "reputation": -1, "standing": -2 },
    ...
    { "label": { "fr": "Accuser le gouvernement d'impréparation", "en": "Blame the government for being unprepared" },
      "effects": { "axis": "self", "poll": 2, "notoriete": 1, "popularity": 6, "reputation": -1,
                   "standing": 4, "credibilite": -1, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire le tour des départements un par un", "en": "Tour the counties one by one" },
      "effects": { "poll": 2, "reseau": 1, "credibilite": 1, "energie": -3 },
    ...
    { "label": { "fr": "Dénoncer publiquement le filtre des parrainages", "en": "Denounce the signature filter in public" },
      "roll": { "base": 14, "stat": "eloquence", "plus": { "notoriete": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": {"power": -55}, "poll": 3, "popularity": 7, "eloquence": 1, "notoriete": 1, "credibilite": -1 },
      ...
      "failure": { "effects": { "poll": -4, "popularity": -3, "credibilite": -1 },
    ...
    { "label": { "fr": "Payer trois équipes pour ratisser le pays", "en": "Pay three teams to comb the country" },
      ...
      "failure": { "effects": { "money": -120000, "poll": -2, "energie": 1, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Le visage en gros plan, fond uni, un seul mot", "en": "Face in close-up, flat background, one word" },
      "effects": { "poll": 2, "notoriete": 1, "popularity": 2 },
    ...
    { "label": { "fr": "Une phrase longue, qui dit vraiment ce que vous pensez", "en": "A long sentence that actually says what you think" },
      "roll": { "base": 14, "stat": "eloquence", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 3, "credibilite": 1, "reputation": 1 },
    ...
    { "label": { "fr": "Vous au milieu d'une foule, sans slogan", "en": "You in a crowd, no slogan" },
      "effects": { "poll": 1, "appeal": { "self": 6 }, "credibilite": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Donner un chiffre et l'assumer", "en": "Give a figure and stand by it" },
      "roll": { "base": 15, "stat": "credibilite",
                "plus": { "sangfroid": 0.35, "eloquence": 0.25 },
                "bonus": [ { "when": { "background": ["academia", "civil", "business"] }, "value": 2 },
                           { "when": { "personality": ["hardworking"] }, "value": 1.5 },
                           { "when": { "trait": ["clairvoyant"] }, "value": 1.5 },
                           { "when": { "stat": { "energie": { "max": 7 } } }, "value": -1.5 } ],
                "dice": 16 },
      "success": { "effects": { "poll": 4, "popularity": 5, "credibilite": 1, "notoriete": 1 },
    ...
    { "label": { "fr": "Dire que vous ne savez pas, et pourquoi la question est mauvaise", "en": "Say you do not know, and why the question is a poor one" },
      "roll": { "base": 13, "stat": "sangfroid", "plus": { "credibilite": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 15 },
      "success": { "effects": { "poll": 1, "credibilite": 1, "reputation": 1, "popularity": -2 },
    ...
    { "label": { "fr": "Sortir le chiffre exact et enchaîner sur trois autres", "en": "Give the exact figure and add three more" },
      ...
      "effects": { "poll": 3, "credibilite": 1, "popularity": 1 },
    ...
    { "label": { "fr": "Retourner la question au journaliste", "en": "Put the question back to the interviewer" },
      ...
      "success": { "effects": { "poll": 2, "popularity": 8, "charisme": 1, "notoriete": 1, "reputation": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Annoncer une mesure agricole au milieu des allées", "en": "Announce a farm policy in the middle of the aisles" },
      "roll": { "base": 14, "stat": "credibilite", "plus": { "sangfroid": 0.35 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      ...
      "failure": { "effects": { "poll": -3, "credibilite": -1, "reputation": -1, "energie": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Y aller, écouter, et ne rien promettre", "en": "Go, listen, and promise nothing" },
      "effects": { "poll": 0, "popularity": 3, "credibilite": 1, "reputation": 1, "energie": -1,
                   "appeal": { "self": -5 } },
    ...
    { "label": { "fr": "Ne pas y aller et recevoir les délégués", "en": "Stay away and receive the shop stewards" },
      "effects": { "poll": -2, "popularity": -4, "credibilite": 1, "standing": 4, "energie": 2,
                   "reseau": 1 },
    ...
    { "label": { "fr": "Expliquer pourquoi l'usine ferme, vraiment", "en": "Explain why the factory is really closing" },
      ...
      "success": { "effects": { "axis": {"economy": 60}, "poll": 2, "credibilite": 2, "reputation": 1, "popularity": 5 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire le déplacement complet", "en": "Do the whole trip" },
      "roll": { "base": 14, "stat": "energie", "plus": { "charisme": 0.3, "reseau": 0.25 }, "bonus": [ { "when": { "personality": ["hardworking"] }, "value": 2 }, { "when": { "trait": ["robuste"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"poll": 4, "standing": 3, "reputation": 1, "popularity": 5, "energie": -3},
      ...
      "failure": { "effects": {"poll": -3, "energie": -4, "popularity": -3, "credibilite": -1},
        "result": { "fr": "Vingt-deux heures d'avion pour trente et une heures sur place, dont neuf de sommeil et quatre de trajets. Le compte rendu de campagne écrit « déplacement effectué », ce qui est vrai, et le journal local titre sur le rapport entre les deux chiffres, ce qui l'est aussi.",
                    "en": "Twenty-two hours in the air for thirty-one hours on the ground, nine of them asleep and four in cars. The campaign log records the visit as completed, which is true, and the local paper leads on the ratio between the two figures, which is also true." } } },
    ...
    { "label": { "fr": "Annuler et rester en métropole", "en": "Cancel and stay on the mainland" },
      "effects": { "poll": 1, "standing": -3, "reputation": -1, "energie": 2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Signer le pacte", "en": "Sign the pact" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "sangfroid": 0.3, "standing": 0.04 }, "bonus": [ { "when": { "personality": ["calculating"] }, "value": 2 }, { "when": { "trait": ["reseauteur"] }, "value": 1.5 }, { "when": { "trait": ["traitre"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"alliance": "scene", "poll": 5, "standing": -4, "reputation": -1, "landscape": {"self": 0.5}},
      ...
      "failure": { "effects": {"poll": -4, "standing": -6, "credibilite": -1, "appeal": {"self": -8}},
        "result": { "fr": "Le protocole fait deux pages et il fuite avant la signature, dans la version où figurent encore les quatre circonscriptions promises. Les deux camps le désavouent le même soir, avec les mêmes mots, ce qui suffit à établir qu'il existait.",
                    "en": "The agreement runs to two pages and leaks before it is signed, in the version that still names the four constituencies promised. Both camps disown it the same evening, in the same words, which is enough to establish that it existed." } } },
    { "label": { "fr": "Reprendre ses mesures sans rien signer", "en": "Take the policies and sign nothing" },
      "effects": { "poll": 4, "reputation": -1, "reseau": -1, "credibilite": -1,
                   "appeal": { "scene": -5 } },
    ...
    { "label": { "fr": "Refuser : vous ne devrez rien à personne", "en": "Refuse: you will owe nobody anything" },
      "effects": { "poll": -3, "credibilite": 1, "reputation": 1, "standing": 3,
                   "appeal": { "scene": -7 }, "landscape": { "self": -0.6, "scene": 0.7 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter et poser en famille", "en": "Accept and pose with the family" },
      "roll": { "base": 14, "stat": "charisme", "plus": { "popularity": 0.04, "sangfroid": 0.25 }, "bonus": [ { "when": { "personality": ["charming"] }, "value": 2 }, { "when": { "background": ["celebrity", "comms"] }, "value": 1.5 }, { "when": { "trait": ["couple_people"] }, "value": 2 } ], "dice": 16 },
      "success": { "effects": {"poll": 3, "popularity": 8, "credibilite": -1, "reputation": -1},
      ...
      "failure": { "effects": {"poll": -3, "popularity": -6, "reputation": -1, "energie": -1},
        "result": { "fr": "Les photos sont bonnes et l'une d'elles est trop bonne : on y voit une mise en scène, et le magazine publie aussi les trois prises précédentes. Ce qui devait vous incarner vous fabrique.",
                    "en": "The photographs are good and one of them is too good: the staging shows, and the magazine also prints the three previous takes. What was meant to make you human makes you manufactured." } } },
    { "label": { "fr": "Refuser catégoriquement", "en": "Refuse outright" },
      "effects": { "poll": -1, "popularity": -2, "reputation": 1, "credibilite": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Promettre les quatre circonscriptions", "en": "Promise all four constituencies" },
      ...
      "failure": { "effects": { "poll": 2, "standing": -6, "reputation": -1, "strike": "appareil",
                                "landscape": { "self": -0.7 } },
    ...
    { "label": { "fr": "N'en promettre aucune, et le dire", "en": "Promise none of them, and say so" },
      "roll": { "base": 16, "stat": "credibilite", "plus": { "sangfroid": 0.35 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "poll": 2, "popularity": 7, "standing": -5, "credibilite": 1,
                                "landscape": { "self": 0.6 }, "reputation": 1 },
    ...
    { "label": { "fr": "En promettre deux et faire attendre les deux autres", "en": "Promise two and keep the other two waiting" },
      "when": { "personality": ["calculating"] },
      "roll": { "base": 15, "stat": "reseau", "plus": { "standing": 0.05 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "poll": 4, "standing": 3, "reseau": 1, "landscape": { "self": -0.2 } },
    ...
    { "label": { "fr": "Promettre la vôtre à quelqu'un d'autre", "en": "Promise your own seat to somebody else" },
      ...
      "roll": { "base": 14, "stat": "charisme", "plus": { "reputation": 0.3 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "poll": -3, "standing": -4, "popularity": -6, "credibilite": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "{Le} nommer et {le} laisser occuper l'antenne", "en": "Appoint {him} and let {him} take the airtime" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "standing": 0.04 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "poll": -3, "standing": -4, "popularity": -5, "notoriete": -1 },
    ...
    { "label": { "fr": "{Le} nommer et {le} tenir en laisse courte", "en": "Appoint {him} and keep {him} on a short leash" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
    ...
    { "label": { "fr": "Refuser et parler vous-même", "en": "Refuse, and speak for yourself" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "energie": 0.35 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 4, "eloquence": 1, "notoriete": 1, "popularity": 5, "standing": -6,
                                "energie": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Aller le voir avant qu'il ne sorte", "en": "Go and see him before it gets out" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "reputation": 0.3 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 2, "reseau": 1, "sangfroid": 1, "standing": 3, "energie": -1 },
      ...
      "failure": { "effects": { "poll": -6, "popularity": -9, "reputation": -1,
                                "appeal": { "others": -3 } },
    ...
    { "label": { "fr": "Prendre les devants et publier la phrase", "en": "Get ahead of it and publish the line yourself" },
      ...
      "success": { "effects": { "poll": 4, "notoriete": 1, "popularity": 6, "credibilite": 1,
                                "reputation": 1 },
    ...
    { "label": { "fr": "Nier en bloc", "en": "Deny everything" },
      ...
      "success": { "effects": { "poll": 1, "standing": 3, "reputation": -1, "sangfroid": 1 },
      ...
      "failure": { "effects": { "poll": -8, "popularity": -10, "credibilite": -2,
...

{
  ...
  "choices": [
    { "label": { "fr": "Écrire le chapitre personnel", "en": "Write the personal chapter" },
      "roll": { "base": 15, "stat": "reputation", "plus": { "charisme": 0.35 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["casserole"] }, "value": -2 }, { "when": { "trait": ["repris_de_justice"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": { "poll": 5, "popularity": 8, "notoriete": 1, "standing": -4 },
      ...
      "failure": { "effects": { "poll": -4, "popularity": -6, "reputation": -1, "money": -20000 },
    ...
    { "label": { "fr": "En faire un programme et rien d'autre", "en": "Make it a programme and nothing else" },
      "roll": { "base": 14, "stat": "credibilite", "plus": { "eloquence": 0.3 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "poll": 3, "credibilite": 2, "standing": 6, "popularity": -2,
                                "landscape": { "self": 0.5 } },
    ...
    { "label": { "fr": "Régler vos comptes avec votre propre camp", "en": "Settle scores with your own side" },
      "when": { "personality": ["provocative"] },
      "roll": { "base": 17, "stat": "eloquence", "plus": { "popularity": 0.05 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 6, "popularity": 9, "eloquence": 1, "notoriete": 1, "standing": -14, "appeal": { "self": -8 },
                                "landscape": { "self": -0.5 } },
      ...
      "failure": { "effects": { "poll": -7, "standing": -18, "reputation": -1, "strike": "traitre",
                                "landscape": { "self": -1.0 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et marcher dans le cortège", "en": "Turn up and walk in the march" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "reputation": 0.3 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "poll": 5, "popularity": 8, "charisme": 1, "notoriete": 1,
                                "landscape": { "self": 0.6 } },
    ...
    { "label": { "fr": "Recevoir les syndicats et personne d'autre", "en": "Receive the unions and nobody else" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 3, "credibilite": 1, "standing": 5, "reseau": 1,
                                "popularity": 2 },
    ...
    { "label": { "fr": "Appeler au retour à l'ordre", "en": "Call for a return to order" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
    ...
    { "label": { "fr": "Ne rien dire pendant trois jours", "en": "Say nothing for three days" },
      ...
      "success": { "effects": { "poll": 2, "sangfroid": 1, "energie": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Annoncer le contournement", "en": "Announce the bypass" },
      ...
      "failure": { "effects": { "poll": -6, "credibilite": -2, "popularity": -7, "strike": "menteur",
                                "reputation": -1 },
    ...
    { "label": { "fr": "Y aller et refuser de l'annoncer", "en": "Go, and refuse to announce it" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "credibilite": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 3, "credibilite": 1, "popularity": 6, "standing": -6,
                                "reputation": 1 },

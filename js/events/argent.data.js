...

{
  ...
  "tag": { "fr": "Sept mille cinq cents", "en": "Seven thousand five hundred" },
  "text": {
    "fr": "Un homme d'affaires que personne n'ose fréquenter propose de financer vos activités. Il connaît la loi mieux que vous : le plafond du don d'une personne physique est de sept mille cinq cents euros par an, et il le dit lui-même, en souriant, avant que vous ayez posé la question. Ce qu'il propose est très au-dessus. Il ne demande rien. Pour l'instant.",
    "en": "A businessman nobody dares be seen with offers to fund your work. He knows the law better than you do: an individual may give seven thousand five hundred euros a year, and he says so himself, smiling, before you have asked. What he is offering is well above that. He asks for nothing. For now."
  },
  "choices": [
    { "label": { "fr": "Accepter discrètement", "en": "Accept quietly" },
      "effects": { "money": 140000, "reseau": 1, "standing": 9, "flags": { "dirtyMoney": true },
                   "strike": "casserole" },
      "result": { "fr": "Le virement arrive par une société de conseil qui vous facture une étude de marché que personne ne lira. Votre campagne respire, votre permanence est payée pour deux ans, et il y a désormais une facture quelque part avec votre nom en face d'un travail qui n'existe pas.",
                  "en": "The transfer comes through a consultancy that invoices you for a market study nobody will read. Your campaign can breathe, your office is paid for two years, and there is now an invoice somewhere with your name against work that does not exist." } },

    { "label": { "fr": "Le faire entrer par la porte : sept mille cinq cents euros, déclarés", "en": "Bring him in through the front door: seven thousand five hundred, declared" },
      "effects": { "money": 7500, "credibilite": 1, "reputation": 1, "reseau": 1, "standing": 1 },
      "result": { "fr": "Il signe le reçu-don sans discuter et vous remercie de l'avoir reçu. C'est cent fois moins que ce qu'il proposait, c'est parfaitement légal, et il garde pour lui les quatre-vingt-dix-neuf autres centièmes de son envie de vous aider. Vous le reverrez.",
    ...
    { "label": { "fr": "Lui demander maintenant ce qu'il voudra plus tard", "en": "Ask him now what he will want later" },
      ...
      "success": { "effects": { "reseau": 1, "sangfroid": 1, "credibilite": 1, "money": 7500,
                                "standing": -2 },
        "result": { "fr": "Il répond, ce que personne n'attendait : un permis de construire, dans quatre ans, sur un terrain qu'il n'a pas encore acheté. Vous refusez l'enveloppe, vous prenez les sept mille cinq cents légaux, et vous savez désormais une chose que trois personnes savent dans ce département.",
                    "en": "He answers, which nobody expected: planning permission, in four years, on land he has not yet bought. You turn down the envelope, you take the seven and a half thousand that are lawful, and you now know something that three people in this part of the country know." } },
      "failure": { "effects": { "reseau": -2, "standing": -4, "popularity": -2,
                                "landscape": { "self": -0.8 } },
        "result": { "fr": "Il le prend comme une insulte, se lève avant le café et va financer quelqu'un d'autre dans votre camp le mois suivant. Vous n'avez ni l'argent, ni le renseignement, ni la paix, et l'autre a les trois.",
                    "en": "He takes it as an insult, gets up before the coffee and goes off to fund somebody else in your own camp the following month. You have neither the money, nor the information, nor the peace, and the other one has all three." } } },

    { "label": { "fr": "Refuser poliment", "en": "Decline politely" },
      "effects": { "reputation": 1, "credibilite": 1, "sangfroid": 1, "standing": -6, "reseau": -1 },
      "result": { "fr": "Il sourit et n'insiste pas. Il finance une fédération voisine, dont le premier secrétaire vous succédera peut-être un jour, et vous passez les deux années suivantes à compter les timbres de votre permanence.",
                  "en": "He smiles and does not insist. He funds a neighbouring federation, whose secretary may well succeed you one day, and you spend the next two years counting the stamps at your office." } },

    { "label": { "fr": "Le dénoncer publiquement", "en": "Expose him publicly" },
      "when": { "personality": ["principled"] },
      "effects": { "landscape": { "self": -1.1, "identitarians": 0.9 }, "strike": "intrepide",
                   "notoriete": 1, "reputation": 2, "popularity": 11, "standing": -9,
                   "trait": "intouchable", "chain": "position_impopulaire" },
      "result": { "fr": "Vous racontez la proposition en détail devant les caméras, avec la date, l'heure et le montant. L'homme disparaît. Personne dans votre parti ne vous dit merci, et deux personnes vous demandent en réunion si vous enregistrez les conversations.",
                  "en": "You describe the offer on camera in detail, with the date, the time and the amount. The man disappears. Nobody in your party thanks you, and two people ask you in a meeting whether you record conversations." } },
    ...
    { "label": { "fr": "Monter un financement transparent autour de lui", "en": "Build transparent funding around him" },
      ...
      "success": { "effects": { "money": 60000, "reseau": 2, "reputation": 1, "credibilite": 1,
                                "standing": 5 },
        "result": { "fr": "Vous ne prenez pas son argent, vous prenez son carnet d'adresses : onze personnes physiques, sept mille cinq cents euros chacune, tout est déclaré et tout est vrai. Il n'a rien donné et il a tout organisé, ce qui n'est écrit nulle part et ne se poursuit nulle part.",
                    "en": "You do not take his money, you take his address book: eleven individuals, seven and a half thousand euros each, all declared and all genuine. He gave nothing and organised everything, which is written down nowhere and prosecuted nowhere." } },
      "failure": { "effects": { "reseau": -1, "standing": -6, "popularity": -3, "energie": -1 },
        "result": { "fr": "Il refuse le cadre légal, parce que le cadre légal suppose que onze personnes signent onze reçus à leur nom. Il va financer un rival. Vous n'avez ni l'argent ni la paix.",
                    "en": "He refuses the legal framework, because the legal framework means eleven people signing eleven receipts in their own names. He goes and funds a rival. You have neither the money nor the peace." } } },

    { "label": { "fr": "Accepter en montant un écran juridique", "en": "Accept behind a legal screen" },
      "when": { "personality": ["calculating"] },
      "effects": { "money": 190000, "reseau": 1, "standing": 9, "reputation": -1, "sangfroid": -1,
                   "flags": { "dirtyMoney": true }, "trait": "caisse_noire" },
      "result": { "fr": "Trois sociétés, deux pays, un cabinet complaisant et une convention de trésorerie que personne ne lira avant six ans. Ça tiendra un moment. Ce qui ne tiendra pas, c'est le jour où quelqu'un demandera pourquoi la première des trois a été créée onze jours avant votre déclaration de candidature.",
                  "en": "Three companies, two countries, an accommodating law firm and a cash agreement nobody will read for six years. It will hold for a while. What will not hold is the day somebody asks why the first of the three was set up eleven days before you declared your candidacy." } }
  ]
},
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire comme tout le monde", "en": "Do what everyone does" },
      "roll": { "base": 13, "stat": "sangfroid", "plus": { "reseau": 0.3, "credibilite": 0.2 }, "bonus": [ { "when": { "trait": ["appareil"] }, "value": 2 }, { "when": { "personality": ["calculating"] }, "value": 1.5 }, { "when": { "position": ["ministre", "premier", "chef"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"money": 26000, "standing": 5, "reseau": 1},
        "result": { "fr": "C'est facile, c'est courant, et personne ne va chercher les notes d'un élu de votre échelon. La trace écrite existe, dans un carton, dans un service qui déménage tous les six ans.",
                    "en": "It is easy, it is common, and nobody goes looking at the expenses of a member at your level. The paper trail exists, in a box, in an office that moves premises every six years." } },
      "failure": { "effects": {"money": 6000, "popularity": -8, "reputation": -1, "credibilite": -1, "flags": {"dirtyMoney": true}, "strike": "casserole"},
        "result": { "fr": "Un service de vérification épluche trois ans de notes de quatorze élus et publie le tableau. Le vôtre est dans la moyenne, ce qui est exactement le problème : le tableau se lit d'un coup d'œil et la moyenne est indéfendable.",
                    "en": "A fact-checking desk goes through three years of expenses for fourteen members and publishes the table. Yours is around the average, which is precisely the problem: the table reads at a glance and the average is indefensible." } } },
    { "label": { "fr": "Tout payer de votre poche", "en": "Pay for everything yourself" },
      "effects": { "money": -20000, "reputation": 1, "popularity": 4, "standing": -4, "reseau": -1 },
    ...
    { "label": { "fr": "Publier vos comptes de votre propre initiative", "en": "Publish your accounts unprompted" },
      "when": { "personality": ["principled"] },
      "effects": { "landscape": { "self": -1.4, "identitarians": 1.2 }, "reputation": 2, "popularity": 12, "standing": -11 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser publiquement", "en": "Refuse publicly" },
      "effects": { "landscape": { "self": -0.8, "identitarians": 0.6 }, "reputation": 1, "popularity": 8, "standing": -4 },
    ...
    { "label": { "fr": "Accepter et tout reverser", "en": "Accept and give it all away" },
      "when": { "personality": ["principled"] },
      "effects": { "reputation": 2, "popularity": 9, "standing": -5, "trait": "intouchable" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Attribuer au moins-disant, comme prévu", "en": "Award it to the lowest bid, as required" },
      "effects": { "reputation": 1, "standing": -6, "popularity": 3 },
    ...
    { "label": { "fr": "Trouver un critère technique qui les avantage", "en": "Find a technical criterion that favours them" },
      ...
      "failure": { "effects": { "money": 90000, "standing": 4, "reputation": -1, "popularity": -7, "flags": { "dirtyMoney": true }, "strike": "casserole", "chain": "chantier_suite" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Signer l'avenant", "en": "Sign the rider" },
      "effects": { "money": 140000, "standing": 4, "reputation": -1, "popularity": -5, "chain": "signalement_chambre" },
    ...
    { "label": { "fr": "Refuser et faire jouer les pénalités de retard", "en": "Refuse and enforce the late penalties" },
      ...
      "success": { "effects": { "reputation": 1, "popularity": 6, "standing": -4, "flags": { "dirtyMoney": false } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Charger votre directeur général des services", "en": "Blame your chief executive" },
      "effects": { "popularity": -3, "standing": 3, "reputation": -1, "strike": "menteur", "chain": "perquisition" },
    ...
    { "label": { "fr": "Rembourser la commune avant que le procureur ne bouge", "en": "Repay the town before the prosecutor moves" },
      ...
      "effects": { "money": -230000, "reputation": 1, "popularity": 4, "standing": -6, "flags": { "dirtyMoney": false } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Refuser et le déclarer au registre", "en": "Refuse it and log it in the register" },
      "effects": { "reputation": 2, "notoriete": 1, "popularity": 4, "standing": -3 },
    ...
    { "label": { "fr": "Accepter sans le déclarer", "en": "Take it, and say nothing" },
      ...
      "success": { "effects": { "money": 260000, "standing": 5, "reputation": -1, "flags": { "dirtyMoney": true }, "chain": "amendements_dictes" },
      ...
      "failure": { "effects": { "money": 200000, "standing": 3, "reputation": -1, "popularity": -6, "flags": { "dirtyMoney": true }, "strike": "casserole", "chain": "amendements_dictes" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Les déposer tels quels", "en": "Table them as they are" },
      "effects": { "money": 90000, "reputation": -1, "standing": 3, "chain": "fuite_bruxelles" },
    ...
    { "label": { "fr": "Rompre et rendre l'argent déjà versé", "en": "Break it off and give back what you took" },
      ...
      "effects": { "money": -190000, "reputation": 2, "standing": -5, "flags": { "dirtyMoney": false } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout nier en bloc", "en": "Deny everything" },
      ...
      "failure": { "effects": { "popularity": -18, "standing": -12, "reputation": -1, "strike": "menteur", "flags": { "onTrial": true }, "chain": "proces" },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser et le raconter à la presse", "en": "Decline and tell the press" },
      ...
      "success": { "effects": { "notoriete": 1, "popularity": 12, "reputation": 1, "standing": -7 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Nier connaître la fondation", "en": "Deny knowing the foundation" },
      ...
      "failure": { "effects": { "popularity": -14, "standing": -10, "reputation": -1, "strike": "casserole",
    ...
    { "label": { "fr": "Attaquer le journaliste et son journal", "en": "Go after the reporter and his paper" },
      "effects": { "notoriete": 1, "popularity": -13, "standing": 4, "reputation": -1,
                   "credibilite": -2, "chain": "commission_enquete" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Mentir sous serment", "en": "Lie under oath" },
      ...
      "failure": { "effects": { "popularity": -12, "standing": -12, "reputation": -1,
...

{
  ...
  "choices": [
    { "label": { "fr": "L'embaucher comme attachée parlementaire", "en": "Hire her as a parliamentary assistant" },
      ...
      "success": { "effects": {"money": 20000, "energie": 1, "reputation": -1, "flags": {"dirtyMoney": true}, "chain": "emploi_fictif_presse"},
      ...
      "failure": { "effects": {"money": 8000, "popularity": -11, "reputation": -1, "credibilite": -2, "strike": "casserole"},
    ...
    { "label": { "fr": "Refuser net et le faire savoir en famille", "en": "Say no, and let the family know" },
      "effects": { "reputation": 1, "reseau": -1, "energie": -1 },
    ...
    { "label": { "fr": "L'embaucher chez un ami, qui vous doit un service", "en": "Get a friend to hire her instead" },
      "when": { "personality": ["calculating"] },
      "effects": { "reseau": 1, "standing": 4, "reputation": -1, "money": 15000 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Fabriquer des notes de travail", "en": "Manufacture some work notes" },
      ...
      "failure": { "effects": { "popularity": -18, "standing": -14, "reputation": -1, "strike": "casserole",
                                "flags": { "onTrial": true }, "chain": "proces" },
    ...
    { "label": { "fr": "Assumer : « c'est légal, et je le referais »", "en": "Own it: “it is legal, and I would do it again”" },
      "effects": { "notoriete": 1, "popularity": -12, "standing": 8, "sangfroid": 1, "strike": "casserole" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Acheter et le faire sortir dans la presse", "en": "Buy it and get it into the press" },
      "when": { "minMoney": 60000 },
      "effects": { "money": -50000, "notoriete": 1, "popularity": 6, "standing": 5, "reputation": -1,
    ...
    { "label": { "fr": "Refuser et le mettre dehors", "en": "Refuse and show him the door" },
      "effects": { "reputation": 1, "sangfroid": 1, "standing": -4, "reseau": -1,
                   "landscape": { "self": -0.4 } },
    ...
    { "label": { "fr": "Prévenir votre rival de ce qui circule", "en": "Warn your rival about what is circulating" },
      ...
      "success": { "effects": {"reseau": 2, "reputation": 2, "credibilite": 1, "popularity": -3, "standing": -2},
      ...
      "failure": { "effects": {"reseau": -1, "standing": -6, "reputation": -1, "notoriete": 1},
...

{
  ...
  "choices": [
    { "label": { "fr": "Assumer une prestation légale de veille", "en": "Call it a legal monitoring service" },
      ...
      "failure": { "effects": { "popularity": -13, "standing": -10, "reputation": -1, "strike": "casserole",
    ...
    { "label": { "fr": "Charger un collaborateur qui a agi seul", "en": "Blame a staffer who acted alone" },
      "effects": { "popularity": -6, "standing": 5, "reputation": -2, "reseau": -1, "strike": "traitre" },
    ...
    { "label": { "fr": "Tout reconnaître et présenter des excuses", "en": "Admit everything and apologise" },
      "effects": { "popularity": 3, "standing": -12, "reputation": 1, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Signer : c'est propre et rapide", "en": "Sign: it is clean and fast" },
      "roll": { "base": 14, "stat": "credibilite", "plus": { "reseau": 0.3, "standing": 0.04 }, "bonus": [ { "when": { "background": ["business"] }, "value": 2 }, { "when": { "legal": 1 }, "value": 1.5 }, { "when": { "personality": ["principled"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": {"money": -140000, "standing": 7, "eloquence": 1, "popularity": -6, "reputation": -1, "credibilite": 1},
      ...
      "failure": { "effects": {"money": -40000, "popularity": -9, "credibilite": -2, "standing": -4, "reputation": -1},
        "result": { "fr": "Le rapport est rendu en six semaines, il est bon, et le montant de la prestation sort au printemps suivant avec le nom du cabinet. On ne discute pas du rapport, on discute du tarif horaire.",
                    "en": "The report is delivered in six weeks, it is good, and the fee comes out the following spring with the name of the firm. Nobody discusses the report; they discuss the hourly rate." } } },
    { "label": { "fr": "Le faire écrire par vos militants", "en": "Have your activists write it" },
      "effects": { "energie": -2, "reseau": 1, "popularity": 7, "standing": -3 },
    ...
    { "label": { "fr": "Signer, puis dénoncer les cabinets en meeting", "en": "Sign, then attack consultants at a rally" },
      ...
      "effects": { "money": -140000, "notoriete": 1, "popularity": 11, "standing": 2, "reputation": -1, "strike": "menteur" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Garder, et les porter", "en": "Keep them, and wear them" },
      ...
      "success": { "effects": {"money": 25000, "charisme": 1, "reputation": -1, "flags": {"dirtyMoney": true}, "reseau": 1},
      ...
      "failure": { "effects": {"popularity": -9, "reputation": -1, "credibilite": -1, "notoriete": 1, "strike": "casserole"},
    ...
    { "label": { "fr": "Renvoyer le tout avec un mot sec", "en": "Send it all back with a curt note" },
      "effects": { "reputation": 1, "reseau": -1, "standing": -3 },
    ...
    { "label": { "fr": "Les donner à une association, devant témoins", "en": "Give them to charity, with witnesses" },
      "effects": { "popularity": 7, "reputation": 1, "notoriete": 1, "reseau": -1, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et se reposer vraiment", "en": "Go, and actually rest" },
      "effects": { "energie": 3, "money": 20000, "reputation": -1, "popularity": -7, "reseau": 1 },
    ...
    { "label": { "fr": "Y aller et parler des prisonniers politiques", "en": "Go, and raise the political prisoners" },
      ...
      "success": { "effects": { "notoriete": 1, "popularity": 10, "reputation": 1, "reseau": -1, "energie": -1 },
      ...
      "failure": { "effects": { "popularity": -5, "reseau": -1, "standing": -4, "energie": -1 },
    ...
    { "label": { "fr": "Refuser publiquement l'invitation", "en": "Turn the invitation down publicly" },
      "effects": { "popularity": 9, "reputation": 1, "reseau": -1, "energie": -1, "standing": -4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Privatiser un restaurant et inviter du beau monde", "en": "Take over a restaurant and invite the right people" },
      ...
      "success": { "effects": { "money": -45000, "reseau": 1, "standing": 3, "notoriete": 1 },
      ...
      "failure": { "effects": { "money": -45000, "popularity": -4, "reputation": -1, "standing": 1 },
    ...
    { "label": { "fr": "Donner à une œuvre, et le faire savoir", "en": "Give to a charity, and make sure it is known" },
      ...
      "success": { "effects": { "money": -150000, "reputation": 1, "popularity": 5, "standing": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "L'acheter et payer deux permanents", "en": "Buy it and pay two staffers" },
      ...
      "effects": { "money": -280000, "standing": 6, "reseau": 1, "appeal": { "self": 3 }, "energie": -1 },
    ...
    { "label": { "fr": "Garder l'argent, le mandat ne dure pas", "en": "Keep the money; the mandate will not last" },
      ...
      "failure": { "effects": {"money": 6000, "popularity": -9, "standing": -5, "reputation": -1, "strike": "casserole"},
...

{
  ...
  "choices": [
    { "label": { "fr": "Financer la fondation en entier", "en": "Fund the foundation in full" },
      ...
      "success": { "effects": { "money": -700000, "credibilite": 1, "notoriete": 1, "reseau": 1, "reputation": 1 },
      ...
      "failure": { "effects": { "money": -700000, "popularity": -4, "reputation": -1, "notoriete": 1 },
    ...
    { "label": { "fr": "Financer une chaire, et ne pas y mettre votre nom", "en": "Fund a chair, and keep your name off it" },
      "effects": { "money": -350000, "credibilite": 1, "reseau": 1, "standing": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Forcer le cordon et hurler devant les caméras", "en": "Push through the cordon and shout in front of the cameras" },
      ...
      "success": { "effects": { "appeal": { "self": 15, "others": -6 }, "charisme": 1, "notoriete": 2, "credibilite": -1,
      ...
      "failure": { "effects": { "popularity": -13, "credibilite": -2, "reputation": -1, "notoriete": 2,
      ...
      "debacle": { "effects": { "popularity": -16, "credibilite": -2, "reputation": -1, "notoriete": 2,
    ...
    { "label": { "fr": "Tout ouvrir, et publier les comptes vous-même le soir même", "en": "Open everything, and publish the accounts yourself that evening" },
      "effects": { "credibilite": 2, "reputation": 1, "popularity": 6, "standing": -2, "energie": -2,
                   "appeal": { "self": -7 } },
      "effectsIf": [
    ...
    { "label": { "fr": "Attaquer sur la date : onze mois de signalement, et une descente maintenant", "en": "Go after the timing: eleven months on the referral, and a raid now" },
      ...
      "success": { "effects": { "axis": { "power": -60 }, "popularity": 10, "eloquence": 1, "notoriete": 1, "credibilite": 1,
      ...
      "failure": { "effects": { "popularity": -7, "credibilite": -1, "standing": -3, "energie": -1 },
    ...
    { "label": { "fr": "Laisser l'avocat parler et ne rien dire pendant quinze jours", "en": "Let the lawyer speak and say nothing for a fortnight" },
      "effects": { "credibilite": 1, "standing": 2, "energie": 1, "notoriete": -1, "popularity": -5,
                   "appeal": { "self": -6 } },
    ...
    { "label": { "fr": "Prendre le cabinet qui a fait tomber la dernière commission d'enquête", "en": "Hire the firm that took down the last inquiry" },
      "when": { "minMoney": 250000 },
      "effects": { "money": -180000, "credibilite": 1, "standing": 4, "reputation": -1, "popularity": -3,
                   "reseau": 1 },

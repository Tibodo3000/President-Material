...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter discrètement", "en": "Accept quietly" },
      "effects": { "money": 140000, "reseau": 2, "standing": 9, "flags": { "dirtyMoney": true },
                   "strike": "casserole" },
    ...
    { "label": { "fr": "Le faire entrer par la porte : sept mille cinq cents euros, déclarés", "en": "Bring him in through the front door: seven thousand five hundred, declared" },
      "effects": { "money": 7500, "credibilite": 2, "reputation": 1, "reseau": 1, "standing": 1 },
    ...
    { "label": { "fr": "Lui demander maintenant ce qu'il voudra plus tard", "en": "Ask him now what he will want later" },
      ...
      "failure": { "effects": { "reseau": -3, "standing": -4, "popularity": -2,
                                "landscape": { "self": -0.8 } },
    ...
    { "label": { "fr": "Refuser poliment", "en": "Decline politely" },
      "effects": { "reputation": 2, "credibilite": 1, "sangfroid": 1, "standing": -6, "reseau": -2 },
    ...
    { "label": { "fr": "Le dénoncer publiquement", "en": "Expose him publicly" },
      ...
      "effects": { "landscape": { "self": -1.1, "identitarians": 0.9 }, "strike": "intrepide",
                   "notoriete": 2, "reputation": 3, "popularity": 11, "standing": -9,
    ...
    { "label": { "fr": "Accepter en montant un écran juridique", "en": "Accept behind a legal screen" },
      ...
      "effects": { "money": 190000, "reseau": 2, "standing": 9, "reputation": -2, "sangfroid": -1,
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire comme tout le monde", "en": "Do what everyone does" },
      ...
      "failure": { "effects": {"money": 6000, "popularity": -8, "reputation": -2, "credibilite": -2, "flags": {"dirtyMoney": true}, "strike": "casserole"},
    ...
    { "label": { "fr": "Tout payer de votre poche", "en": "Pay for everything yourself" },
      "effects": { "money": -20000, "reputation": 2, "popularity": 4, "standing": -4, "reseau": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Signer : c'est propre et rapide", "en": "Sign: it is clean and fast" },
      ...
      "success": { "effects": {"money": -140000, "standing": 7, "eloquence": 1, "popularity": -6, "reputation": -1, "credibilite": 2},
      ...
      "failure": { "effects": {"money": -40000, "popularity": -9, "credibilite": -3, "standing": -4, "reputation": -1},

...

{
  ...
  "choices": [
    { "label": { "fr": "Monter à la tribune", "en": "Take the floor" },
      ...
      "success": { "effects": { "eloquence": 1, "notoriete": 1, "popularity": 13, "standing": 6, "energie": -1 },
    ...
    { "label": { "fr": "Monter, et transformer ça en meeting", "en": "Take the floor and turn it into a rally" },
      ...
      "effects": { "axis": "self", "notoriete": 2, "popularity": 10, "standing": -8, "energie": -1, "strike": "radical" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Passer les trois coups de fil", "en": "Make the three phone calls" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "standing": 0.05, "charisme": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2.5 }, { "when": { "personality": ["calculating"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"standing": 4, "reseau": 1, "energie": -2, "popularity": -3},
      ...
      "failure": { "effects": {"reseau": -1, "standing": -7, "reputation": -1, "energie": -1},
        "result": { "fr": "Les trois appels sont passés et deux des trois en parlent au troisième. Ce que vous vouliez éviter arrive quand même, et il est désormais établi que vous avez essayé de l'éviter.",
                    "en": "The three calls are made and two of the three tell the third. What you were trying to prevent happens anyway, and it is now on the record that you tried to prevent it." } } },
    { "label": { "fr": "Les laisser partir et le dire au pays", "en": "Let them go, and say so publicly" },
      "effects": { "popularity": 11, "standing": -13, "reputation": 1, "notoriete": 1 },
    ...
    { "label": { "fr": "Acheter la paix sur vos deniers", "en": "Buy the peace out of your own pocket" },
      ...
      "effects": { "money": -150000, "standing": 9, "reseau": 1, "reputation": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Attaquer le magazine en diffamation", "en": "Sue the magazine for libel" },
      ...
      "effects": { "money": -80000, "notoriete": 1, "popularity": -3, "standing": 4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Organiser le rendez-vous", "en": "Set up the meeting" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "reseau": 0.35, "credibilite": 0.25 }, "bonus": [ { "when": { "personality": ["calculating"] }, "value": 2 }, { "when": { "background": ["law", "business"] }, "value": 1.5 }, { "when": { "trait": ["intouchable"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"reseau": 1, "standing": 6, "money": 10000, "reputation": -1},
      ...
      "failure": { "effects": {"reseau": -1, "reputation": -1, "popularity": -6, "standing": -4, "strike": "casserole"},
        "result": { "fr": "Le rendez-vous a lieu dans un bureau qui n'est pas le vôtre, ce qui ne trompe personne, et son entreprise obtient l'agrément quatre mois plus tard. Le rapprochement se fait tout seul, dans un article, deux ans après.",
                    "en": "The meeting takes place in an office that is not yours, which fools nobody, and his company gets its licence four months later. The connection makes itself, in an article, two years on." } } },
    { "label": { "fr": "Refuser en invoquant le secret professionnel", "en": "Refuse, citing professional privilege" },
      "effects": { "reputation": 1, "sangfroid": 1, "reseau": -1 },
    ...
    { "label": { "fr": "Raconter la scène dans un entretien", "en": "Tell the story in an interview" },
      ...
      "effects": { "notoriete": 1, "popularity": 9, "reseau": -2, "standing": -5 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Défendre la décision de vos anciens associés", "en": "Defend your former partners' decision" },
      "effects": { "axis": {"economy": 65}, "reseau": 1, "standing": 4, "popularity": 7, "reputation": -1 },
    ...
    { "label": { "fr": "Aller devant l'usine avec les salariés", "en": "Stand outside the plant with the workers" },
      "effects": { "axis": {"economy": -70}, "popularity": 10, "energie": -2, "reseau": -2, "reputation": 1 },
      "effectsIf": [
    ...
    { "label": { "fr": "Négocier discrètement un plan de reprise", "en": "Quietly broker a rescue deal" },
      "roll": { "base": 18, "stat": "reseau", "plus": { "sangfroid": 0.4, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "reputation": 1, "standing": 6, "energie": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Utiliser vos contacts pour retarder l'enquête", "en": "Use your contacts to delay the story" },
      "roll": { "base": 17, "stat": "reseau", "plus": { "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 8, "reseau": 1, "reputation": -1, "strike": "menteur" },
      ...
      "failure": { "effects": { "popularity": -10, "standing": -4, "reputation": -1, "strike": "casserole" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Aller vous expliquer à leur assemblée générale", "en": "Go and explain yourself at their meeting" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "reputation": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": {"economy": -50, "social": -40}, "reputation": 1, "popularity": 7, "energie": -2, "reseau": 1 },
    ...
    { "label": { "fr": "Leur financer une salle et du matériel", "en": "Pay for a venue and equipment for them" },
      "when": { "minMoney": 40000 },
      "effects": { "money": -30000, "reseau": 1, "popularity": 3, "reputation": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "La sortir en séance", "en": "Read it out in the chamber" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "credibilite": 0.4, "eloquence": 0.25 }, "bonus": [ { "when": { "background": ["civil"] }, "value": 2.5 }, { "when": { "background": ["law"] }, "value": 1.5 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"notoriete": 1, "popularity": 5, "standing": 4, "reseau": -2},
      ...
      "failure": { "effects": {"popularity": -6, "credibilite": -2, "standing": -6, "reseau": -1, "reputation": -1},
        "result": { "fr": "La note est authentique et elle date de onze mois. Le ministre répond qu'elle a été écrite par un stagiaire, qu'elle n'a jamais été validée, et il produit la version définitive dans l'heure. Les deux documents sont vrais.",
                    "en": "The memo is genuine and eleven months old. The minister replies that it was drafted by an intern, that it was never signed off, and produces the final version within the hour. Both documents are genuine." } } },
    { "label": { "fr": "La garder pour un meilleur moment", "en": "Keep it for a better moment" },
      "effects": { "sangfroid": 1, "reseau": 1, "standing": 3, "popularity": -2 },
    ...
    { "label": { "fr": "La renvoyer sans l'avoir lue", "en": "Send it back unread" },
      "effects": { "reputation": 1, "reseau": 1, "popularity": -3, "standing": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Revendiquer d'avoir changé d'avis", "en": "Claim the right to have changed your mind" },
      "roll": { "base": 14, "stat": "eloquence", "plus": { "credibilite": 0.35, "reputation": 0.3 }, "bonus": [ { "when": { "background": ["academia"] }, "value": 2.5 }, { "when": { "personality": ["clever"] }, "value": 1.5 }, { "when": { "trait": ["menteur"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"eloquence": 1, "reputation": 1, "popularity": 6, "standing": -3, "credibilite": 1},
      ...
      "failure": { "effects": {"popularity": -7, "credibilite": -1, "notoriete": 1, "standing": -4},
        "result": { "fr": "Vous expliquez pourquoi vous ne pensez plus ce que vous avez écrit, et c'est honnête. On retient qu'un homme qui a changé d'avis une fois peut en changer deux, et la phrase de la thèse est citée sans la vôtre pendant trois semaines.",
                    "en": "You explain why you no longer think what you wrote, and it is honest. What people keep is that a man who has changed his mind once can change it twice, and the line from the thesis is quoted without yours for three weeks." } } },
    ...
    { "label": { "fr": "Republier l'article avec une préface", "en": "Republish the paper with a new preface" },
      "effects": { "eloquence": 1, "notoriete": 1, "reputation": 1, "energie": -1, "popularity": 2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "En rire et republier la compilation", "en": "Laugh and repost the compilation yourself" },
      "effects": { "charisme": 1, "notoriete": 1, "popularity": 8, "standing": -6 },
    ...
    { "label": { "fr": "Faire retirer les vidéos", "en": "Have the videos taken down" },
      ...
      "failure": { "effects": { "money": -60000, "popularity": -12, "notoriete": 1, "strike": "casserole" },
    ...
    { "label": { "fr": "Raconter ce que ça payait", "en": "Explain what it paid for" },
      "effects": { "reputation": 1, "popularity": 7, "energie": -1 },
      "effectsIf": [
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Retourner votre connaissance de leurs méthodes", "en": "Turn your knowledge of their methods against them" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "credibilite": 0.35, "notoriete": 0.2 }, "bonus": [ { "when": { "background": ["comms", "journalism"] }, "value": 2.5 }, { "when": { "personality": ["clever"] }, "value": 1.5 }, { "when": { "trait": ["orateur"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"eloquence": 1, "notoriete": 1, "popularity": 7, "reseau": -1, "standing": -2, "credibilite": 1},
      ...
      "failure": { "effects": {"popularity": -6, "credibilite": -1, "standing": -4, "reputation": -1},
        "result": { "fr": "Vous expliquez comment on fabrique un slogan, et le public comprend surtout que vous savez le faire. La démonstration est brillante et elle se retourne dans la semaine : on vous demande lequel des vôtres était sincère.",
                    "en": "You explain how a slogan is manufactured, and what the audience mainly grasps is that you know how. The demonstration is brilliant and it turns on you within the week: you are asked which of your own were sincere." } } },
    { "label": { "fr": "Faire venir votre ancienne agence sur votre campagne", "en": "Bring your old agency onto your campaign" },
      "when": { "minMoney": 120000 },
      "effects": { "money": -100000, "standing": 5, "reseau": 1, "reputation": -1, "popularity": -3 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "En tirer une formule et la marteler", "en": "Boil it down to one line and hammer it" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "charisme": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "eloquence": 1, "notoriete": 1, "popularity": 10, "standing": -2 },
    ...
    { "label": { "fr": "Le confier à un collègue plus médiatique", "en": "Hand it to a more telegenic colleague" },
      "effects": { "reseau": 1, "standing": 5, "energie": 1, "notoriete": -1, "popularity": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "En jouer sans jamais confirmer", "en": "Play with it without ever confirming" },
      "effects": { "charisme": 1, "notoriete": 1, "popularity": 8, "reputation": -1, "standing": -4 },
    ...
    { "label": { "fr": "Chercher qui l'a lancée", "en": "Find out who started it" },
      "roll": { "base": 17, "stat": "reseau", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Assumer et recommencer", "en": "Own it and do it again" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "sangfroid": 0.35, "notoriete": 0.25 }, "bonus": [ { "when": { "personality": ["provocative"] }, "value": 2 }, { "when": { "trait": ["teflon"] }, "value": 2.5 }, { "when": { "trait": ["menteur"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"landscape": {"self": -0.6}, "charisme": 1, "notoriete": 2, "eloquence": 1, "popularity": 11, "standing": 3, "reputation": -1},
      ...
      "failure": { "effects": {"popularity": -9, "reputation": -1, "standing": -5, "credibilite": -1},
        "result": { "fr": "Vous le redites, en pire, dans une matinale. Cette fois la phrase n'est plus une saillie mais une position, et une position se discute, se cite et se ressort à chaque portrait.",
                    "en": "You say it again, worse, on a morning programme. This time the line is no longer a quip but a position, and a position can be argued with, quoted, and brought back out in every profile." } } },
    { "label": { "fr": "Vous excuser auprès de l'intéressé", "en": "Apologise to the man himself" },
      "effects": { "reseau": 1, "reputation": 1, "standing": 4, "popularity": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire la séquence sérieuse", "en": "Do the serious stretch" },
      "effects": { "reputation": 1, "standing": 6, "appeal": { "self": -7 }, "notoriete": -1 },
    ...
    { "label": { "fr": "En rajouter dès le lendemain", "en": "Go further the very next day" },
      "effects": { "axis": "self", "notoriete": 2, "popularity": 9, "reputation": -1, "standing": -8, "strike": "radical" },
    ...
    { "label": { "fr": "Retourner l'accusation contre la presse", "en": "Turn the accusation back on the press" },
      "roll": { "base": 16, "stat": "charisme", "plus": { "eloquence": 0.4, "popularity": 0.03 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "charisme": 1, "notoriete": 1, "popularity": 10, "standing": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Refuser et le dire à la sortie", "en": "Refuse, and say so on the way out" },
      "effects": { "reputation": 1, "popularity": 9, "standing": -12, "reseau": -1 },
    ...
    { "label": { "fr": "Accepter, une fois", "en": "Accept, just this once" },
      "effects": { "standing": 12, "reseau": 1, "popularity": -3 },
      "effectsIf": [
    ...
    { "label": { "fr": "Refuser et faire voter l'amendement", "en": "Refuse, and get the amendment passed" },
      "roll": { "base": 19, "stat": "eloquence", "plus": { "reseau": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "reputation": 1, "notoriete": 1, "popularity": 11, "standing": -6 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout lui expliquer, et lui offrir sa part", "en": "Explain everything, and offer him his share" },
      "effects": { "reseau": 1, "standing": 1, "sangfroid": 1, "popularity": -2, "energie": -1,
                   "landscape": { "self": 0.9 } },
      "result": { "fr": "Il accepte, à contrecœur et pour longtemps. Vous venez de fabriquer un associé, pas un ami. Le parti, lui, ne se coupe pas en deux ce trimestre-là, et c'est vous qui payez la moitié qu'il a fallu céder.",
    ...
    { "label": { "fr": "Nier en bloc", "en": "Deny everything" },
      "roll": { "base": 16, "stat": "sangfroid",
                "plus": { "eloquence": 0.4, "reseau": 0.25, "standing": 0.04 },
                "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2.5 },
                           { "when": { "trait": ["clairvoyant"] }, "value": 1.5 },
                           { "when": { "anyTrait": ["traitre", "menteur"] }, "value": -2.5 } ],
                "dice": 16 },
      "success": { "effects": { "standing": 9, "sangfroid": 1, "strike": "menteur" },
      ...
      "failure": { "effects": { "standing": -12, "reseau": -2, "reputation": -1, "strike": "traitre" },
    ...
    { "label": { "fr": "Le prendre de vitesse et le griller d'abord", "en": "Move first and burn him" },
      "effects": { "standing": 12, "reseau": -2, "reputation": -1, "popularity": -4,
                   "strike": "traitre", "landscape": { "self": -1.1 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Suivre la consigne", "en": "Follow the advice" },
      "effects": { "standing": 9, "reputation": -1, "popularity": -2, "sangfroid": 1 },
    ...
    { "label": { "fr": "Répondre que la question ne se pose pas", "en": "Answer that the question does not arise" },
      "effects": { "reputation": 1, "sangfroid": 1, "standing": -4 },
    ...
    { "label": { "fr": "Prendre les devants et en parler publiquement", "en": "Get ahead of it and say it publicly" },
      ...
      "success": { "effects": {"notoriete": 1, "popularity": 4, "reputation": 2, "standing": -6},
      ...
      "failure": { "effects": {"popularity": -6, "standing": -8, "notoriete": 1, "energie": -2},
...

{
  ...
  "choices": [
    { "label": { "fr": "Le devancer d'un jour", "en": "Beat them by a day" },
      "effects": { "axis": {"social": -60}, "notoriete": 1, "popularity": 9, "reputation": 1, "energie": -1 },
    ...
    { "label": { "fr": "Attaquer en justice pour vie privée", "en": "Sue over privacy" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "money": 0.5 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "money": -25000, "reputation": 1, "standing": 4, "popularity": -2 },
      ...
      "failure": { "effects": { "money": -25000, "popularity": -6, "notoriete": 1, "standing": -4 },
    ...
    { "label": { "fr": "Ne rien faire et laisser paraître", "en": "Do nothing and let it run" },
      "effects": { "sangfroid": 1, "popularity": 2, "reputation": 1, "energie": -1, "strike": "lache" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Il figure, comme tous les autres", "en": "He appears, like everybody else" },
      ...
      "success": { "effects": {"popularity": 6, "reputation": 1, "notoriete": 1},
      ...
      "failure": { "effects": {"popularity": -4, "energie": -2, "standing": -5, "notoriete": 1},
    ...
    { "label": { "fr": "Demander pourquoi la question est posée", "en": "Ask why the question is being asked" },
      "effects": { "reputation": 2, "notoriete": 1, "standing": -5, "popularity": 3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller sérieusement, pendant deux ans", "en": "Go seriously, for two years" },
      "roll": { "base": 14, "stat": "energie", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2 }, { "when": { "trait": ["athletique"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 }, { "when": { "trait": ["epuise"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": { "untrait": "zozote", "eloquence": 1, "energie": -1, "money": -9000 },
    ...
    { "label": { "fr": "En faire votre marque de fabrique", "en": "Make it your trademark" },
      "effects": { "notoriete": 1, "popularity": 7, "charisme": 1, "standing": -5 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Se plaindre à la chaîne", "en": "Complain to the channel" },
      "roll": { "chance": 0.36,
                "chanceBonus": [ { "when": { "stat": { "reseau": { "min": 13 } } }, "value": 0.16 },
                                 { "when": { "minStanding": 62 }, "value": 0.12 },
                                 { "when": { "background": ["journalism", "comms"] }, "value": 0.12 } ] },
      "success": { "effects": { "popularity": 1, "standing": 6, "reseau": 1, "sangfroid": 1 },
        "result": { "fr": "Le numéro disparaît de la grille en trois semaines, sans communiqué et sans explication. L'humoriste le racontera dans huit ans, dans un livre que personne n'attend, et il aura raison.",
                    "en": "The sketch quietly leaves the schedule within three weeks, with no statement and no explanation. The comedian will tell the story in eight years, in a book nobody is waiting for, and he will be right." } },
      "failure": { "effects": { "popularity": -8, "reputation": -1, "standing": 3, "strike": "lache" },
    ...
    { "label": { "fr": "Travailler la voix jusqu'à rendre l'imitation fausse", "en": "Work on the voice until the impression stops working" },
      "when": { "trait": ["zozote"] },
      "effects": { "energie": -2, "eloquence": 1, "popularity": 2, "money": -6000 },

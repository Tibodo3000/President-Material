...

{
  ...
  "choices": [
    { "label": { "fr": "Passer les trois coups de fil", "en": "Make the three phone calls" },
      ...
      "success": { "effects": {"standing": 4, "reseau": 2, "energie": -2, "popularity": -3},
      ...
      "failure": { "effects": {"reseau": -2, "standing": -7, "reputation": -1, "energie": -1},
...

{
  ...
  "choices": [
    { "label": { "fr": "Organiser le rendez-vous", "en": "Set up the meeting" },
      ...
      "success": { "effects": {"reseau": 2, "standing": 6, "money": 10000, "reputation": -1},
      ...
      "failure": { "effects": {"reseau": -1, "reputation": -2, "popularity": -6, "standing": -4, "strike": "casserole"},
...

{
  ...
  "choices": [
    { "label": { "fr": "La sortir en séance", "en": "Read it out in the chamber" },
      ...
      "success": { "effects": {"notoriete": 2, "popularity": 5, "standing": 4, "reseau": -3},
      ...
      "failure": { "effects": {"popularity": -6, "credibilite": -3, "standing": -6, "reseau": -2, "reputation": -1},
...

{
  ...
  "choices": [
    { "label": { "fr": "Revendiquer d'avoir changé d'avis", "en": "Claim the right to have changed your mind" },
      ...
      "success": { "effects": {"eloquence": 1, "reputation": 1, "popularity": 6, "standing": -3, "credibilite": 2},
      ...
      "failure": { "effects": {"popularity": -7, "credibilite": -2, "notoriete": 1, "standing": -4},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Retourner votre connaissance de leurs méthodes", "en": "Turn your knowledge of their methods against them" },
      ...
      "success": { "effects": {"notoriete": 2, "popularity": 7, "reseau": -2, "standing": -2, "credibilite": 2},
      ...
      "failure": { "effects": {"popularity": -6, "credibilite": -2, "standing": -4, "reputation": -1},
...

{
  ...
  "choices": [
    { "label": { "fr": "Assumer et recommencer", "en": "Own it and do it again" },
      ...
      "success": { "effects": {"landscape": {"self": -0.6}, "notoriete": 5, "eloquence": 1, "popularity": 11, "standing": 3, "reputation": -2},
      ...
      "failure": { "effects": {"popularity": -9, "reputation": -2, "standing": -5, "credibilite": -2},
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout lui expliquer, et lui offrir sa part", "en": "Explain everything, and offer him his share" },
      "effects": { "reseau": 2, "standing": 1, "sangfroid": 1, "popularity": -2, "energie": -1,
                   "landscape": { "self": 0.9 } },
    ...
    { "label": { "fr": "Le prendre de vitesse et le griller d'abord", "en": "Move first and burn him" },
      "effects": { "standing": 12, "reseau": -3, "reputation": -2, "popularity": -4,
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Se plaindre à la chaîne", "en": "Complain to the channel" },
      ...
      "failure": { "effects": { "popularity": -8, "reputation": -2, "standing": 3, "strike": "lache" },

...

{
  ...
  "choices": [
    { "label": { "fr": "Verrouiller le groupe, vote par vote", "en": "Lock the group down, vote by vote" },
      "effects": { "standing": 9, "approval": 5, "reputation": -1, "popularity": -5, "credibilite": 1, "energie": -2 },
    ...
    { "label": { "fr": "Laisser passer des amendements de l'opposition sur les textes mineurs", "en": "Let opposition amendments through on the minor bills" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "credibilite": 0.45, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 8, "reputation": 1, "credibilite": 1, "standing": -4 },
    ...
    { "label": { "fr": "Faire passer tout le programme, tout de suite", "en": "Push the entire platform through, immediately" },
      "effects": { "standing": 7, "credibilite": 1, "landscape": { "self": 1.4 }, "approval": -8, "popularity": -6, "energie": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Négocier un accord de gouvernement", "en": "Negotiate a coalition agreement" },
      ...
      "success": { "effects": { "alliance": "scene", "standing": 6, "approval": 7, "credibilite": 1,
    ...
    { "label": { "fr": "Demander au président de dissoudre", "en": "Ask the president to dissolve" },
      "roll": { "base": 16, "stat": "credibilite", "plus": { "charisme": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "dissolve": true, "notoriete": 1, "popularity": 4, "standing": 5, "energie": -2 },
      ...
      "failure": { "effects": { "standing": -9, "approval": -6, "credibilite": -1, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Entretenir la division d'en face, discrètement", "en": "Keep the other side divided, quietly" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "standing": 7, "approval": 5, "reputation": -1, "energie": -2 },
      ...
      "failure": { "effects": { "standing": -6, "approval": -7, "reputation": -2, "strike": "casserole" },
    ...
    { "label": { "fr": "Proposer un pacte de non-censure, publiquement", "en": "Publicly offer a no-confidence truce" },
      "effects": { "reputation": 2, "credibilite": 1, "approval": 8, "popularity": 3, "standing": -8 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Payer, et payer vite", "en": "Pay, and pay quickly" },
      "effects": { "standing": -6, "approval": 6, "landscape": { "self": -1.2, "ally": 1.4 }, "reseau": 1, "credibilite": 1 },
    ...
    { "label": { "fr": "Rappeler qui a gagné la présidentielle", "en": "Remind them who won the presidential election" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "credibilite": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "standing": 9, "credibilite": 1, "landscape": { "ally": -1 }, "approval": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Entrer au gouvernement, et négocier les postes", "en": "Join the government, and negotiate the posts" },
      "roll": { "base": 14, "stat": "reseau", "plus": { "credibilite": 0.5, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "alliance": "ruling", "standing": 8, "credibilite": 1, "popularity": -5,
      ...
      "failure": { "effects": { "standing": -9, "popularity": -5, "reputation": -1, "credibilite": -1 },
    ...
    { "label": { "fr": "Soutenir sans participer, texte par texte", "en": "Support without joining, bill by bill" },
      "effects": { "sangfroid": 1, "credibilite": 1, "standing": 4, "approval": 5, "popularity": -1, "chain": "alliance_a_la_carte" },
    ...
    { "label": { "fr": "Refuser, et le dire à la sortie", "en": "Refuse, and say so on the way out" },
      "effects": { "axis": "self", "popularity": 10, "notoriete": 1, "reputation": 1, "standing": -5, "credibilite": -1,
    ...
    { "label": { "fr": "Faire monter les enchères avant de répondre", "en": "Drive the price up before answering" },
      "when": { "minStanding": 55 },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "reseau": 0.5, "credibilite": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "alliance": "ruling", "standing": 11, "credibilite": 2, "popularity": -4,
      ...
      "failure": { "effects": { "standing": -11, "popularity": -6, "credibilite": -1, "landscape": { "self": -1 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Gouverner à blanc : sortir un contre-budget complet", "en": "Govern in the abstract: publish a full alternative budget" },
      "roll": { "base": 15, "stat": "credibilite", "plus": { "eloquence": 0.4, "energie": 0.3 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "popularity": 7, "standing": 5, "energie": -3, "landscape": { "self": 1.2 } },
      ...
      "failure": { "effects": { "credibilite": -1, "popularity": -5, "standing": -4, "energie": -3 },
    ...
    { "label": { "fr": "Occuper l'hémicycle : obstruction sur tous les textes", "en": "Occupy the chamber: obstruct every bill" },
      "effects": { "axis": "self", "notoriete": 2, "standing": 7, "approval": -7, "popularity": 7, "credibilite": -1, "energie": -3 },
    ...
    { "label": { "fr": "Voter les textes que vous approuvez, et le dire", "en": "Vote for the bills you agree with, and say so" },
      "effects": { "reputation": 2, "credibilite": 1, "popularity": 5, "standing": -9, "approval": 4, "appeal": { "self": -6 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout miser sur les deux minutes", "en": "Put everything into the two minutes" },
      "roll": { "base": 13, "stat": "eloquence", "plus": { "charisme": 0.5 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "eloquence": 1, "notoriete": 2, "popularity": 9, "landscape": { "self": 1.2 } },
    ...
    { "label": { "fr": "Échanger vos voix contre des amendements, sans état d'âme", "en": "Trade your votes for amendments, without sentiment" },
      "effects": { "reseau": 1, "standing": 6, "credibilite": 1, "popularity": -4, "reputation": -1 },
    ...
    { "label": { "fr": "Chercher à fusionner avec un groupe voisin", "en": "Try to merge with a neighbouring group" },
      "when": { "minStanding": 45 },
      "roll": { "base": 16, "stat": "reseau", "plus": { "charisme": 0.4, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "alliance": "scene", "standing": 5, "credibilite": 1, "landscape": { "self": 1, "ally": 0.5 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Réclamer un ministère, publiquement", "en": "Demand a ministry, in public" },
      "roll": { "base": 16, "stat": "credibilite", "plus": { "reseau": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "office": "ministre", "standing": 9, "credibilite": 1, "popularity": -4, "reputation": -1 },
      ...
      "failure": { "effects": { "standing": -8, "popularity": -4, "credibilite": -1, "approval": -3 },
    ...
    { "label": { "fr": "Sortir de la coalition, en plein budget", "en": "Walk out of the coalition, mid-budget" },
      "effects": { "popularity": 8, "standing": -6, "approval": -11, "appeal": { "ruling": -6 }, "landscape": { "self": 1.4, "ruling": -1.2 }, "notoriete": 1 },
    ...
    { "label": { "fr": "Continuer, et faire les comptes plus tard", "en": "Carry on, and settle up later" },
      "effects": { "sangfroid": 1, "reseau": 1, "credibilite": 1, "standing": 2, "popularity": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Placer vos fidèles partout où c'est possible", "en": "Place your loyalists wherever you can" },
      "effects": { "standing": 8, "reseau": 2, "reputation": -1, "popularity": -3, "landscape": { "self": -0.6 } },
    ...
    { "label": { "fr": "Investir les mieux placés, y compris vos adversaires internes", "en": "Nominate the strongest candidates, internal rivals included" },
      "effects": { "reputation": 2, "credibilite": 1, "landscape": { "self": 1.4 }, "standing": -5 },
    ...
    { "label": { "fr": "Garder trois circonscriptions en réserve pour négocier", "en": "Hold three seats back as bargaining chips" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "reseau": 0.5 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "reseau": 2, "standing": 6, "credibilite": 1, "reputation": -1 },
      ...
      "failure": { "effects": { "standing": -7, "reputation": -1, "landscape": { "self": -1 }, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "La circonscription. On ne dirige rien quand on n'est plus élu", "en": "The constituency. You run nothing once you stop being elected" },
      "effects": { "appeal": { "self": 8 }, "reseau": 1, "energie": -2, "standing": -5 },
    ...
    { "label": { "fr": "Les deux, et dormir dans le train", "en": "Both, and sleep on the train" },
      "roll": { "base": 15, "stat": "energie", "plus": { "charisme": 0.4 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2 }, { "when": { "trait": ["athletique"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 }, { "when": { "trait": ["epuise"] }, "value": -2 } ], "dice": 16 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Tenir sur les quatre, quitte à tout faire capoter", "en": "Hold on all four, even if it kills the deal" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "eloquence": 0.4, "credibilite": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "standing": 10, "credibilite": 1, "reputation": 1, "approval": -3 },
    ...
    { "label": { "fr": "Signer les trente-huit et renvoyer les quatre à plus tard", "en": "Sign the thirty-eight and defer the four" },
      "effects": { "reseau": 1, "approval": 5, "credibilite": -1, "standing": 2, "chain": "alliance_epreuve" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Exiger un ministère régalien, pour vous", "en": "Demand a great office of state, for yourself" },
      "roll": { "base": 16, "stat": "credibilite", "plus": { "reseau": 0.45, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "office": "ministre", "standing": 8, "credibilite": 2, "notoriete": 1, "popularity": -4 },
    ...
    { "label": { "fr": "Prendre les trois postes et y placer vos meilleurs", "en": "Take the three posts and fill them with your best people" },
      "effects": { "reseau": 2, "standing": 6, "credibilite": 1, "popularity": -2, "chain": "alliance_epreuve" },
    ...
    { "label": { "fr": "Refuser tous les postes et rester au Parlement", "en": "Turn down every post and stay in Parliament" },
      "effects": { "reputation": 2, "credibilite": 1, "popularity": 6, "standing": -6, "sangfroid": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Vendre cher, et faire savoir que c'était cher", "en": "Sell dear, and let it be known that it was dear" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "sangfroid": 0.4, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 9, "reseau": 1, "credibilite": 1, "approval": -4, "popularity": 2 },
    ...
    { "label": { "fr": "Voter pour, sans rien demander cette fois", "en": "Vote for it, asking for nothing this time" },
      "effects": { "reputation": 1, "credibilite": 1, "approval": 6, "standing": -4, "popularity": 3, "chain": "alliance_epreuve" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire voter votre groupe, discipline comprise", "en": "Whip your group into voting for it" },
      "effects": { "standing": -10, "approval": 8, "credibilite": 1, "popularity": -5, "landscape": { "self": -1.4 } },
    ...
    { "label": { "fr": "Laisser la liberté de vote", "en": "Allow a free vote" },
      "effects": { "reputation": 1, "sangfroid": 1, "standing": 2, "approval": -5, "credibilite": -1 },
    ...
    { "label": { "fr": "Rompre l'accord sur ce texte, et l'annoncer avant eux", "en": "Break the deal over this bill, and announce it first" },
      "effects": { "alliance": null, "popularity": 8, "standing": 6, "approval": -12, "credibilite": -1,
...

{
  ...
  "choices": [
    { "label": { "fr": "Achever le gouvernement : voter la censure", "en": "Finish the government off: vote the censure" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "eloquence": 0.35, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "dissolve": true, "notoriete": 2, "popularity": 10, "standing": 7, "approval": -12, "appeal": { "scene": -8 },
                                "landscape": { "self": 1.4 } },
      ...
      "failure": { "effects": { "popularity": -7, "standing": -10, "credibilite": -1, "approval": 6 },
    ...
    { "label": { "fr": "Reprendre langue, sans rien signer cette fois", "en": "Reopen talks, signing nothing this time" },
      "effects": { "reseau": 1, "credibilite": 1, "approval": 5, "standing": -4, "popularity": -3, "chain": "alliance_a_la_carte" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Aller chercher les voix une par une", "en": "Go and find the votes one at a time" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "energie": 0.4, "eloquence": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 2, "credibilite": 2, "standing": 8, "approval": 7, "energie": -4 },
    ...
    { "label": { "fr": "Passer en force et assumer", "en": "Force it through and own it" },
      "effects": { "standing": 4, "approval": -10, "popularity": -7, "credibilite": 1, "notoriete": 1, "landscape": { "self": -1 } },
    ...
    { "label": { "fr": "Céder sur les recettes pour sauver les dépenses", "en": "Give on the revenue side to save the spending" },
      "effects": { "credibilite": 1, "reputation": 1, "approval": 4, "standing": -5 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire campagne auprès des députés, un par un", "en": "Canvass the members, one by one" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "charisme": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 2, "standing": 10, "credibilite": 1, "energie": -3 },
    ...
    { "label": { "fr": "Soutenir {rival} contre une commission", "en": "Back {rival} in exchange for a committee" },
      "effects": { "reseau": 1, "standing": 4, "credibilite": 1, "popularity": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Viser un ministre, avec des pièces", "en": "Go after a minister, with documents" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "eloquence": 0.4, "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "notoriete": 2, "popularity": 10, "credibilite": 2, "approval": -9, "energie": -3, "appeal": { "ruling": -6 },
      ...
      "failure": { "effects": { "popularity": -6, "credibilite": -1, "reputation": -1, "energie": -3, "approval": 4 },
    ...
    { "label": { "fr": "Choisir un sujet technique et faire un vrai travail", "en": "Pick a technical subject and do real work" },
      "effects": { "credibilite": 2, "reputation": 1, "eloquence": 1, "energie": -3, "popularity": -2, "standing": 2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Un texte que la majorité devra refuser en public", "en": "A bill the majority will have to reject in public" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "reseau": 0.4, "credibilite": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 9, "credibilite": 1, "eloquence": 1, "notoriete": 1, "approval": -6, "standing": 4 },
    ...
    { "label": { "fr": "Donner votre journée à un collègue menacé chez lui", "en": "Give your day to a colleague in trouble at home" },
      "effects": { "reseau": 2, "standing": 5, "reputation": 1, "popularity": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "La question qu'on ne peut pas préparer", "en": "The question nobody can prepare for" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "sangfroid": 0.45, "charisme": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "eloquence": 1, "notoriete": 2, "popularity": 9, "approval": -5, "standing": 3, "appeal": { "ruling": -5 } },
      ...
      "failure": { "effects": { "popularity": -5, "credibilite": -1, "notoriete": 1 },
    ...
    { "label": { "fr": "Céder votre question à un dossier de circonscription", "en": "Use your question on a constituency issue" },
      "effects": { "popularity": 4, "reseau": 1, "notoriete": -1, "standing": 1 },
    ...
    { "label": { "fr": "Faire un numéro : la formule qui tourne", "en": "Do a turn: the line that travels" },
      "roll": { "base": 14, "stat": "charisme", "plus": { "eloquence": 0.5 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "charisme": 1, "notoriete": 2, "popularity": 8, "credibilite": -1, "standing": -2 },
      ...
      "failure": { "effects": { "popularity": -6, "credibilite": -1, "reputation": -1, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Voter avec le groupe", "en": "Vote with the group" },
      "effects": { "standing": 7, "approval": 4, "reputation": -1, "popularity": -5, "strike": "menteur" },
    ...
    { "label": { "fr": "Voter contre, et l'assumer devant le groupe", "en": "Vote against, and own it in front of the group" },
      "effects": { "reputation": 2, "credibilite": 1, "popularity": 7, "standing": -11, "approval": -5, "appeal": { "self": -6 } },
    ...
    { "label": { "fr": "S'absenter de l'hémicycle ce jour-là", "en": "Be absent from the chamber that day" },
      "roll": { "base": 13, "stat": "sangfroid", "plus": { "reseau": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "standing": -7, "reputation": -1, "popularity": -3, "strike": "lache" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter, et prendre l'amendement", "en": "Accept, and take the amendment" },
      "effects": { "reseau": 1, "standing": 5, "popularity": 3, "reputation": -1, "approval": 4 },
    ...
    { "label": { "fr": "Refuser, et voter selon le texte", "en": "Refuse, and vote on the merits" },
      "effects": { "reputation": 2, "credibilite": 1, "standing": -5, "popularity": 2, "energie": -1 },
    ...
    { "label": { "fr": "Accepter, puis voter contre quand même", "en": "Accept, then vote against anyway" },
      "roll": { "base": 17, "stat": "sangfroid", "plus": { "reseau": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "standing": 4, "popularity": 5, "reputation": -1, "reseau": 1 },
      ...
      "failure": { "effects": { "standing": -10, "reputation": -2, "credibilite": -1, "strike": "menteur" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Voter la censure et faire tomber le gouvernement", "en": "Vote the censure and bring the government down" },
      "effects": { "notoriete": 2, "popularity": 10, "standing": 6, "approval": -12, "dissolve": true, "appeal": { "scene": -8 },
    ...
    { "label": { "fr": "Négocier votre abstention, et facturer", "en": "Negotiate your abstention, and invoice" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "sangfroid": 0.45, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 2, "standing": 9, "credibilite": 1, "approval": 5, "popularity": -3 },
      ...
      "failure": { "effects": { "standing": -8, "popularity": -6, "reputation": -1, "approval": 3 },
    ...
    { "label": { "fr": "Voter contre la censure, et dire pourquoi", "en": "Vote against the censure, and say why" },
      "effects": { "reputation": 2, "credibilite": 1, "approval": 8, "standing": -6, "popularity": -4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Expliquer la méthode, chiffres à l'appui", "en": "Explain the methodology, with figures" },
      ...
      "success": { "effects": { "credibilite": 1, "popularity": 3, "reputation": 1, "energie": -1 },
      ...
      "failure": { "effects": { "popularity": -6, "reputation": -1, "notoriete": 1 },
    ...
    { "label": { "fr": "Passer six mois à l'Assemblée, du lundi au vendredi", "en": "Spend six months in the chamber, Monday to Friday" },
      "effects": { "credibilite": 1, "reputation": 1, "standing": 4, "energie": -3, "popularity": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et dire que le pays a été clair", "en": "Go on and say the country has been clear" },
      "roll": { "base": 14, "stat": "eloquence", "plus": { "sangfroid": 0.4, "credibilite": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "eloquence": 1, "notoriete": 1, "popularity": 8, "credibilite": 1, "standing": 3 },
    ...
    { "label": { "fr": "Rester au siège et compter les circonscriptions", "en": "Stay at headquarters and count the seats" },
      "effects": { "reseau": 1, "standing": 6, "credibilite": 1, "popularity": -2, "energie": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Le maintenir et le défendre quand même", "en": "Keep it and defend it anyway" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "credibilite": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 7, "credibilite": 1, "notoriete": 1, "standing": -6 },
    ...
    { "label": { "fr": "Aller voir le ministre directement, hors séance", "en": "Go and see the minister directly, off the floor" },
      "roll": { "base": 14, "stat": "reseau", "plus": { "sangfroid": 0.35 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "standing": 4, "credibilite": 1, "energie": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire du bruit, puisque le vote est perdu d'avance", "en": "Make noise, since the vote is lost anyway" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "notoriete": 0.35 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "charisme": 1, "notoriete": 1, "popularity": 8, "credibilite": -1, "standing": -3, "approval": -4 },
      ...
      "failure": { "effects": { "popularity": -6, "credibilite": -1, "reputation": -1, "standing": -4 },
    ...
    { "label": { "fr": "Rentrer chez vous et y passer cinq ans", "en": "Go home and spend five years there" },
      "effects": { "popularity": 6, "reseau": 1, "energie": 2, "standing": -6, "notoriete": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Dire que votre article méritait un vote", "en": "Say your article deserved a vote" },
      "effects": { "credibilite": 1, "reputation": 1, "popularity": 5, "standing": -6, "approval": -3 },
    ...
    { "label": { "fr": "Signer la motion de censure contre votre propre camp", "en": "Sign the censure motion against your own side" },
      "roll": { "base": 18, "stat": "sangfroid", "plus": { "popularity": 0.06 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 10, "notoriete": 2, "credibilite": 1, "standing": -14, "approval": -8, "reputation": 1, "appeal": { "self": -8 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre la rocade et voter le budget", "en": "Take the bypass and vote for the budget" },
      "effects": { "popularity": 8, "reseau": 1, "standing": 4, "credibilite": -1, "reputation": -1 },
    ...
    { "label": { "fr": "Voter le budget sans rien demander", "en": "Vote for the budget and ask for nothing" },
      "effects": { "reputation": 2, "credibilite": 1, "standing": 2, "popularity": -3 },
    ...
    { "label": { "fr": "Prendre la rocade et voter contre", "en": "Take the bypass and vote against" },
      "roll": { "base": 18, "stat": "sangfroid", "plus": { "reseau": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 6, "standing": -6, "reseau": 1, "reputation": -1 },
      ...
      "failure": { "effects": { "standing": -13, "popularity": -5, "reputation": -2, "strike": "traitre" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Recevoir tout le monde et n'engager rien", "en": "See everybody and commit to nothing" },
      "effects": { "reseau": 2, "credibilite": 1, "standing": 4, "energie": -2 },
    ...
    { "label": { "fr": "Voir le ministre, et seulement lui", "en": "See the minister, and only him" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "reseau": 0.4, "credibilite": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "standing": 7, "credibilite": 1, "popularity": -3 },
      ...
      "failure": { "effects": { "standing": -7, "popularity": -4, "reputation": -1 },
    ...
    { "label": { "fr": "Tout refuser et le faire savoir au groupe", "en": "Refuse everything and tell the group so" },
      "effects": { "standing": 8, "reputation": 1, "reseau": -1, "credibilite": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller, et travailler la salle", "en": "Go, and work the room" },
      "roll": { "base": 18, "stat": "charisme", "plus": { "reseau": 0.45, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "reseau": 2, "standing": 4, "credibilite": 1, "notoriete": 1,
    ...
    { "label": { "fr": "Dénoncer le dîner publiquement", "en": "Denounce the dinner publicly" },
      "roll": { "base": 17, "stat": "eloquence", "plus": { "credibilite": 0.45, "notoriete": 0.2 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": { "power": -70 }, "popularity": 13, "eloquence": 1, "notoriete": 1, "credibilite": 1,
                                "standing": -11, "reseau": -2, "landscape": { "self": 0.7 } },
      ...
      "failure": { "effects": { "popularity": -5, "standing": -9, "reseau": -2, "credibilite": -1,
                                "reputation": -1, "energie": -1 },
      ...
      "debacle": { "effects": { "popularity": -8, "standing": -12, "reseau": -3, "credibilite": -2,
    ...
    { "label": { "fr": "Décliner poliment, sans le dire à personne", "en": "Decline politely, and tell nobody" },
      "effects": { "reputation": 1, "energie": 1, "standing": -2, "reseau": -1 },
    ...
    { "label": { "fr": "Y aller, et demander à table qui paie", "en": "Go, and ask at the table who is paying" },
      "roll": { "base": 17, "stat": "sangfroid", "plus": { "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "reputation": 1, "credibilite": 1, "popularity": 5, "notoriete": 1,
                                "standing": -5, "reseau": -2 },
      ...
      "failure": { "effects": { "reseau": -2, "standing": -4, "reputation": -1, "credibilite": -1,
    ...
    { "label": { "fr": "Y aller, et faire sortir la carte du menu trois semaines plus tard", "en": "Go, and get the menu card out three weeks later" },
      ...
      "effects": { "axis": { "power": -55 }, "popularity": 9, "notoriete": 2, "credibilite": 1,
                   "standing": -8, "reseau": -2, "reputation": -1 },

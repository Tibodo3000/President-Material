...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Vous y remettre le matin, sérieusement", "en": "Start training again, properly, in the mornings" },
      "roll": { "base": 15, "stat": "energie", "plus": { "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2 }, { "when": { "trait": ["athletique"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 }, { "when": { "trait": ["epuise"] }, "value": -2 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Publier celui qui dit la vérité", "en": "Publish the one that tells the truth" },
      "roll": { "base": 15, "stat": "reputation", "plus": { "sangfroid": 0.35 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["casserole"] }, "value": -2 }, { "when": { "trait": ["repris_de_justice"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": { "popularity": 9, "flags": { "carefulHealth": true, "frailHealth": true },
                                "standing": -7, "credibilite": 1, "reputation": 1 },
    ...
    { "label": { "fr": "Publier celui qui parle de contrôle de routine", "en": "Publish the routine-check one" },
      ...
      "failure": { "effects": { "popularity": -9, "standing": -9, "credibilite": -1,
    ...
    { "label": { "fr": "Ne rien publier du tout", "en": "Publish nothing at all" },
      ...
      "success": { "effects": { "energie": 1, "sangfroid": 1, "standing": 2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "En rire tout de suite, à l'antenne", "en": "Laugh it off immediately, on air" },
      ...
      "failure": { "effects": { "popularity": -8, "standing": -6, "notoriete": 1, "credibilite": -1 },
    ...
    { "label": { "fr": "Ne plus faire de direct", "en": "Stop doing live interviews" },
      ...
      "success": { "effects": { "energie": 2, "standing": -5, "notoriete": -1, "popularity": -2 },
      ...
      "failure": { "effects": { "popularity": -7, "standing": -8, "notoriete": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout remettre, et le dire devant tout le monde", "en": "Put it all back, and say so in front of everyone" },
      "roll": { "base": 16, "stat": "energie", "plus": { "sangfroid": 0.35 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2 }, { "when": { "trait": ["athletique"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 }, { "when": { "trait": ["epuise"] }, "value": -2 } ], "dice": 16 },
    ...
    { "label": { "fr": "Accepter, et le mettre au compte de la stratégie", "en": "Accept it, and call it strategy" },
      ...
      "failure": { "effects": { "energie": 3, "standing": -9, "popularity": -5, "notoriete": -1 },
    ...
    { "label": { "fr": "Remercier celui qui a annulé", "en": "Sack the person who cancelled" },
      ...
      "failure": { "effects": { "standing": -14, "reseau": -1, "popularity": -6, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Annoncer votre retrait vous-même", "en": "Announce your own withdrawal" },
      "roll": { "base": 12, "stat": "reputation", "plus": { "standing": 0.04 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["casserole"] }, "value": -2 }, { "when": { "trait": ["repris_de_justice"] }, "value": -2 } ], "dice": 16 },
    ...
    { "label": { "fr": "Tenir jusqu'à la prochaine échéance", "en": "Hold on until the next contest" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "energie": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "energie": -2, "standing": 6, "popularity": 5, "credibilite": 1,
    ...
    { "label": { "fr": "Ne rien dire à personne, même chez vous", "en": "Tell nobody, not even at home" },
      ...
      "success": { "effects": { "standing": 9, "sangfroid": 1, "energie": -1, "popularity": 2,
                                "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Désigner {le} vous-même et partir", "en": "Name {him} yourself and go" },
      "roll": { "base": 13, "stat": "reseau", "plus": { "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "end": "retire" },
    ...
    { "label": { "fr": "Casser les trois déjeuners", "en": "Break up the three lunches" },
      "roll": { "base": 17, "stat": "reseau", "plus": { "sangfroid": 0.35, "standing": 0.05 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 11, "energie": -3, "reseau": 1, "credibilite": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Répondre oui, et détailler", "en": "Answer yes, and give the detail" },
      "roll": { "base": 16, "stat": "credibilite", "plus": { "energie": 0.35 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "popularity": 8, "standing": 6, "credibilite": 1, "energie": -2 },
      ...
      "failure": { "effects": { "popularity": -10, "standing": -8, "credibilite": -1,
                                "flags": { "frailHealth": true } },
    ...
    { "label": { "fr": "Répondre que non, et annoncer la suite", "en": "Answer no, and announce what follows" },
      "roll": { "base": 12, "stat": "reputation", "plus": { "popularity": 0.05 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["casserole"] }, "value": -2 }, { "when": { "trait": ["repris_de_justice"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": { "end": "retire" },
    ...
    { "label": { "fr": "Retourner la question contre elle", "en": "Turn the question back on her" },
      ...
      "success": { "effects": { "popularity": 6, "eloquence": 1, "notoriete": 1, "standing": 4, "reputation": -1 },
      ...
      "failure": { "effects": { "popularity": -9, "standing": -5, "reputation": -1, "notoriete": 1 },

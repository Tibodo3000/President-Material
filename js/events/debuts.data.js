...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Structurer le collectif", "en": "Organise the group properly" },
      ...
      "effects": { "reseau": 1, "energie": -1, "popularity": 9, "standing": 6 },
    ...
    { "label": { "fr": "Attaquer la fermeture en justice", "en": "Challenge the closure in court" },
      "when": { "background": ["law"] },
      "roll": { "base": 13, "stat": "eloquence", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": {"economy": -55, "power": -35}, "eloquence": 1, "notoriete": 1, "reputation": 1, "popularity": 14 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Y aller seul, sans tract", "en": "Go alone, without leaflets" },
      ...
      "roll": { "base": 13, "stat": "charisme", "plus": { "energie": 0.4 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Traiter les dossiers administratifs vous-même", "en": "Handle the paperwork yourself" },
      ...
      "effects": { "reputation": 1, "energie": -1, "popularity": 12, "standing": 3 },
    ...
    { "label": { "fr": "Filmer et diffuser les permanences", "en": "Film the surgeries and post them" },
      ...
      "roll": { "base": 13, "stat": "notoriete", "plus": { "charisme": 0.4 }, "bonus": [ { "when": { "trait": ["bete_scene"] }, "value": 2 }, { "when": { "trait": ["couple_people"] }, "value": 1.5 }, { "when": { "trait": ["has_been"] }, "value": -2 }, { "when": { "trait": ["albinos"] }, "value": 1 } ], "dice": 16 },
      "success": { "effects": { "notoriete": 1, "popularity": 10 },
      ...
      "failure": { "effects": { "reputation": -1, "popularity": -6 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Recouvrir les leurs", "en": "Cover theirs" },
      "roll": { "base": 13, "stat": "sangfroid",
                "plus": { "energie": 0.3, "reseau": 0.2 },
                "bonus": [ { "when": { "personality": ["provocative"] }, "value": 2 },
                           { "when": { "background": ["activism"] }, "value": 1.5 },
                           { "when": { "trait": ["lache"] }, "value": -2 } ],
                "dice": 16 },
      "success": { "effects": { "energie": -1, "standing": 9, "reputation": -1, "popularity": -2,
                                "reseau": 1 },
        "result": { "fr": "Deux cents affiches recouvertes en une heure quarante, sans un mot. La fédération l'apprend par la fédération d'en face, ce qui vaut mieux qu'un communiqué.",
                    "en": "Two hundred posters pasted over in an hour and forty minutes, without a word. Your federation hears about it from the other one, which is better than a press release." } },
      "failure": { "effects": { "energie": -2, "standing": -6, "reputation": -1, "popularity": -5 },
        "result": { "fr": "Une caméra de commerçant, une plainte pour dégradation, et une photo de vous avec un seau. L'affaire s'arrête là et la photo, non.",
                    "en": "A shopkeeper's camera, a complaint for criminal damage, and a photograph of you holding a bucket. The case goes no further; the photograph does." } } },
    ...
    { "label": { "fr": "Coller les deux côtés de la rue et laisser les leurs", "en": "Do both sides of the street and leave theirs alone" },
      "when": { "background": ["activism"] },
      "effects": { "reseau": 1, "reputation": 1, "energie": -2, "standing": 1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Expliquer à votre supérieur que vous ne lâcherez ni l'un ni l'autre", "en": "Tell your manager you will drop neither" },
      ...
      "effects": { "energie": -3, "standing": 4, "reputation": 1, "credibilite": 1, "sangfroid": 1 },
    ...
    { "label": { "fr": "Démissionner sans y penser deux fois", "en": "Resign without thinking twice" },
      ...
      "effects": { "energie": 2, "standing": 8, "reseau": 1, "money": -22000, "reputation": -1,
                   "popularity": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Lui apprendre le tableur, un samedi sur deux", "en": "Teach him spreadsheets, every other Saturday" },
      "when": { "background": ["activism"] },
      "effects": { "reseau": 1, "reputation": 2, "energie": -2, "standing": 2 },
    ...
    { "label": { "fr": "Le signaler à la fédération", "en": "Report it to the federation" },
      "roll": { "base": 14, "stat": "credibilite",
                "plus": { "reputation": 0.35, "standing": 0.04 },
                "bonus": [ { "when": { "background": ["law", "civil"] }, "value": 2 },
                           { "when": { "personality": ["principled"] }, "value": 2 },
                           { "when": { "trait": ["intouchable"] }, "value": 1.5 } ],
                "dice": 16 },
      "success": { "effects": { "reputation": 2, "credibilite": 2, "standing": -4, "reseau": -1 },
        "result": { "fr": "La fédération reprend les comptes, sans bruit et sans lui, et personne ne saura d'où c'est parti. Il continue de coller. Il ne vous parle plus.",
                    "en": "The federation takes the accounts over, quietly and without him, and nobody will know where it started. He goes on flyposting. He no longer speaks to you." } },
      "failure": { "effects": { "reputation": 1, "standing": -12, "reseau": -2, "energie": -1 },
        "result": { "fr": "La fédération classe le dossier en trois semaines et la section apprend le nom de celui qui a écrit. Mille deux cents euros, trois ans, et vous êtes désormais celui qui a fait ça.",
                    "en": "The federation shelves it within three weeks and the branch learns the name of whoever wrote in. Twelve hundred euros, three years, and you are now the person who did that." } } }
  ]
},

{
  ...
  "choices": [
    { "label": { "fr": "Préparer le point douze mieux que quiconque", "en": "Prepare item twelve better than anyone" },
      "effects": { "eloquence": 1, "reputation": 1, "standing": 4, "energie": -1 },
    ...
    { "label": { "fr": "Faire une sortie sur un tout autre sujet", "en": "Make a scene about something else entirely" },
      "roll": { "base": 14, "stat": "eloquence", "plus": { "charisme": 0.3, "notoriete": 0.2 }, "bonus": [ { "when": { "personality": ["provocative"] }, "value": 2 }, { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "background": ["activism", "journalism"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"eloquence": 1, "notoriete": 1, "popularity": 8, "standing": -6, "reputation": -1, "landscape": {"self": 0.5}},
      ...
      "failure": { "effects": {"notoriete": 1, "popularity": -4, "standing": -8, "reputation": -1, "credibilite": -1},
        "result": { "fr": "Vous parlez douze minutes de tout sauf de la voirie, et le président de séance vous coupe le micro à la neuvième. La vidéo existe, elle dure quarante secondes, et on n'y voit qu'un homme qu'on fait taire dans une salle vide.",
                    "en": "You speak for twelve minutes about everything except the roads, and the chair cuts your microphone at the ninth. The video exists, it lasts forty seconds, and all it shows is a man being silenced in an empty room." } } },
    { "label": { "fr": "Voter avec la majorité sur ce point-là", "en": "Vote with the majority on this one" },
      "effects": { "reseau": 1, "standing": 3, "popularity": -3, "landscape": { "self": -0.6 } },
    ...
    { "label": { "fr": "Déposer un vœu recevable sur la forme", "en": "Table a motion they cannot rule out of order" },
      "when": { "background": ["civil", "law"] },
      "effects": { "credibilite": 2, "reputation": 1, "standing": 2, "popularity": 1, "energie": -1 },
    ...
    { "label": { "fr": "Rester les six heures et parler sur les vingt-huit points", "en": "Stay all six hours and speak on all twenty-eight items" },
      ...
      "effects": { "energie": -3, "credibilite": 2, "reputation": 1, "standing": 5, "popularity": 2,
                   "eloquence": 1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Les mettre à contribution", "en": "Put them to work" },
      "roll": { "base": 13, "stat": "charisme", "plus": { "reseau": 0.3, "eloquence": 0.25 }, "bonus": [ { "when": { "personality": ["charming"] }, "value": 2 }, { "when": { "origin": ["dynasty"] }, "value": 2 }, { "when": { "personality": ["principled"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": {"reseau": 2, "energie": -1, "reputation": -1, "standing": 5},
      ...
      "failure": { "effects": {"reseau": -1, "standing": -3, "energie": -2, "reputation": -1},
        "result": { "fr": "Deux d'entre eux viennent au premier collage et à aucun autre. Le troisième vous demande, sérieusement, si c'est payé. Vous ne rouvrirez plus le sujet à table.",
                    "en": "Two of them come to the first flyposting session and to none after. The third asks you, seriously, whether it pays. You will not raise the subject at the table again." } } },
    { "label": { "fr": "Rappeler que personne à cette table n'a jamais fait autre chose", "en": "Point out that nobody at this table has ever done anything else" },
      "when": { "origin": ["dynasty"] },
      "effects": { "standing": 4, "reseau": 1, "energie": 1, "reputation": -1 },
    ...
    { "label": { "fr": "Leur dire combien ça paie", "en": "Tell them what it pays" },
      "when": { "origin": ["modest", "middle"] },
      "effects": { "reputation": 1, "credibilite": 1, "popularity": 2, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre le poste et le faire vivre", "en": "Take the post and make it live" },
      "roll": { "base": 13, "stat": "energie", "plus": { "reseau": 0.35, "charisme": 0.25 }, "bonus": [ { "when": { "personality": ["hardworking"] }, "value": 2 }, { "when": { "background": ["activism"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"reseau": 2, "energie": -2, "standing": 8, "popularity": -1, "landscape": {"self": 0.6}},
      ...
      "failure": { "effects": {"reseau": 1, "standing": -4, "energie": -3, "reputation": -1},
        "result": { "fr": "Deux cents adhérents, trente actifs au départ, onze à la fin de l'année. Vous avez tenu le mouvement à bout de bras pendant dix-huit mois et il s'éteint le jour où vous arrêtez, ce qui prouve qu'il n'existait pas.",
                    "en": "Two hundred members, thirty active at the start, eleven by the end of the year. You carried the movement single-handed for eighteen months and it dies the day you stop, which proves it never existed." } } },
    ...
    { "label": { "fr": "Le prendre, et faire adhérer soixante personnes en trois mois", "en": "Take it, and sign up sixty new members in three months" },
      ...
      "effects": { "standing": 9, "reseau": 1, "energie": -2, "reputation": -1, "strike": "appareil" },
    ...
    { "label": { "fr": "Le prendre et en faire une structure qui vous survivra", "en": "Take it and build something that outlasts you" },
      "when": { "background": ["activism"] },
      "effects": { "reseau": 2, "standing": 4, "credibilite": 1, "reputation": 1, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter, ce n'est qu'une cuisine", "en": "Accept, it is only a kitchen" },
      "roll": { "base": 13, "stat": "sangfroid",
                "plus": { "reseau": 0.3, "credibilite": 0.25 },
                "bonus": [ { "when": { "personality": ["calculating"] }, "value": 2 },
                           { "when": { "trait": ["teflon"] }, "value": 2 },
                           { "when": { "position": ["maire"] }, "value": -1.5 } ],
                "dice": 16 },
      "success": { "effects": { "money": 14000, "reseau": 1, "flags": { "dirtyMoney": true } },
        "result": { "fr": "La cuisine est posée en quatre jours par une équipe qui ne facture rien à la commune. Il n'y a rien d'écrit, il n'y aura jamais rien d'écrit, et vous lui devez quelque chose dont le montant n'est nulle part.",
                    "en": "The kitchen is fitted in four days by a team that bills the council for nothing. There is nothing in writing, there never will be, and you owe him something whose amount appears nowhere." } },
      "failure": { "effects": { "money": 12000, "reseau": 1, "popularity": -6, "reputation": -1,
                                "flags": { "dirtyMoney": true }, "strike": "casserole" },
        "result": { "fr": "Un de ses ouvriers le raconte au bar, et le bar est en face de la permanence de l'opposition. Personne ne porte plainte pour une cuisine, et tout le monde s'en souvient.",
                    "en": "One of his fitters tells the story in the bar, and the bar is opposite the opposition's office. Nobody files a complaint over a kitchen, and everybody remembers it." } } },
    { "label": { "fr": "Refuser et payer le prix normal", "en": "Refuse and pay the going rate" },
      "effects": { "money": -9000, "reputation": 1, "reseau": -1 },
    ...
    { "label": { "fr": "Refuser et cesser de le voir", "en": "Refuse, and stop seeing him" },
      "effects": { "reputation": 2, "reseau": -1, "standing": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et parler", "en": "Go, and speak" },
      "roll": { "base": 12, "stat": "eloquence", "plus": { "reputation": 0.35, "charisme": 0.25 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 2 }, { "when": { "personality": ["charming"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"energie": -1, "standing": 10, "reputation": 2, "landscape": {"self": 0.4}},
      ...
      "failure": { "effects": {"standing": -3, "reputation": -1, "energie": -2},
        "result": { "fr": "Vous parlez six minutes d'un homme que vous avez croisé quatre fois, et cela s'entend dès la deuxième. Sa fille vous remercie poliment à la sortie, et la section n'en reparlera jamais devant vous.",
                    "en": "You speak for six minutes about a man you met four times, and it shows from the second minute. His daughter thanks you politely on the way out, and the branch will never mention it in front of you again." } } },
    ...
    { "label": { "fr": "Y aller, et citer onze prénoms", "en": "Go, and name eleven people" },
      ...
      "effects": { "standing": 11, "reputation": 2, "reseau": 1, "popularity": 1, "energie": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Dire une chose vraie et risquée", "en": "Say one true and risky thing" },
      "roll": { "base": 13, "stat": "eloquence", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "eloquence": 1, "notoriete": 1, "popularity": 8, "standing": -4, "reputation": 1 },
    ...
    { "label": { "fr": "Lui écrire ses réponses telles qu'elle les publiera", "en": "Write her answers the way she will print them" },
      ...
      "effects": { "notoriete": 1, "popularity": 5, "standing": 2, "credibilite": 1, "reputation": -1 },
    ...
    { "label": { "fr": "Lui donner deux heures au lieu de trois questions", "en": "Give her two hours instead of three questions" },
      "when": { "personality": ["charming"] },
      "effects": { "reseau": 1, "notoriete": 1, "popularity": 3, "reputation": 1, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Traiter le dossier de logement jusqu'au bout", "en": "See the housing case through to the end" },
      "roll": { "base": 14, "stat": "credibilite", "plus": { "reseau": 0.3, "energie": 0.25 }, "bonus": [ { "when": { "background": ["civil", "law"] }, "value": 2.5 }, { "when": { "personality": ["hardworking"] }, "value": 2 }, { "when": { "trait": ["appareil"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"energie": -2, "popularity": 8, "reseau": 1, "standing": -1, "reputation": 2},
      ...
      "failure": { "effects": {"popularity": -3, "energie": -3, "credibilite": -1, "reputation": 1},
        "result": { "fr": "Onze mois, quatorze courriers et deux recours. Le dossier relève de l'État, l'État répond qu'il relève du bailleur, le bailleur répond qu'il relève de la commune. Elle a déménagé chez sa fille en septembre.",
                    "en": "Eleven months, fourteen letters and two appeals. The case is the State's, the State says it is the landlord's, the landlord says it is the council's. She moved in with her daughter in September." } } },
    ...
    { "label": { "fr": "Écouter le troisième jusqu'au bout", "en": "Hear the third one out" },
      "effects": { "energie": -1, "popularity": 3, "sangfroid": 1 },
    ...
    { "label": { "fr": "Rester jusqu'à midi et prendre les seize suivants", "en": "Stay until noon and take the next sixteen" },
      ...
      "effects": { "popularity": 7, "reputation": 2, "credibilite": 1, "reseau": 1, "energie": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Publier du contenu de terrain", "en": "Post from the ground" },
      "effects": { "notoriete": 1, "energie": -1, "popularity": 3 },
    ...
    { "label": { "fr": "Chercher le clash", "en": "Go looking for a fight" },
      "roll": { "base": 14, "stat": "notoriete", "plus": { "charisme": 0.3, "eloquence": 0.25 }, "bonus": [ { "when": { "personality": ["provocative"] }, "value": 2.5 }, { "when": { "background": ["celebrity", "comms"] }, "value": 2 }, { "when": { "personality": ["principled"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"notoriete": 3, "popularity": 6, "reputation": -2, "standing": -5, "strike": "radical", "landscape": {"self": 0.7}},
      ...
      "failure": { "effects": {"notoriete": 1, "popularity": -7, "reputation": -2, "standing": -6, "credibilite": -1},
        "result": { "fr": "La phrase part un vendredi à vingt-trois heures et elle est reprise par des comptes qui ne vous veulent aucun bien. Vous la supprimez le samedi, ce qui la rend définitive.",
                    "en": "The line goes out on a Friday at eleven at night and is picked up by accounts that wish you no good at all. You delete it on the Saturday, which makes it permanent." } } },
    ...
    { "label": { "fr": "Reprendre ce que vous faisiez avant, en moins drôle", "en": "Go back to what you did before, only less funny" },
      "when": { "background": ["celebrity", "comms"] },
      "effects": { "notoriete": 2, "popularity": 4, "credibilite": 1, "standing": -2, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et prendre le mégaphone", "en": "Go, and take the megaphone" },
      "roll": { "base": 13, "stat": "charisme", "plus": { "eloquence": 0.35, "energie": 0.25 }, "bonus": [ { "when": { "background": ["activism"] }, "value": 2.5 }, { "when": { "party": ["radical_left", "socdem"] }, "value": 1.5 }, { "when": { "trait": ["orateur"] }, "value": 2 } ], "dice": 16 },
      "success": { "effects": {"axis": {"economy": -70}, "charisme": 1, "notoriete": 1, "popularity": 10, "energie": -1, "standing": -3, "landscape": {"self": 0.6}},
      ...
      "failure": { "effects": {"popularity": -5, "notoriete": 1, "energie": -2, "standing": -5, "credibilite": -1},
        "result": { "fr": "Le mégaphone passe de main en main et vous l'avez pris à votre tour, après un délégué syndical qui parlait mieux que vous parce que c'est son usine. Trois cents personnes l'ont remarqué, et l'une d'elles filmait.",
                    "en": "The megaphone goes from hand to hand and you took your turn with it, after a union rep who spoke better than you because it is his plant. Three hundred people noticed, and one of them was filming." } } },
    { "label": { "fr": "Y aller sans prendre la parole", "en": "Go, without speaking" },
      "effects": { "popularity": 3, "reputation": 1, "energie": -1 },
    ...
    { "label": { "fr": "Recevoir la direction de l'usine à la place", "en": "Meet the plant's management instead" },
      "effects": { "reseau": 1, "standing": 4, "popularity": -5, "sangfroid": 1,
                   "landscape": { "self": -0.5 } },
    ...
    { "label": { "fr": "Y aller avec les comptes du repreneur", "en": "Turn up with the buyer's accounts" },
      ...
      "effects": { "credibilite": 2, "reputation": 1, "popularity": 6, "reseau": 1, "standing": 1,
                   "energie": -1 },

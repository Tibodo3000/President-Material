...

{
  ...
  "choices": [
    { "label": { "fr": "Recouvrir les leurs", "en": "Cover theirs" },
      ...
      "failure": { "effects": { "energie": -2, "standing": -6, "reputation": -2, "popularity": -5 },
  ...
  "choices": [
    ...
    { "label": { "fr": "Le signaler à la fédération", "en": "Report it to the federation" },
      "roll": { "base": 14, "stat": "credibilite",
                ...
                "dice": 16 },
      "success": { "effects": { "reputation": 3, "credibilite": 3, "standing": -4, "reseau": -2 },
      ...
      "failure": { "effects": { "reputation": 1, "standing": -12, "reseau": -3, "energie": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire une sortie sur un tout autre sujet", "en": "Make a scene about something else entirely" },
      ...
      "success": { "effects": {"notoriete": 3, "popularity": 8, "standing": -6, "reputation": -1, "landscape": {"self": 0.5}},
      ...
      "failure": { "effects": {"notoriete": 1, "popularity": -4, "standing": -8, "reputation": -2, "credibilite": -2},
    ...
    { "label": { "fr": "Voter avec la majorité sur ce point-là", "en": "Vote with the majority on this one" },
      "effects": { "reseau": 2, "standing": 3, "popularity": -3, "landscape": { "self": -0.6 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Les mettre à contribution", "en": "Put them to work" },
      ...
      "success": { "effects": {"reseau": 3, "energie": -1, "reputation": -1, "standing": 5},
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre le poste et le faire vivre", "en": "Take the post and make it live" },
      ...
      "success": { "effects": {"reseau": 4, "energie": -2, "standing": 8, "popularity": -1, "landscape": {"self": 0.6}},
  ...
  "choices": [
    { "label": { "fr": "Accepter, ce n'est qu'une cuisine", "en": "Accept, it is only a kitchen" },
      "roll": { "base": 13, "stat": "sangfroid",
                ...
                "dice": 16 },
      "success": { "effects": { "money": 14000, "reseau": 2, "flags": { "dirtyMoney": true } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et parler", "en": "Go, and speak" },
      ...
      "success": { "effects": {"energie": -1, "standing": 10, "reputation": 3, "landscape": {"self": 0.4}},
...

{
  ...
  "choices": [
    { "label": { "fr": "Traiter le dossier de logement jusqu'au bout", "en": "See the housing case through to the end" },
      ...
      "success": { "effects": {"energie": -2, "popularity": 8, "reseau": 1, "standing": -1, "reputation": 3},
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Chercher le clash", "en": "Go looking for a fight" },
      ...
      "success": { "effects": {"notoriete": 5, "popularity": 6, "reputation": -3, "standing": -5, "strike": "radical", "landscape": {"self": 0.7}},
      ...
      "failure": { "effects": {"notoriete": 2, "popularity": -7, "reputation": -3, "standing": -6, "credibilite": -2},
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et prendre le mégaphone", "en": "Go, and take the megaphone" },
      ...
      "success": { "effects": {"axis": {"economy": -70}, "notoriete": 3, "popularity": 10, "energie": -1, "standing": -3, "landscape": {"self": 0.6}},
      ...
      "failure": { "effects": {"popularity": -5, "notoriete": 1, "energie": -2, "standing": -5, "credibilite": -2},

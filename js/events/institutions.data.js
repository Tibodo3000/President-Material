...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter sans condition", "en": "Accept, no conditions" },
      "effects": { "office": "premier", "notoriete": 2, "credibilite": 2, "standing": 6, "energie": -2, "popularity": 4 },
    ...
    { "label": { "fr": "Négocier trois ministères pour vos fidèles", "en": "Negotiate three ministries for your own people" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "standing": 0.05 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "office": "premier", "notoriete": 2, "credibilite": 2, "reseau": 1, "standing": 10, "energie": -2 },
      ...
      "failure": { "effects": { "office": "premier", "credibilite": 1, "notoriete": 2, "standing": -4, "energie": -2, "reputation": -1 },
    ...
    { "label": { "fr": "Refuser : le fusible, ce sera un autre", "en": "Refuse: let somebody else be the fuse" },
      "effects": { "credibilite": -1, "standing": -10, "sangfroid": 1, "reputation": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter et prévenir votre parti après", "en": "Accept, and tell your party afterwards" },
      "effects": { "office": "premier", "notoriete": 2, "credibilite": 2, "popularity": 6, "standing": -16, "reputation": -1, "appeal": { "self": -10, "ruling": 6 }, "strike": "traitre" },
    ...
    { "label": { "fr": "Exiger l'accord du parti avant de dire oui", "en": "Demand your party's blessing first" },
      "roll": { "base": 17, "stat": "eloquence", "plus": { "standing": 0.06, "reseau": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "office": "premier", "eloquence": 1, "notoriete": 1, "credibilite": 2, "standing": 4, "popularity": 4, "energie": -2 },
    ...
    { "label": { "fr": "Refuser et rendre la proposition publique", "en": "Refuse, and make the offer public" },
      "effects": { "notoriete": 1, "credibilite": 1, "popularity": 9, "standing": 8, "reputation": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Passer en force", "en": "Force it through" },
      "effects": { "credibilite": 1, "standing": 6, "popularity": -12, "notoriete": 1, "reputation": -1, "chain": "matignon_censure" },
    ...
    { "label": { "fr": "Retirer le texte", "en": "Withdraw the bill" },
      "effects": { "credibilite": -2, "standing": -8, "popularity": 5, "reputation": 1 },
    ...
    { "label": { "fr": "Aller chercher les voix une par une", "en": "Go and find the votes one by one" },
      "roll": { "base": 17, "stat": "reseau", "plus": { "eloquence": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "standing": 4, "popularity": 6, "energie": -3, "reseau": 1 },
      ...
      "failure": { "effects": { "credibilite": -2, "standing": -10, "popularity": -6, "energie": -3, "chain": "matignon_censure" },
    ...
    { "label": { "fr": "Passer les quarante-huit heures dans l'hémicycle, à tenir le texte article par article", "en": "Spend the forty-eight hours in the chamber, holding the text article by article" },
      ...
      "roll": { "base": 16, "stat": "energie", "plus": { "eloquence": 0.4, "credibilite": 0.3 }, "bonus": [ { "when": { "trait": ["robuste"] }, "value": 2 }, { "when": { "trait": ["athletique"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 }, { "when": { "trait": ["epuise"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "standing": 5, "popularity": 7, "reputation": 1,
      ...
      "failure": { "effects": { "credibilite": -1, "standing": -8, "popularity": -7, "energie": -5,
...

{
  ...
  "choices": [
    { "label": { "fr": "Les recevoir un par un à Matignon", "en": "See them one by one" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "standing": 0.05, "charisme": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "standing": 11, "reseau": 2, "energie": -3,
                                "reputation": -1 },
      ...
      "failure": { "effects": { "credibilite": -2, "energie": -3, "popularity": -8, "standing": -12, "office": "none", "trait": "ancien_premier" },
    ...
    { "label": { "fr": "Poser la question de confiance vous-même", "en": "Call the confidence vote yourself" },
      "roll": { "base": 18, "stat": "sangfroid", "plus": { "eloquence": 0.45 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 3, "notoriete": 1, "standing": 6, "popularity": 7,
      ...
      "failure": { "effects": { "credibilite": -2, "popularity": -6, "standing": -14, "office": "none", "trait": "ancien_premier" },
    ...
    { "label": { "fr": "Laisser le président arbitrer", "en": "Let the president handle it" },
      "effects": { "credibilite": -1, "standing": -6, "popularity": -4, "reputation": -1,
...

{
  ...
  "choices": [
    { "label": { "fr": "Encaisser sans rien dire", "en": "Take it without a word" },
      "effects": { "credibilite": -1, "popularity": -5, "standing": 7, "sangfroid": 1,
    ...
    { "label": { "fr": "Répondre publiquement au président", "en": "Answer the president in public" },
      ...
      "success": { "effects": { "credibilite": 2, "notoriete": 1, "popularity": 11, "standing": -6, "strike": "intrepide" },
      ...
      "failure": { "effects": { "credibilite": -1, "popularity": -7, "standing": -10, "office": "none", "trait": "ancien_premier" },
    ...
    { "label": { "fr": "Démissionner en choisissant le moment", "en": "Resign, on your own timing" },
      "effects": { "office": "none", "trait": "ancien_premier", "credibilite": 1, "popularity": 8, "reputation": 1, "standing": -4, "notoriete": 1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Repartir et faire taire la rumeur par un coup d'éclat", "en": "Run again and kill the rumour with a stunt" },
      ...
      "success": { "effects": { "notoriete": 1, "popularity": 9, "standing": 3, "energie": -2,
                                "landscape": { "self": 0.8 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Accepter en échange d'une place au bureau politique", "en": "Accept in exchange for a seat on the executive" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "standing": 0.06, "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Apprendre le métier pour de bon", "en": "Learn the job properly" },
      "effects": { "eloquence": 1, "sangfroid": 1, "reputation": 1, "energie": -2, "popularity": -2, "standing": 3 },
    ...
    { "label": { "fr": "Faire du Parlement une tribune nationale", "en": "Use the Parliament as a national platform" },
      "roll": { "base": 14, "stat": "notoriete", "plus": { "eloquence": 0.5 }, "bonus": [ { "when": { "trait": ["bete_scene"] }, "value": 2 }, { "when": { "trait": ["couple_people"] }, "value": 1.5 }, { "when": { "trait": ["has_been"] }, "value": -2 }, { "when": { "trait": ["albinos"] }, "value": 1 } ], "dice": 16 },
      "success": { "effects": { "axis": {"world": 60}, "notoriete": 1, "popularity": 7, "reputation": -1, "landscape": { "self": 0.8 } },
    ...
    { "label": { "fr": "Lire les amendements en entier, tous, avant chaque session", "en": "Read every amendment in full, all of them, before every session" },
      "when": { "personality": ["hardworking"] },
      "effects": { "credibilite": 2, "reputation": 1, "reseau": 1, "eloquence": 1, "energie": -4,
...

{
  ...
  "choices": [
    { "label": { "fr": "Le déposer tel quel", "en": "Table it as written" },
      "effects": { "money": 60000, "reseau": 1, "reputation": -1, "flags": { "dirtyMoney": true } },
    ...
    { "label": { "fr": "Le réécrire dans l'intérêt général", "en": "Rewrite it in the public interest" },
      ...
      "success": { "effects": { "reputation": 2, "eloquence": 1, "standing": -3, "popularity": 4 },
    ...
    { "label": { "fr": "Le rendre public", "en": "Make it public" },
      "effects": { "notoriete": 1, "popularity": 9, "reputation": 1, "standing": -8, "reseau": -1, "chain": "position_impopulaire" },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Répondre par votre bilan européen", "en": "Answer with your European record" },
      ...
      "success": { "effects": { "reputation": 1, "popularity": 3, "notoriete": 1 },
    ...
    { "label": { "fr": "Publier votre agenda complet, heure par heure, depuis l'élection", "en": "Publish your full diary, hour by hour, since the election" },
      ...
      "effects": { "credibilite": 2, "reputation": 1, "popularity": 5, "notoriete": 1, "energie": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Suivre le groupe européen", "en": "Follow the European group" },
      "roll": { "base": 15, "stat": "credibilite", "plus": { "reseau": 0.35, "eloquence": 0.25 }, "bonus": [ { "when": { "trait": ["anglais_parfait"] }, "value": 2 }, { "when": { "background": ["civil", "academia"] }, "value": 1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"axis": {"world": -70}, "reseau": 2, "reputation": 2, "standing": -5, "eloquence": 1, "popularity": 2, "credibilite": 1},
      ...
      "failure": { "effects": {"reseau": -1, "standing": -9, "credibilite": -1, "popularity": -2},
        "result": { "fr": "Le groupe vote une ligne que votre parti a combattue à l'Assemblée le mois précédent, et le rapprochement est fait en France avant la fin du vote. Vous étiez à Strasbourg, ce qui n'excuse rien et explique tout.",
                    "en": "The group votes a line your party fought in the National Assembly the month before, and the connection is made back home before the vote has finished. You were in Strasbourg, which excuses nothing and explains everything." } } },
    ...
    { "label": { "fr": "Faire du vote une affaire nationale", "en": "Turn the vote into a national story" },
      ...
      "effects": { "axis": {"world": 70}, "notoriete": 1, "popularity": 8, "standing": -10, "landscape": { "self": 1.2 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre le grand ministère", "en": "Take the big department" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "credibilite": 0.35, "standing": 0.05 }, "bonus": [ { "when": { "background": ["civil", "law"] }, "value": 2 }, { "when": { "personality": ["hardworking"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"credibilite": 2, "office": "ministre", "notoriete": 3, "standing": 10, "energie": -2, "popularity": 12},
      ...
      "failure": { "effects": {"office": "ministre", "notoriete": 1, "popularity": -8, "credibilite": -2, "energie": -3, "standing": -4},
        "result": { "fr": "Le portefeuille est immense et le cabinet compte onze personnes, dont sept étaient là avant vous et connaissent les dossiers mieux que vous ne les connaîtrez jamais. Le premier arbitrage se joue en février, sans vous, dans un bureau de l'Élysée.",
                    "en": "The brief is vast and the private office has eleven people in it, seven of whom were there before you and know the files better than you ever will. The first real decision is taken in February, without you, in an office at the palace." } } },
    { "label": { "fr": "Prendre le portefeuille technique", "en": "Take the technical brief" },
      "effects": { "credibilite": +2, "office": "ministre", "reputation": 1, "sangfroid": 1, "standing": 4,
                   "notoriete": -1, "popularity": -2 },
    ...
    { "label": { "fr": "Refuser pour rester libre", "en": "Refuse, and stay free" },
      "effects": { "standing": -12, "popularity": 2, "reputation": 1, "sangfroid": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Défendre chaque ligne", "en": "Defend every line" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "eloquence": 0.5, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "credibilite": +2, "standing": 6, "reputation": 1, "energie": -2 },
      ...
      "failure": { "effects": { "credibilite": -1, "standing": -6, "energie": -2, "popularity": -4 },
    ...
    { "label": { "fr": "Céder et négocier autre chose en échange", "en": "Give way and trade it for something else" },
      "effects": { "reseau": 1, "standing": 6, "reputation": -1, "popularity": -3 },
    ...
    { "label": { "fr": "Faire fuiter les coupes dans la presse", "en": "Leak the cuts to the press" },
      "effects": { "credibilite": -1, "notoriete": 1, "popularity": 7, "standing": -12, "reputation": -1, "appeal": { "self": -6 },
    ...
    { "label": { "fr": "Menacer de démissionner sur-le-champ", "en": "Threaten to resign on the spot" },
      ...
      "roll": { "base": 17, "stat": "sangfroid", "plus": { "popularity": 0.06, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "credibilite": -1, "office": "none", "standing": -10, "popularity": 3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "La défendre point par point", "en": "Defend it point by point" },
      "effects": { "standing": 6, "reputation": -1, "popularity": -5, "eloquence": 1 },
    ...
    { "label": { "fr": "Prendre vos distances en direct", "en": "Distance yourself on air" },
      "effects": { "popularity": 8, "reputation": 1, "standing": -14, "notoriete": 1, "appeal": { "self": -7 }, "chain": "position_impopulaire" },
    ...
    { "label": { "fr": "La défendre en la vidant de son contenu", "en": "Defend it while emptying it out" },
      ...
      "roll": { "base": 16, "stat": "eloquence", "plus": { "sangfroid": 0.5 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Saisir la justice vous-même", "en": "Refer it to the prosecutors yourself" },
      "effects": { "reputation": 2, "popularity": 5, "standing": -8, "energie": -1, "chain": "position_impopulaire" },
    ...
    { "label": { "fr": "Couvrir le service et gagner du temps", "en": "Cover the department and buy time" },
      ...
      "failure": { "effects": { "popularity": -10, "reputation": -1, "flags": { "dirtyMoney": true }, "chain": "enquete_ouverte" },
    ...
    { "label": { "fr": "Sacrifier votre directeur de cabinet", "en": "Sacrifice your chief of staff" },
      "effects": { "standing": 4, "reseau": -1, "popularity": 2, "reputation": -1, "sangfroid": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire campagne dans les couloirs pour rester", "en": "Campaign in the corridors to stay" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "standing": 0.06 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
    ...
    { "label": { "fr": "Demander un ministère plus lourd", "en": "Ask for a heavier portfolio" },
      "roll": { "base": 19, "stat": "sangfroid", "plus": { "standing": 0.07, "popularity": 0.05 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "notoriete": 1, "standing": 9, "popularity": 5, "energie": -2 },
    ...
    { "label": { "fr": "Partir avant d'être remercié", "en": "Leave before you are thanked" },
      "effects": { "office": "none", "reputation": 1, "popularity": 6, "standing": -4, "sangfroid": 1 },
    ...
    { "label": { "fr": "Faire passer un mot par quelqu'un qui dîne à l'Élysée", "en": "Get a word passed on by somebody who dines at the palace" },
      ...
      "effects": { "standing": 7, "reseau": 1, "reputation": -1, "energie": 1, "popularity": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Démissionner et dire pourquoi", "en": "Resign and say why" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "credibilite": 0.4, "popularity": 0.04 }, "bonus": [ { "when": { "personality": ["principled"] }, "value": 2 }, { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["orateur"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"office": "none", "popularity": 9, "reputation": 2, "standing": -10, "eloquence": 1, "notoriete": 1, "landscape": {"self": 1.4}},
      ...
      "failure": { "effects": {"popularity": -5, "standing": -8, "credibilite": -1, "reseau": -1},
        "result": { "fr": "La lettre est publiée en entier et personne ne la lit jusqu'au bout. Ce qui reste, c'est un ministre qui part en claquant la porte à onze mois d'un scrutin, et le mot claquant appartient déjà à quelqu'un d'autre.",
                    "en": "The letter is published in full and nobody reads it to the end. What remains is a minister slamming the door eleven months before an election, and the word slamming already belongs to somebody else." } } },
    ...
    { "label": { "fr": "Rester en préparant votre départ", "en": "Stay, and prepare your exit" },
      "when": { "personality": ["calculating"] },
      "effects": { "reseau": 1, "sangfroid": 1, "standing": 4, "reputation": -1, "chain": "demission_preparee" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Partir en publiant tout", "en": "Walk out and publish everything" },
      "effects": { "office": "none", "popularity": 12, "notoriete": 1, "standing": -16, "reputation": 1, "appeal": { "ruling": -8 },
    ...
    { "label": { "fr": "Utiliser le dossier pour monter, pas pour partir", "en": "Use the file to climb, not to leave" },
      "roll": { "base": 18, "stat": "reseau", "plus": { "sangfroid": 0.5, "standing": 0.05 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 13, "reseau": 1, "reputation": -1 },
      ...
      "failure": { "effects": { "office": "none", "standing": -12, "reputation": -1, "strike": "traitre" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Rester, et tant pis pour l'horaire", "en": "Stay, and never mind the schedule" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "charisme": 0.45 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 11, "credibilite": 1, "reputation": 1, "notoriete": 1,
      ...
      "failure": { "effects": { "popularity": -9, "credibilite": -1, "energie": -2, "approval": -3,
                                "standing": -2 },
      ...
      "debacle": { "effects": { "popularity": -12, "credibilite": -2, "energie": -2, "approval": -5,
    ...
    { "label": { "fr": "Annoncer un dispositif d'urgence sur place", "en": "Announce an emergency scheme on the spot" },
      "roll": { "base": 17, "stat": "charisme", "plus": { "standing": 0.05, "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "approval": -5, "credibilite": -2, "standing": -6, "popularity": -4,
                                "energie": -1 },
    ...
    { "label": { "fr": "Faire évacuer", "en": "Have yourself extracted" },
      "effects": { "popularity": -13, "reputation": -1, "standing": 3, "approval": -2, "energie": 1 },
    ...
    { "label": { "fr": "Demander la feuille de paie et la lire à voix haute", "en": "Ask for the payslip and read it out loud" },
      ...
      "effects": { "notoriete": 1, "popularity": 7, "credibilite": 1, "approval": -4, "standing": -5,

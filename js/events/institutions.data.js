...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Suivre le groupe européen", "en": "Follow the European group" },
      ...
      "success": { "effects": {"axis": {"world": -70}, "reseau": 3, "reputation": 3, "standing": -5, "eloquence": 1, "popularity": 2, "credibilite": 2},
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre le grand ministère", "en": "Take the big department" },
      ...
      "success": { "effects": {"credibilite": 3, "office": "ministre", "notoriete": 5, "standing": 10, "energie": -2, "popularity": 12},
      ...
      "failure": { "effects": {"office": "ministre", "notoriete": 2, "popularity": -8, "credibilite": -3, "energie": -3, "standing": -4},
    ...
    { "label": { "fr": "Prendre le portefeuille technique", "en": "Take the technical brief" },
      "effects": { "credibilite": +3, "office": "ministre", "reputation": 2, "sangfroid": 1, "standing": 4,
...

{
  ...
  "choices": [
    { "label": { "fr": "Démissionner et dire pourquoi", "en": "Resign and say why" },
      ...
      "success": { "effects": {"office": "none", "popularity": 9, "reputation": 3, "standing": -10, "notoriete": 2, "landscape": {"self": 1.4}},
      ...
      "failure": { "effects": {"popularity": -5, "standing": -8, "credibilite": -2, "reseau": -2},

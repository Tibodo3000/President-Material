...

{
  ...
  "choices": [
    { "label": { "fr": "Attaquer son bilan, dossier par dossier", "en": "Attack the record, file by file" },
      ...
      "roll": { "base": 14, "stat": "credibilite", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "poll": 7, "credibilite": 1, "popularity": 3, "energie": -2 },
    ...
    { "label": { "fr": "Tenir la hauteur et ne jamais l'interrompre", "en": "Hold the high ground and never interrupt" },
      "roll": { "base": 13, "stat": "sangfroid", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 6, "credibilite": 2, "reputation": 1, "energie": -1 },
    ...
    { "label": { "fr": "Chercher la phrase qui restera", "en": "Go looking for the line that lasts" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "charisme": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 18 },
      "success": { "effects": { "poll": 9, "eloquence": 1, "notoriete": 1, "popularity": 7, "energie": -2 },
    ...
    { "label": { "fr": "Lui demander ce qu'{il} ferait, précisément, le premier lundi", "en": "Ask {him} what {he} would do, precisely, on the first Monday" },
      ...
      "roll": { "base": 14, "stat": "credibilite", "plus": { "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "poll": 7, "credibilite": 1, "popularity": 2, "energie": -2 },
    ...
    { "label": { "fr": "Le contre-interrogatoire : une question, une réponse, la suivante", "en": "Cross-examine: one question, one answer, the next" },
      "when": { "background": ["law"] },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "eloquence": 0.45, "credibilite": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 8, "credibilite": 2, "notoriete": 1, "energie": -2 },
    ...
    { "label": { "fr": "Compter ses interruptions à voix haute", "en": "Count his interruptions out loud" },
      "when": { "trait": ["femme"] },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "charisme": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 8, "popularity": 7, "notoriete": 1, "reputation": 1, "energie": -1 },
    ...
    { "label": { "fr": "{Le} renvoyer à ce que son camp a écrit noir sur blanc", "en": "Send {him} back to what {his} own camp put in writing" },
      "when": { "foeFar": true },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "credibilite": 0.4, "reputation": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "poll": 9, "popularity": 5, "credibilite": 1, "landscape": { "scene": -1.5 }, "energie": -2 },
    ...
    { "label": { "fr": "{Le} pousser à la faute sur ce que vous savez", "en": "Push {him} into a mistake on what you know" },
      ...
      "success": { "effects": { "poll": 8, "notoriete": 1, "reputation": -1, "energie": -2 },
      ...
      "failure": { "effects": { "poll": -7, "reputation": -1, "popularity": -4 },
    ...
    { "label": { "fr": "Ne parler que du pays, et jamais de votre adversaire", "en": "Talk only about the country, never about your opponent" },
      ...
      "effects": { "poll": 3, "credibilite": 1, "reputation": 2, "popularity": 2, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Promettre un grand ministère", "en": "Promise a top ministry" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "charisme": 0.35, "standing": 0.04 }, "bonus": [ { "when": { "personality": ["calculating"] }, "value": 2 }, { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["menteur"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"poll": 3, "standing": -8, "reputation": -1},
      ...
      "failure": { "effects": {"poll": -5, "reputation": -1, "credibilite": -1, "appeal": {"self": -6}},
        "result": { "fr": "La promesse fuite avant le ralliement, avec le nom du ministère et celui de la personne. Ses électeurs y voient un marché, les vôtres aussi, et il n'y a plus rien à rallier.",
                    "en": "The promise leaks before the endorsement, with the name of the ministry and the name of the person. His voters see a deal, so do yours, and there is nothing left to endorse." } } },
    { "label": { "fr": "Ne rien promettre", "en": "Promise nothing" },
      "effects": { "poll": -2, "reputation": 1, "popularity": 3 },
    ...
    { "label": { "fr": "Lui rappeler ce que vous savez sur {lui}", "en": "Remind {him} what you know" },
      ...
      "effects": { "poll": 5, "standing": 4, "reputation": -1, "reseau": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Aller les chercher franchement, et le dire", "en": "Go after them openly, and say so" },
      ...
      "success": { "effects": { "poll": 7, "credibilite": 1, "standing": -8 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Annoncer quelqu'un de l'autre bord", "en": "Name somebody from the other side" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "poll": 7, "credibilite": 1, "notoriete": 1, "standing": -7 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Répondre point par point, tout de suite", "en": "Answer point by point, immediately" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "credibilite": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 3, "credibilite": 1, "reputation": 1, "energie": -2 },
      ...
      "failure": { "effects": { "poll": -6, "reputation": -1, "credibilite": -1, "energie": -2 },
    ...
    { "label": { "fr": "Attaquer ceux qui l'ont sorti", "en": "Go after the people who put it out" },
      ...
      "failure": { "effects": { "poll": -7, "popularity": -5, "credibilite": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Un discours tourné vers ceux qui n'ont pas voté pour vous", "en": "A speech aimed at the people who did not vote for you" },
      "effects": { "poll": 3, "credibilite": 1, "standing": -3, "energie": -2 },
    ...
    { "label": { "fr": "Un discours court, et sortir sous les applaudissements", "en": "A short speech, and leave on the applause" },
      "roll": { "base": 13, "stat": "charisme", "plus": { "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Les plateaux, tous les jours", "en": "The studios, every day" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "energie": 0.3, "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["bete_scene"] }, "value": 2.5 }, { "when": { "trait": ["orateur"] }, "value": 1.5 }, { "when": { "stat": { "energie": { "max": 8 } } }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"poll": 4, "eloquence": 1, "notoriete": 1, "popularity": -1, "energie": -2},
      ...
      "failure": { "effects": {"poll": -4, "energie": -4, "popularity": -4, "credibilite": -1},
        "result": { "fr": "Onze plateaux en quatorze jours, et à partir du huitième vous répétez les mêmes phrases avec moins de conviction. Le montage qui circule met les quatre dernières bout à bout.",
                    "en": "Eleven studios in fourteen days, and from the eighth onwards you repeat the same lines with less conviction. The cut that goes round puts the last four back to back." } } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire peur : dire ce qui arrive si vous perdez", "en": "Frighten them: say what happens if you lose" },
      ...
      "failure": { "effects": { "poll": -5, "popularity": -5, "credibilite": -1 },
    ...
    { "label": { "fr": "Donner une raison de voter pour vous, pas contre {lui}", "en": "Give them a reason to vote for you, not against {him}" },
      ...
      "success": { "effects": { "poll": 7, "credibilite": 1, "reputation": 1, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Annoncer un nom rassurant venu d'ailleurs", "en": "Announce a reassuring name from outside politics" },
      ...
      "success": { "effects": { "poll": 6, "credibilite": 1, "popularity": 5, "standing": -7 },
    ...
    { "label": { "fr": "Promettre Matignon à votre parti", "en": "Promise the premiership to your own party" },
      ...
      "success": { "effects": { "poll": 3, "standing": 13, "reseau": 1, "landscape": { "self": 0.7 },
                                "popularity": -3 },
      ...
      "failure": { "effects": { "poll": -4, "standing": 4, "credibilite": -1, "popularity": -6 },
    ...
    { "label": { "fr": "Ne rien annoncer du tout", "en": "Announce nothing at all" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "eloquence": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "poll": -5, "popularity": -6, "credibilite": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter les soixante", "en": "Accept all sixty" },
      ...
      "failure": { "effects": { "poll": 2, "standing": -14, "reputation": -1,
    ...
    { "label": { "fr": "En offrir quinze et pas une de plus", "en": "Offer fifteen and not one more" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "sangfroid": 0.35, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "poll": 4, "standing": 4, "reseau": 1, "landscape": { "self": -0.3 } },
      ...
      "failure": { "effects": { "poll": -6, "standing": -5, "energie": -2, "appeal": { "scene": -5 } },
    ...
    { "label": { "fr": "Refuser publiquement et raconter la demande", "en": "Refuse publicly, and describe the demand" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "reputation": 0.3 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 5, "popularity": 7, "standing": 8, "credibilite": 1,
                                "landscape": { "self": 0.6 }, "appeal": { "scene": -11 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Remercier chaleureusement", "en": "Thank him warmly" },
      ...
      "failure": { "effects": { "poll": -6, "popularity": -8, "reputation": -1, "credibilite": -1 },
    ...
    { "label": { "fr": "Le refuser publiquement", "en": "Refuse the endorsement publicly" },
      "roll": { "base": 16, "stat": "reputation", "plus": { "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["casserole"] }, "value": -2 }, { "when": { "trait": ["repris_de_justice"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": { "poll": 3, "popularity": 10, "credibilite": 1, "reputation": 1,
                                "standing": -6 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Vous en réclamer sans réserve", "en": "Claim it without reservation" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "popularity": 0.05 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "poll": 6, "appeal": { "self": 8, "others": -2 }, "charisme": 1, "notoriete": 1,
                                "landscape": { "self": 0.7 } },
      ...
      "failure": { "effects": { "poll": -7, "popularity": -8, "credibilite": -1,
                                "appeal": { "others": -4 } },
    ...
    { "label": { "fr": "Saluer le cortège et condamner les casseurs", "en": "Salute the march and condemn the rioters" },
      ...
      "success": { "effects": { "poll": 4, "popularity": 6, "credibilite": 1, "standing": 2 },

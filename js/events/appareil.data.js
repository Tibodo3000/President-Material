...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter son parrainage", "en": "Accept the patronage" },
      ...
      "success": { "effects": {"reseau": 2, "standing": 6, "reputation": -1, "popularity": -8, "chain": "mentor_dette"},
        "result": { "fr": "Les portes s'ouvrent. Vous lui devez quelque chose, désormais.",
                  "en": "Doors open. You owe them something now." } },
      "failure": { "effects": {"reseau": 1, "standing": -3, "reputation": -1, "energie": -1},
    ...
    { "label": { "fr": "Accepter, en comptant bien s'en affranchir", "en": "Accept, fully intending to shake him off later" },
      ...
      "effects": { "reseau": 1, "standing": 12, "sangfroid": 1, "reputation": -1, "popularity": -6, "chain": "mentor_dette" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Payer votre dette", "en": "Pay your debt" },
      "effects": { "standing": 9, "reputation": -1, "popularity": -9, "strike": "appareil", "chain": "mentor_encombrant" },
    ...
    { "label": { "fr": "Refuser et rompre", "en": "Refuse and break with him" },
      "effects": { "landscape": { "self": -1.2 }, "strike": "intrepide", "standing": -11, "reputation": 1, "appeal": { "self": 4 }, "reseau": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Passer pour la photo", "en": "Show up for the photo" },
      "roll": { "base": 13, "stat": "charisme", "plus": { "reseau": 0.35, "notoriete": 0.2 }, "bonus": [ { "when": { "personality": ["charming"] }, "value": 2 }, { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": {"energie": 1, "standing": 5, "reseau": 1, "popularity": -2, "notoriete": 1},
      ...
      "failure": { "effects": {"reseau": -1, "energie": -2, "standing": -2, "popularity": -2},
        "result": { "fr": "Vous restez onze minutes, le temps d'une photo de groupe où l'on vous voit derrière quelqu'un de plus grand. La légende publiée le lendemain cite six noms sur onze, et le vôtre n'en fait pas partie.",
                    "en": "You stay eleven minutes, long enough for a group photograph in which you appear behind somebody taller. The caption published the next day names six of the eleven, and yours is not among them." } } },
    { "label": { "fr": "Payer le bar de la fédération pendant trois jours", "en": "Pick up the bar tab for three days" },
      "when": { "minMoney": 40000 },
      "effects": { "money": -25000, "reseau": 1, "standing": 8, "energie": -1, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "En faire votre protégé", "en": "Make him your protégé" },
      "when": { "stat": { "energie": { "min": 8 } } },
      "effects": { "reseau": 1, "energie": -2, "standing": 6, "chain": "protege_perce" },
    ...
    { "label": { "fr": "L'embaucher comme collaborateur, payé par l'Assemblée", "en": "Hire him as staff, paid by parliament" },
      ...
      "success": { "effects": {"reseau": 2, "energie": 2, "standing": 3, "reputation": -1, "popularity": -4},
...

{
  ...
  "choices": [
    { "label": { "fr": "L'écraser sans pitié", "en": "Crush him without mercy" },
      "roll": { "base": 13, "stat": "reseau", "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 10, "reputation": -1, "notoriete": 1, "popularity": -6, "strike": "traitre" },
    ...
    { "label": { "fr": "Lui laisser sa chance", "en": "Let him have his shot" },
      "effects": { "reputation": 1, "popularity": 4, "standing": -8 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Les affronter en face", "en": "Face them down" },
      "roll": { "base": 14, "stat": "sangfroid", "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "strike": "intrepide", "reseau": -1, "standing": -17 },
    ...
    { "label": { "fr": "Les séduire un par un", "en": "Win them over one by one" },
      ...
      "roll": { "base": 14, "stat": "charisme", "plus": { "reseau": 0.5 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "standing": 14 },
    ...
    { "label": { "fr": "Annoncer votre départ à terme", "en": "Announce you will step down eventually" },
      "effects": { "reputation": 1, "popularity": 7, "standing": -6, "sangfroid": 1 },
  ...
  "choices": [
    { "label": { "fr": "Refuser et le faire savoir", "en": "Refuse, loudly" },
      "effects": { "reputation": 1, "reseau": -1, "standing": 12, "popularity": -4,
                   "notoriete": -1, "landscape": { "self": 0.4 } },
    ...
    { "label": { "fr": "Laisser la porte entrouverte", "en": "Leave the door ajar" },
      "effects": { "sangfroid": 1, "reputation": -1, "standing": -7, "reseau": 2, "notoriete": 1,
                   "landscape": { "self": -0.5, "scene": 0.4 }, "chain": "transfuge_fuite" },
    ...
    { "label": { "fr": "S'en servir pour négocier chez vous", "en": "Use it to bargain at home" },
      "when": { "personality": ["calculating"] },
      "roll": { "base": 14, "stat": "reseau", "plus": { "standing": 0.05 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      ...
      "failure": { "effects": { "standing": -15, "reputation": -1 },
    ...
    { "label": { "fr": "Refuser au nom de vos convictions", "en": "Refuse on principle" },
      ...
      "effects": { "reputation": 2, "appeal": { "self": 9 }, "standing": 12, "reseau": -1, "money": -30000 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Nier en bloc", "en": "Deny everything" },
      "roll": { "base": 16, "stat": "sangfroid",
                "plus": { "reputation": 0.35, "reseau": 0.3, "standing": 0.04 },
                "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2.5 },
                           { "when": { "trait": ["intouchable"] }, "value": 2 },
                           { "when": { "anyTrait": ["traitre", "menteur"] }, "value": -3 } ],
                "dice": 16 },
      "success": { "effects": { "standing": 11, "sangfroid": 1, "reseau": 1, "landscape": { "self": 0.5 } },
      ...
      "failure": { "effects": { "standing": -18, "reputation": -1, "popularity": -8 },
    ...
    { "label": { "fr": "Tout assumer publiquement", "en": "Own it publicly" },
      "effects": { "standing": -8, "reputation": 1, "notoriete": 1, "popularity": 5 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Débaucher deux de ses fidèles", "en": "Poach two of {his} loyalists" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "charisme": 0.35, "money": 0.4 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 12, "reseau": 1, "reputation": -1, "money": -20000 },
      ...
      "failure": { "effects": { "standing": -10, "reputation": -1, "strike": "traitre", "money": -20000 },
    ...
    { "label": { "fr": "L'attendre : {il} finira par se tromper", "en": "Wait: {he} will slip eventually" },
      "effects": { "standing": -3, "sangfroid": 1, "energie": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Écraser tout de suite, avant que la motion ait un titre", "en": "Crush it now, before the motion has a title" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "sangfroid": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 10, "reseau": 1, "reputation": -1, "energie": -3 },
      ...
      "failure": { "effects": { "standing": -11, "reputation": -1, "popularity": -3, "energie": -3 },
    ...
    { "label": { "fr": "{Le} faire entrer à la direction", "en": "Bring {him} into the leadership" },
      "effects": { "standing": -6, "reseau": 1, "credibilite": 1, "sangfroid": 1, "landscape": { "self": 0.6 } },
    ...
    { "label": { "fr": "Convoquer un congrès extraordinaire et trancher devant les militants", "en": "Call a special congress and settle it in front of the members" },
      "when": { "minStanding": 55 },
      "roll": { "base": 15, "stat": "charisme", "plus": { "eloquence": 0.45, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "standing": 13, "credibilite": 1, "notoriete": 1, "energie": -3, "appeal": { "self": 5 } },
      ...
      "failure": { "effects": { "lead": false, "standing": -9, "popularity": -5, "credibilite": -1, "energie": -3 },
    ...
    { "label": { "fr": "Ne rien voir, et travailler", "en": "See nothing, and get on with the work" },
      "effects": { "sangfroid": 1, "credibilite": 1, "standing": -4, "energie": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire le tour des sections, une par une", "en": "Tour the branches, one at a time" },
      "effects": { "standing": 11, "reseau": 1, "energie": -3, "popularity": -2 },
    ...
    { "label": { "fr": "Négocier son retrait contre un poste honorifique", "en": "Trade his withdrawal for an honorary title" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 15 },
    ...
    { "label": { "fr": "Y envoyer quelqu'un à vous", "en": "Send somebody of your own" },
      "effects": { "standing": 6, "reseau": 1, "reputation": -1, "energie": -1 },
    ...
    { "label": { "fr": "Faire les six cents adhérents au téléphone, un par un", "en": "Phone all six hundred members, one at a time" },
      ...
      "effects": { "standing": 14, "reseau": 2, "credibilite": 1, "energie": -5, "popularity": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Obtenir sa bénédiction avant l'annonce", "en": "Get {his} blessing before the announcement" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "standing": 0.05, "charisme": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 14, "reseau": 1, "credibilite": 1, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Aller le chercher sur son terrain", "en": "Take them on their own ground" },
      "roll": { "base": 16, "stat": "eloquence",
                "plus": { "sangfroid": 0.4, "notoriete": 0.25, "popularity": 0.05 },
                "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 },
                           { "when": { "background": ["journalism", "comms", "law"] }, "value": 1.5 },
                           { "when": { "personality": ["provocative"] }, "value": 1.5 },
                           { "when": { "trait": ["zozote"] }, "value": -1.5 } ],
                "dice": 16 },
      "success": { "effects": { "strike": "intrepide", "popularity": 12, "eloquence": 1, "notoriete": 1, "standing": 2, "appeal": { "scene": -9 }, "landscape": { "self": 2.4, "scene": -2.4 } },
      ...
      "failure": { "effects": { "credibilite": -1, "strike": "intrepide", "popularity": -7, "energie": -1, "landscape": { "self": -1.3, "scene": 1.3 } },
    ...
    { "label": { "fr": "Rester courtois et le laisser se découvrir", "en": "Stay courteous and let them expose themselves" },
      "effects": { "credibilite": +1, "reputation": 1, "sangfroid": 1, "popularity": 3, "standing": 3,
                   "notoriete": -1, "appeal": { "self": -6 }, "landscape": { "self": 0.3, "scene": 0.7 } },
      "result": { "fr": "Personne ne retiendra une réplique, ce qui est exactement ce que votre entourage espérait. Le lendemain, les éditorialistes vous trouvent présidentiable, faute de mieux, et son camp sort de l'heure intact, ce que vos militants ont très bien vu.",
    ...
    { "label": { "fr": "Transformer le débat en moment de télévision", "en": "Turn the debate into television" },
      ...
      "effects": { "credibilite": -1, "notoriete": 1, "popularity": 7, "reputation": -1, "standing": -5, "appeal": { "scene": -6 },
    ...
    { "label": { "fr": "Lui proposer un accord en coulisses avant l'antenne", "en": "Offer a backstage deal before you go on air" },
      ...
      "failure": { "effects": { "reputation": -1, "popularity": -5, "landscape": { "scene": 1.5 } },
    ...
    { "label": { "fr": "Se décommander la veille", "en": "Pull out the night before" },
      "when": { "trait": ["lache"] },
      "effects": { "credibilite": -1, "energie": 2, "popularity": -4, "standing": -2, "sangfroid": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Lui offrir une circonscription gagnable", "en": "Offer them a winnable seat" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "charisme": 0.4, "standing": 0.05 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
    ...
    { "label": { "fr": "Refuser de mélanger les familles", "en": "Refuse to mix the families" },
      "effects": { "reputation": 1, "standing": 5, "popularity": -2 },
    ...
    { "label": { "fr": "Lui promettre plus que ce que vous pouvez tenir", "en": "Promise more than you can deliver" },
      "effects": { "notoriete": 1, "reputation": -1, "strike": "menteur",
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Traverser", "en": "Cross the floor" },
      "effects": { "join": "scene", "notoriete": 1 },
    ...
    { "label": { "fr": "Faire monter les enchères des deux côtés", "en": "Run an auction between the two" },
      "when": { "personality": ["calculating"] },
      "roll": { "base": 17, "stat": "reseau", "plus": { "sangfroid": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      ...
      "failure": { "effects": { "standing": -16, "reputation": -1, "strike": "traitre" },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser et rester seul", "en": "Refuse and stand alone" },
      "effects": { "reputation": 1, "popularity": 3, "standing": -4, "appeal": { "scene": -7 } },
    ...
    { "label": { "fr": "Signer, mais aux conditions les plus dures", "en": "Sign, but on the hardest terms" },
      "roll": { "base": 20, "stat": "reseau", "plus": { "eloquence": 0.4, "standing": 0.05 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Retourner l'incident et absorber leur électorat", "en": "Turn it around and absorb their voters" },
      "roll": { "base": 18, "stat": "charisme", "plus": { "eloquence": 0.5, "popularity": 0.06 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 4, "appeal": { "ally": 9 }, "landscape": { "self": 2.6, "ally": -2.6 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Aller les rechercher un par un", "en": "Go and get them back one by one" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "charisme": 0.4, "energie": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
    ...
    { "label": { "fr": "Les accuser d'avoir été achetés", "en": "Accuse them of having been bought" },
      "effects": { "notoriete": 1, "popularity": 4, "reputation": -1, "appeal": { "scene": -6 }, "landscape": { "self": -1.4, "scene": -0.8 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et jouer le jeu jusqu'au bout", "en": "Go, and play along all the way" },
      "effects": { "popularity": 9, "notoriete": 2, "credibilite": -2, "standing": -4 },
    ...
    { "label": { "fr": "Refuser : la fonction ne se prête pas à ça", "en": "Refuse: the office does not lend itself to that" },
      "effects": { "credibilite": 1, "standing": 3, "popularity": -4, "notoriete": -1 },
    ...
    { "label": { "fr": "Négocier de placer une séquence de fond", "en": "Negotiate a serious segment into it" },
      ...
      "roll": { "base": 15, "stat": "reseau", "plus": { "charisme": 0.35 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "popularity": 8, "notoriete": 2, "credibilite": 1, "standing": 1 },
      ...
      "failure": { "effects": { "popularity": 3, "credibilite": -2, "standing": -3 },
    ...
    { "label": { "fr": "Y aller comme chez vous : c'était votre métier", "en": "Go as if it were home: it was your job" },
      ...
      "effects": { "popularity": 12, "notoriete": 2, "credibilite": -1, "reseau": 1 },
    ...
    { "label": { "fr": "Y aller, et retourner l'émission en interview", "en": "Go, and turn the show into an interview" },
      ...
      "roll": { "base": 16, "stat": "eloquence", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 7, "credibilite": 2, "eloquence": 1, "notoriete": 1, "standing": 2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Signer sans lire jusqu'au bout", "en": "Sign without reading to the end" },
      "effects": { "notoriete": 1, "popularity": 2, "credibilite": -1, "reputation": -1 },
    ...
    { "label": { "fr": "Refuser de signer un texte collectif", "en": "Refuse to sign a collective text" },
      "effects": { "credibilite": 1, "reputation": 1, "notoriete": -1, "popularity": -2 },
    ...
    { "label": { "fr": "Réécrire trois paragraphes avant de signer", "en": "Rewrite three paragraphs before signing" },
      ...
      "effects": { "credibilite": 2, "reputation": 1, "reseau": 1, "energie": -1, "notoriete": 1 },
    ...
    { "label": { "fr": "Signer, et amener trente signatures de plus", "en": "Sign, and bring thirty more signatures" },
      ...
      "effects": { "reseau": 2, "popularity": 4, "notoriete": 1, "standing": 2, "energie": -2 },
    ...
    { "label": { "fr": "Signer et faire porter le texte par votre camp", "en": "Sign, and get your side to carry the text" },
      ...
      "roll": { "base": 15, "stat": "reseau", "plus": { "standing": 0.03 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "standing": 6, "notoriete": 2, "credibilite": 1,
                                "landscape": { "self": 0.4 } },
      ...
      "failure": { "effects": { "standing": -4, "reputation": -1, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Demander un rendez-vous à la direction et aux syndicats", "en": "Ask to meet both management and the unions" },
      "effects": { "credibilite": 1, "reseau": 1, "popularity": 1, "notoriete": -1 },
    ...
    { "label": { "fr": "Exiger la réquisition et la nationalisation", "en": "Demand requisition and nationalisation" },
      ...
      "effects": { "axis": {"economy": -90, "power": -60}, "popularity": 8, "standing": 8, "credibilite": -1, "notoriete": 1,
                   "landscape": { "self": 0.4 } },
    ...
    { "label": { "fr": "Convoquer une table ronde avec l'État et la région", "en": "Convene a round table with the state and the region" },
      "when": { "party": ["socdem"] },
      "effects": { "credibilite": 1, "reseau": 2, "standing": 5, "popularity": 3, "energie": -2 },
    ...
    { "label": { "fr": "Demander une mission d'inspection avant toute chose", "en": "Ask for an inspection report before anything else" },
      ...
      "effects": { "credibilite": 2, "standing": 4, "popularity": -5, "reputation": 1 },
    ...
    { "label": { "fr": "Expliquer que l'État n'a pas à financer une entreprise qui perd", "en": "Explain that the state should not fund a loss-making firm" },
      "when": { "party": ["liberals"] },
      "roll": { "base": 15, "stat": "credibilite", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "axis": {"economy": 75}, "credibilite": 2, "standing": 6, "popularity": 7, "reputation": 1 },
    ...
    { "label": { "fr": "Mettre en cause le laisser-faire de l'État sur la filière", "en": "Blame the state for letting the whole sector go" },
      ...
      "effects": { "axis": {"economy": -55}, "popularity": 6, "standing": 5, "credibilite": 1, "approval": -5 },
    ...
    { "label": { "fr": "Dénoncer la délocalisation et la concurrence déloyale", "en": "Denounce offshoring and unfair competition" },
      ...
      "effects": { "axis": {"world": 70, "economy": -30}, "popularity": 9, "standing": 6, "credibilite": -2, "notoriete": 1,
                   "landscape": { "self": 0.5 } },
    ...
    { "label": { "fr": "Organiser la caisse de grève depuis votre réseau", "en": "Organise the strike fund through your own network" },
      "when": { "background": ["activism"] },
      "effects": { "axis": {"economy": -75}, "popularity": 6, "reseau": 2, "standing": -3, "energie": -2, "reputation": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et écouter trois heures sans parler", "en": "Go and listen for three hours without speaking" },
      "effects": { "reputation": 2, "reseau": 1, "energie": -2, "standing": -2 },
    ...
    { "label": { "fr": "Y aller et leur demander leur soutien public", "en": "Go and ask them for a public endorsement" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "reputation": 0.4 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": {"economy": -45, "social": -35}, "popularity": 8, "reseau": 2, "charisme": 1, "notoriete": 1, "standing": 2 },
      ...
      "failure": { "effects": { "popularity": -5, "reputation": -2, "reseau": -1 },
    ...
    { "label": { "fr": "Ne pas y aller : ce n'est plus votre place", "en": "Do not go: it is no longer your place" },
      "effects": { "standing": 3, "energie": 1, "appeal": { "self": -7 }, "reputation": -1 },
    ...
    { "label": { "fr": "Leur proposer de porter leur revendication au Parlement", "en": "Offer to take their demand to Parliament" },
      ...
      "effects": { "popularity": 5, "credibilite": 1, "reseau": 1, "standing": -4, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter et devenir un professionnel", "en": "Accept and turn professional" },
      "roll": { "base": 14, "stat": "reseau", "plus": { "standing": 0.05, "credibilite": 0.25 }, "bonus": [ { "when": { "personality": ["hardworking"] }, "value": 2 }, { "when": { "trait": ["appareil"] }, "value": 2 }, { "when": { "origin": ["bourgeois", "dynasty"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": {"money": 30000, "standing": 10, "reseau": 2, "credibilite": 1, "popularity": -3, "reputation": -1},
      ...
      "failure": { "effects": {"reseau": -1, "standing": -5, "money": -14000, "energie": -2, "reputation": -1},
        "result": { "fr": "Le poste existe six mois, puis la fédération perd sa subvention et le contrat n'est pas renouvelé. Vous avez quitté votre métier pour un travail qui n'a pas duré une année scolaire, et il faut maintenant expliquer ce trou.",
                    "en": "The job lasts six months, then the federation loses its funding and the contract is not renewed. You gave up your profession for work that did not last a school year, and now you have to explain the gap." } } },
    { "label": { "fr": "Refuser et garder votre métier", "en": "Refuse and keep your job" },
      "effects": { "reputation": 2, "credibilite": 1, "energie": -3, "standing": -5 },
    ...
    { "label": { "fr": "Accepter à mi-temps, et le dire", "en": "Accept half-time, and say so" },
      ...
      "effects": { "money": 15000, "standing": 4, "reputation": 1, "energie": -2, "reseau": 1 },
    ...
    { "label": { "fr": "Négocier le poste pour quelqu'un d'autre de l'association", "en": "Negotiate the post for somebody else from the association" },
      "effects": { "reseau": 2, "reputation": 2, "standing": 2, "money": -5000 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Ne pas y toucher", "en": "Do not go near it" },
      "effects": { "reputation": 1, "credibilite": 1, "money": -15000 },
    ...
    { "label": { "fr": "L'embaucher et publier le contrat", "en": "Hire her and publish the contract" },
      ...
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "credibilite": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "money": 45000, "credibilite": 1, "reputation": 1, "notoriete": 1 },
      ...
      "failure": { "effects": { "money": 45000, "reputation": -2, "popularity": -6, "strike": "casserole" },
    ...
    { "label": { "fr": "Faire embaucher par un collègue, réciproquement", "en": "Have a colleague hire her, and return the favour" },
      ...
      "effects": { "money": 40000, "reseau": 1, "reputation": -1, "flags": { "dirtyMoney": true } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout déclarer, à la valeur haute", "en": "Declare everything, at the high valuation" },
      "effects": { "reputation": 2, "credibilite": 1, "money": -70000, "popularity": -3 },
    ...
    { "label": { "fr": "Fermer le compte étranger avant de déclarer", "en": "Close the foreign account before declaring" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "reseau": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "reputation": -2, "popularity": -8, "flags": { "investigated": true }, "trait": "casserole" },
    ...
    { "label": { "fr": "Faire réévaluer le bien de famille par un expert", "en": "Have the family property revalued by an expert" },
      ...
      "effects": { "money": -25000, "credibilite": 1, "reputation": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Démissionner à l'antenne", "en": "Resign on air" },
      "effects": { "office": "none", "popularity": 14, "notoriete": 2, "reputation": 2, "standing": -16, "approval": -9 },
    ...
    { "label": { "fr": "Dire ce que vous pensez sans démissionner", "en": "Say what you think without resigning" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 9, "credibilite": 1, "standing": -8, "approval": -5 },
    ...
    { "label": { "fr": "Retourner la question sur le journaliste", "en": "Turn the question back on the interviewer" },
      ...
      "effects": { "notoriete": 2, "popularity": 4, "credibilite": -1, "standing": 3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Promettre de tout reprendre, sans filtre", "en": "Promise to take up everything, unfiltered" },
      "effects": { "axis": {"social": -45}, "popularity": 8, "credibilite": -1, "approval": 4, "standing": -3 },
    ...
    { "label": { "fr": "Annoncer d'emblée ce qui ne passera pas", "en": "Say up front what will not survive" },
      "effects": { "credibilite": 2, "reputation": 1, "popularity": -5, "approval": -2 },
    ...
    { "label": { "fr": "S'asseoir avec eux les neuf week-ends", "en": "Sit with them for all nine weekends" },
      ...
      "effects": { "popularity": 6, "credibilite": 1, "reputation": 1, "energie": -4, "reseau": 1 },
    ...
    { "label": { "fr": "Y placer des experts qui pensent comme vous", "en": "Place experts who think as you do" },
      ...
      "failure": { "effects": { "popularity": -9, "reputation": -2, "approval": -7, "credibilite": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Corriger la fiche et le dire", "en": "Correct the page and say so" },
      "effects": { "reputation": 1, "credibilite": 1, "popularity": -3, "notoriete": 1, "standing": -5 },
    ...
    { "label": { "fr": "Maintenir que c'est équivalent", "en": "Maintain it is equivalent" },
      "roll": { "base": 16, "stat": "charisme",
                "plus": { "eloquence": 0.35, "notoriete": 0.2, "popularity": 0.04 },
                "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2.5 },
                           { "when": { "background": ["comms", "celebrity"] }, "value": 1.5 },
                           { "when": { "trait": ["intouchable"] }, "value": 1.5 },
                           { "when": { "anyTrait": ["casserole", "menteur"] }, "value": -2.5 } ],
                "dice": 16 },
      "success": { "effects": { "popularity": 6, "standing": 5, "credibilite": 1, "sangfroid": 1, "reputation": -1 },
      ...
      "failure": { "effects": { "popularity": -9, "credibilite": -2, "reputation": -1, "strike": "menteur" },
    ...
    { "label": { "fr": "Raconter pourquoi vous n'avez pas fait ces études", "en": "Explain why you never did those studies" },
      ...
      "effects": { "popularity": 8, "reputation": 2, "credibilite": 1, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre l'arrêté et aller jusqu'au tribunal", "en": "Issue the by-law and go to court" },
      "effects": { "axis": "self", "popularity": 9, "notoriete": 2, "credibilite": -1, "standing": 2, "approval": -3 },
    ...
    { "label": { "fr": "Appliquer, et expliquer pourquoi", "en": "Apply it, and explain why" },
      "effects": { "credibilite": 2, "reputation": 1, "popularity": -6, "standing": 3 },
    ...
    { "label": { "fr": "Prendre l'arrêté avec quarante autres maires", "en": "Issue it alongside forty other mayors" },
      ...
      "roll": { "base": 15, "stat": "reseau", "plus": { "charisme": 0.35 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "popularity": 11, "notoriete": 2, "reseau": 2, "standing": 5,
                                "landscape": { "self": 0.5 } },
      ...
      "failure": { "effects": { "popularity": -4, "reseau": -1, "standing": -5 },
    ...
    { "label": { "fr": "Négocier une dérogation au lieu de désobéir", "en": "Negotiate an exemption instead of disobeying" },
      ...
      "effects": { "credibilite": 1, "reseau": 1, "popularity": 3, "notoriete": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Relayer, avec les mots qu'on vous envoie", "en": "Share it, with the wording you are sent" },
      "effects": { "axis": "self", "popularity": 6, "standing": 4, "reputation": -1, "credibilite": -1 },
    ...
    { "label": { "fr": "Attendre de savoir ce qui s'est passé", "en": "Wait until you know what happened" },
      "effects": { "reputation": 2, "credibilite": 1, "standing": -6, "popularity": -3 },
    ...
    { "label": { "fr": "Publier votre propre texte, plus prudent", "en": "Post your own text, more careful" },
      "roll": { "base": 14, "stat": "eloquence", "plus": { "credibilite": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 4, "credibilite": 1, "reputation": 1, "standing": 1 },
    ...
    { "label": { "fr": "En faire un symbole national dès ce soir", "en": "Make it a national symbol tonight" },
      ...
      "roll": { "base": 14, "stat": "charisme", "plus": { "notoriete": 0.3 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "popularity": 10, "charisme": 1, "notoriete": 1, "standing": 6, "credibilite": -1,
                                "reputation": -1, "landscape": { "self": 0.6 } },
      ...
      "failure": { "effects": { "popularity": -10, "reputation": -2, "credibilite": -1, "strike": "radical" },
    ...
    { "label": { "fr": "Appeler le procureur avant de dire quoi que ce soit", "en": "Call the prosecutor before saying anything" },
      ...
      "effects": { "credibilite": 2, "reputation": 1, "reseau": 1, "standing": -3, "popularity": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Lui laisser les clés, entièrement", "en": "Hand him the keys completely" },
      "roll": { "base": 14, "stat": "reseau", "plus": { "notoriete": 0.3, "sangfroid": 0.25 }, "bonus": [ { "when": { "background": ["comms", "celebrity"] }, "value": 2 }, { "when": { "personality": ["calculating"] }, "value": 1.5 }, { "when": { "personality": ["provocative"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"notoriete": 2, "popularity": 5, "credibilite": -1, "energie": 2},
      ...
      "failure": { "effects": {"notoriete": 1, "popularity": -8, "credibilite": -1, "reputation": -1, "energie": 1},
        "result": { "fr": "Il publie à deux heures du matin une réponse que vous n'auriez jamais écrite, sous votre nom et à votre place. Vous la supprimez quarante minutes plus tard, et les captures existent déjà.",
                    "en": "At two in the morning he posts a reply you would never have written, under your name and in your place. You delete it forty minutes later, and the screenshots already exist." } } },
    { "label": { "fr": "Garder la main, et publier moins", "en": "Keep control, and post less" },
      "effects": { "reputation": 1, "credibilite": 1, "notoriete": -1, "energie": -1 },
    ...
    { "label": { "fr": "Le salarier avant qu'un autre le fasse", "en": "Put him on the payroll before somebody else does" },
      "when": { "minMoney": 60000 },
      "effects": { "money": -55000, "notoriete": 2, "popularity": 5, "reseau": 1 },
    ...
    { "label": { "fr": "Lui apprendre le métier plutôt que l'inverse", "en": "Teach him the trade instead of the reverse" },
      ...
      "effects": { "reseau": 1, "reputation": 1, "notoriete": 1, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Assumer mot pour mot", "en": "Own it word for word" },
      "effects": { "axis": "self", "popularity": 6, "standing": -9, "reputation": 1, "credibilite": 1 },
    ...
    { "label": { "fr": "Parler de méthode et pas de contenu", "en": "Talk about methods, not content" },
      "roll": { "base": 14, "stat": "sangfroid", "plus": { "eloquence": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "popularity": -7, "standing": -6, "credibilite": -1 },
    ...
    { "label": { "fr": "Trouver qui a fait la capture", "en": "Find out who took the screenshot" },
      ...
      "roll": { "base": 15, "stat": "reseau", "plus": { "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "standing": 6, "reputation": -1 },
      ...
      "failure": { "effects": { "reseau": -1, "standing": -5, "strike": "traitre" },
    ...
    { "label": { "fr": "Quitter toutes les boucles, définitivement", "en": "Leave every group chat, for good" },
      "effects": { "reseau": -2, "sangfroid": 1, "reputation": 1, "standing": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Corriger publiquement et passer à autre chose", "en": "Correct it publicly and move on" },
      "effects": { "credibilite": 1, "reputation": 1, "popularity": -2, "standing": -2 },
    ...
    { "label": { "fr": "Attaquer la cellule de vérification", "en": "Attack the fact-checkers" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "notoriete": 0.3 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "popularity": 8, "charisme": 1, "notoriete": 1, "credibilite": -1, "standing": 3 },
      ...
      "failure": { "effects": { "popularity": -6, "credibilite": -2, "reputation": -1 },
    ...
    { "label": { "fr": "Republier le chiffre en le sourçant ligne à ligne", "en": "Repost the figure, sourced line by line" },
      ...
      "effects": { "credibilite": 2, "reputation": 1, "notoriete": 1, "popularity": 1, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Publier la vidéo entière et se taire", "en": "Post the full video and say nothing" },
      "effects": { "credibilite": 1, "reputation": 1, "popularity": -1, "energie": 1,
                   "notoriete": -1, "standing": -2 },
    ...
    { "label": { "fr": "S'excuser pour couper court", "en": "Apologise to end it" },
      "effects": { "popularity": 3, "standing": -5, "reputation": 1, "credibilite": -1, "energie": 2,
                   "appeal": { "self": -7 } },
    ...
    { "label": { "fr": "Répéter la phrase, sans en retirer un mot", "en": "Say it again, without taking back a word" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "sangfroid": 0.35 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "popularity": 9, "charisme": 1, "notoriete": 2, "standing": -4, "reputation": -1,
                                "landscape": { "self": 0.4 } },
      ...
      "failure": { "effects": { "popularity": -11, "standing": -7, "reputation": -1, "strike": "radical" },
    ...
    { "label": { "fr": "Appeler l'un des onze mille et l'écouter", "en": "Call one of the eleven thousand and listen" },
      ...
      "effects": { "popularity": 5, "reputation": 2, "notoriete": 1, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout utiliser, et gagner le temps", "en": "Use all of it, and save the time" },
      "effects": { "energie": 3, "notoriete": 1, "credibilite": -1, "reputation": -1 },
    ...
    { "label": { "fr": "Refuser en bloc et le dire publiquement", "en": "Refuse it all and say so publicly" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "reputation": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "reputation": 2, "popularity": 4, "energie": -2 },
    ...
    { "label": { "fr": "L'utiliser pour analyser, jamais pour écrire", "en": "Use it to analyse, never to write" },
      ...
      "effects": { "credibilite": 1, "reseau": 1, "energie": 2, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller sans notes et sans conseiller", "en": "Go with no notes and no adviser" },
      "roll": { "base": 14, "stat": "charisme", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 11, "charisme": 1, "notoriete": 2, "credibilite": 1, "energie": -2 },
      ...
      "failure": { "effects": { "popularity": -8, "credibilite": -1, "notoriete": 1, "energie": -2 },
    ...
    { "label": { "fr": "Y aller préparé, avec les éléments de langage", "en": "Go prepared, with the talking points" },
      "effects": { "notoriete": 1, "popularity": -2, "credibilite": -1, "standing": 2 },
    ...
    { "label": { "fr": "Refuser : ce n'est pas un lieu politique", "en": "Refuse: it is not a political venue" },
      "effects": { "standing": 3, "credibilite": 1, "notoriete": -1, "popularity": -3 },
    ...
    { "label": { "fr": "Y aller et parler de tout sauf de politique", "en": "Go, and talk about anything but politics" },
      "when": { "trait": ["orateur"] },
      "effects": { "popularity": 13, "notoriete": 3, "credibilite": -1, "standing": -4, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre le rapport et le faire sérieusement", "en": "Take the report and do it properly" },
      "effects": { "trait": "connexions_internationales", "credibilite": 1, "energie": -3, "popularity": -2 },
    ...
    { "label": { "fr": "Le prendre, et le négocier en anglais dans les couloirs", "en": "Take it, and negotiate it in English in the corridors" },
      ...
      "effects": { "trait": "connexions_internationales", "credibilite": 2, "reseau": 2, "notoriete": 1, "energie": -3 },
    ...
    { "label": { "fr": "Le prendre et le déléguer à vos assistants", "en": "Take it and hand it to your assistants" },
      ...
      "failure": { "effects": { "credibilite": -2, "reputation": -1, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tenir la position française jusqu'au bout", "en": "Hold the French position to the end" },
      "effects": { "credibilite": 1, "standing": 5, "energie": -3, "axis": { "world": 45 }, "popularity": 5 },
    ...
    { "label": { "fr": "Construire un compromis avec les deux qui hésitent", "en": "Build a compromise with the two who are hesitating" },
      ...
      "success": { "effects": { "trait": "connexions_internationales", "credibilite": 2, "reseau": 1, "energie": -3 },
      ...
      "failure": { "effects": { "credibilite": -1, "standing": -6, "popularity": -4, "energie": -3 },
    ...
    { "label": { "fr": "Appeler l'Élysée et attendre l'arbitrage", "en": "Call the presidency and wait for a decision" },
      "effects": { "standing": 4, "credibilite": -1, "energie": 1, "reputation": -1 },
    ...
    { "label": { "fr": "Faire jouer ce que vous avez négocié dans le privé", "en": "Use what you negotiated in the private sector" },
      ...
      "effects": { "trait": "connexions_internationales", "credibilite": 1, "reseau": 2, "standing": -3, "energie": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Y mettre cinq cent mille et saturer le terrain", "en": "Put in five hundred thousand and saturate the ground" },
      ...
      "effects": { "money": -500000, "popularity": 11, "notoriete": 2, "score": 7,
                   "landscape": { "self": 0.5 } },
    ...
    { "label": { "fr": "Engager un million et demi, et que cela se sache", "en": "Commit a million and a half, and let it be known" },
      ...
      "roll": { "base": 14, "stat": "credibilite", "plus": { "reputation": 0.4 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "money": -1500000, "popularity": 18, "notoriete": 3, "score": 14,
                                "landscape": { "self": 1.4 } },
      ...
      "failure": { "effects": { "money": -1500000, "popularity": -9, "score": 5, "reputation": -2,
                                "credibilite": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Un club de réflexion, deux dîners par an", "en": "A discussion club, two dinners a year" },
      "effects": { "money": -60000, "reseau": 1, "credibilite": 1 },
    ...
    { "label": { "fr": "Un institut avec trois permanents", "en": "An institute with three full-time staff" },
      ...
      "effects": { "money": -600000, "credibilite": 2, "reseau": 2, "notoriete": 1, "standing": 4 },
    ...
    { "label": { "fr": "Une fondation reconnue, avec un vrai budget", "en": "A recognised foundation, properly funded" },
      ...
      "effects": { "money": -2000000, "credibilite": 3, "reseau": 3, "notoriete": 2, "standing": 8,
                   "landscape": { "self": 0.8 } },
    ...
    { "label": { "fr": "Faire porter le budget par des entreprises", "en": "Have companies carry the budget" },
      ...
      "roll": { "base": 15, "stat": "reseau", "plus": { "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "reseau": 2, "standing": 5, "flags": { "dirtyMoney": true } },
      ...
      "failure": { "effects": { "reputation": -2, "credibilite": -1, "standing": -5, "strike": "casserole" },
    ...
    { "label": { "fr": "Écrire vous-même, sans structure", "en": "Write it yourself, with no structure" },
      ...
      "effects": { "credibilite": 2, "eloquence": 1, "energie": -2, "reseau": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Y mettre un million et demi", "en": "Put in a million and a half" },
      ...
      "success": { "effects": { "money": 3000000, "reseau": 1, "sangfroid": 1 },
      ...
      "failure": { "effects": { "money": -1500000, "sangfroid": -1, "reputation": -1, "chain": "fisc" },
    ...
    { "label": { "fr": "Entrer, mais au nom de quelqu'un d'autre", "en": "Go in, but under somebody else's name" },
      ...
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "reseau": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      ...
      "failure": { "effects": { "money": -400000, "reputation": -2, "flags": { "investigated": true }, "strike": "casserole" },
...

{
  ...
  "choices": [
    { "label": { "fr": "Le forfait, deux cent mille", "en": "The standard package, two hundred thousand" },
      "effects": { "money": -200000, "sangfroid": 1, "credibilite": 1, "energie": 2,
    ...
    { "label": { "fr": "Huit cent mille, et l'équipe complète", "en": "Eight hundred thousand, and the full team" },
      ...
      "effects": { "money": -800000, "flags": { "investigated": false }, "reputation": 1, "sangfroid": 1 },
    ...
    { "label": { "fr": "Ne rien payer et se défendre seul", "en": "Pay nothing and defend yourself" },
      "roll": { "base": 18, "stat": "sangfroid",
                "plus": { "credibilite": 0.4, "eloquence": 0.3, "standing": 0.03 },
                "bonus": [ { "when": { "background": ["law"] }, "value": 4 },
                           { "when": { "legal": 1 }, "value": 2 },
                           { "when": { "legal": 2 }, "value": 2 },
                           { "when": { "trait": ["casserole"] }, "value": -2 } ],
                "dice": 16 },
      "success": { "effects": { "flags": { "investigated": false }, "popularity": 7, "credibilite": 1, "reputation": 1 },
      ...
      "failure": { "effects": { "popularity": -8, "reputation": -1, "flags": { "onTrial": true } },
    ...
    { "label": { "fr": "Appeler le cabinet qui vous doit tout", "en": "Call the firm that owes you everything" },
      ...
      "effects": { "money": -80000, "flags": { "investigated": false }, "reseau": -1, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter : c'est encore de la politique", "en": "Accept: it is still politics" },
      "effects": { "trait": "has_been", "money": 60000, "notoriete": 1, "energie": 1 },
    ...
    { "label": { "fr": "Négocier une chronique sur vos dossiers, pas sur les autres", "en": "Negotiate a slot on your own subjects, not on other people" },
      ...
      "roll": { "base": 15, "stat": "credibilite", "plus": { "notoriete": 0.3 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 1, "notoriete": 1, "money": 40000, "popularity": 3 },
    ...
    { "label": { "fr": "Écrire vos mémoires à la place", "en": "Write your memoirs instead" },
      "when": { "background": ["journalism", "academia"] },
      "effects": { "money": 90000, "reputation": 1, "credibilite": 1, "energie": -2, "popularity": -2 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Reconnaître, s'excuser, et rester", "en": "Admit it, apologise, and stay" },
      "effects": { "trait": "repris_de_justice", "flags": { "onTrial": false }, "reputation": 1, "popularity": 4, "standing": -8 },
    ...
    { "label": { "fr": "Se retirer de la vie publique le temps de la peine", "en": "Withdraw from public life for the duration" },
      "effects": { "trait": "repris_de_justice", "flags": { "onTrial": false }, "office": "none", "energie": 3, "reputation": 2 },
    ...
    { "label": { "fr": "Plaider que le dossier était politique", "en": "Argue the case was political" },
      ...
      "roll": { "base": 15, "stat": "charisme", "plus": { "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "trait": "repris_de_justice", "flags": { "onTrial": false }, "appeal": { "self": 9 }, "standing": 6, "credibilite": -1 },
      ...
      "failure": { "effects": { "trait": "repris_de_justice", "flags": { "onTrial": false }, "popularity": -9, "reputation": -1, "credibilite": -1 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Refuser, et prévenir le président de groupe", "en": "Refuse, and warn the group chairman" },
      "when": { "stat": { "reputation": { "min": 12 } } },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "reseau": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "standing": 5, "reputation": 1 },
      ...
      "failure": { "effects": { "standing": -9, "reseau": -1, "strike": "traitre" },
    ...
    { "label": { "fr": "Refuser, et le raconter en séance", "en": "Refuse, and say it in the chamber" },
      "when": { "personality": ["provocative"] },
      "effects": { "notoriete": 2, "popularity": 6, "standing": -14, "reputation": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tout reconnaître immédiatement", "en": "Admit everything immediately" },
      "effects": { "popularity": -8, "reputation": -1, "standing": -6, "credibilite": 1,
                   "sangfroid": 1 },
    ...
    { "label": { "fr": "Faire jouer vos relations", "en": "Pull some strings" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": -1, "reputation": -1, "standing": 4, "sangfroid": 1 },
      ...
      "failure": { "effects": { "popularity": -14, "reputation": -2, "standing": -10, "flags": { "onTrial": true } },
    ...
    { "label": { "fr": "Se soigner, et le dire", "en": "Get treatment, and say so" },
      "effects": { "untrait": "drogue", "popularity": -3, "reputation": 2, "energie": -4,
                   "credibilite": 1, "standing": -7, "money": -18000 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter les huit pages", "en": "Take the eight pages" },
      "effects": { "trait": "couple_people", "popularity": 7, "notoriete": 2, "credibilite": -1 },
    ...
    { "label": { "fr": "Refuser, et protéger ce qui reste", "en": "Refuse, and protect what is left" },
      "effects": { "reputation": 1, "credibilite": 1, "popularity": -3 },
    ...
    { "label": { "fr": "Accepter, et en faire une séquence politique", "en": "Accept, and turn it into a political sequence" },
      ...
      "roll": { "base": 14, "stat": "charisme", "plus": { "notoriete": 0.3 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "trait": "couple_people", "popularity": 10, "charisme": 1, "notoriete": 1, "standing": 3 },
      ...
      "failure": { "effects": { "trait": "couple_people", "popularity": 6, "credibilite": -2, "standing": -4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Continuer à les recevoir vous-même, tous les samedis", "en": "Keep seeing them yourself, every Saturday" },
      "roll": { "base": 14, "stat": "energie", "plus": { "reputation": 0.3, "reseau": 0.25 }, "bonus": [ { "when": { "personality": ["hardworking"] }, "value": 2.5 }, { "when": { "trait": ["robuste"] }, "value": 1.5 }, { "when": { "trait": ["epuise"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"trait": "ancrage_local", "energie": -2, "popularity": 8, "reseau": 1, "reputation": 1},
      ...
      "failure": { "effects": {"popularity": 2, "energie": -4, "credibilite": -1, "standing": -3, "strike": "epuise"},
        "result": { "fr": "Vous tenez quatorze mois, puis vous vous endormez pendant une réunion de bureau et quelqu'un le raconte. La permanence continue, sans vous, et personne n'ose vous dire que c'était mieux.",
                    "en": "You hold out for fourteen months, then fall asleep in a committee meeting and somebody tells the story. The surgery carries on without you, and nobody dares tell you it works better that way." } } },
    ...
    { "label": { "fr": "Garder un samedi sur deux, et monter à Paris l'autre", "en": "Keep every other Saturday, and go up to Paris on the rest" },
      "when": { "stat": { "energie": { "min": 12 } } },
      "effects": { "reseau": 1, "notoriete": 1, "energie": -1, "popularity": 1 },
  ...
  "choices": [
    { "label": { "fr": "Répondre en anglais, sans filet", "en": "Answer in English, without a net" },
      "roll": { "base": 14, "stat": "credibilite", "plus": { "eloquence": 0.35 },
                ...
                "dice": 16 },
      "success": { "effects": { "trait": "anglais_parfait", "credibilite": 1, "notoriete": 1, "standing": 3 },
      ...
      "failure": { "effects": { "trait": "anglais_mediocre", "credibilite": -1, "notoriete": 1, "popularity": -4 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Défendre le texte, sans reculer d'un mot", "en": "Defend the bill, without conceding a word" },
      "when": { "ruling": true },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "credibilite": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "standing": 8, "appeal": { "self": 8,  "others": -5 }, "approval": -4 },
      ...
      "failure": { "effects": { "credibilite": -1, "standing": -6, "popularity": -14, "approval": -12 },
    ...
    { "label": { "fr": "Défiler avec eux", "en": "March with them" },
      "when": { "ruling": false },
      "effects": { "axis": {"economy": -65}, "popularity": 9, "standing": 4, "notoriete": 1, "approval": -6, "energie": -2 },
    ...
    { "label": { "fr": "Proposer une sortie de crise par la négociation", "en": "Offer a negotiated way out" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "reputation": 0.4 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 1, "credibilite": 2, "reputation": 1, "popularity": 4, "approval": 4 },
      ...
      "failure": { "effects": { "reputation": -1, "standing": -5, "popularity": -4, "energie": -1 },
    ...
    { "label": { "fr": "Aller au service d'ordre du cortège, comme avant", "en": "Join the march stewards, the way you used to" },
      "when": { "background": ["activism"] },
      "effects": { "axis": { "economy": -60, "power": -35 }, "popularity": 8, "reseau": 2,
                   "credibilite": 1, "approval": -5, "standing": -4, "energie": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Expliquer le vrai travail, celui qui ne se compte pas", "en": "Explain the real work, the kind that is not counted" },
      "roll": { "base": 13, "stat": "eloquence", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 15 },
      "success": { "effects": { "credibilite": 1, "popularity": 3, "reputation": 1 },
      ...
      "failure": { "effects": { "popularity": -7, "reputation": -1, "credibilite": -1 },
    ...
    { "label": { "fr": "Aller siéger, tous les jours, pendant six mois", "en": "Sit in the chamber, every day, for six months" },
      "effects": { "credibilite": 1, "reputation": 1, "standing": 3, "energie": -4, "popularity": 2 },
    ...
    { "label": { "fr": "Sortir le décompte de ceux d'en face", "en": "Publish the other side's figures" },
      "effects": { "notoriete": 1, "popularity": -3, "reputation": -1, "standing": -4, "approval": -2 },
...

{
  ...
  "choices": [
    { "label": { "fr": "En remettre une couche devant les caméras", "en": "Double down in front of the cameras" },
      "roll": { "base": 14, "stat": "charisme", "plus": { "eloquence": 0.4 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "charisme": 1, "notoriete": 1, "popularity": 8, "standing": 3, "credibilite": -1, "approval": -3 },
      ...
      "failure": { "effects": { "popularity": -8, "reputation": -1, "credibilite": -1, "standing": -3 },
    ...
    { "label": { "fr": "S'excuser tout de suite, publiquement", "en": "Apologise immediately, in public" },
      "effects": { "reputation": 2, "credibilite": 1, "popularity": -2, "standing": -5 },
    ...
    { "label": { "fr": "Aller lui serrer la main devant les caméras", "en": "Go and shake his hand in front of the cameras" },
      "when": { "personality": ["charming"] },
      "effects": { "popularity": 8, "reputation": 1, "credibilite": 1, "notoriete": 1, "standing": -3 },
    ...
    { "label": { "fr": "Reprendre la phrase en direct, en trente secondes, face caméra", "en": "Take the sentence back live, in thirty seconds, straight to camera" },
      ...
      "effects": { "notoriete": 2, "popularity": 5, "standing": 1, "credibilite": -1, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Voter la consigne", "en": "Follow the whip" },
      "effects": { "standing": 7, "appeal": { "self": -7 }, "reputation": -1 },
    ...
    { "label": { "fr": "Voter contre, et l'assumer chez vous", "en": "Vote against, and own it at home" },
      "effects": { "standing": -12, "appeal": { "self": -7,  "others": 8 }, "reputation": 2, "credibilite": 1 },
    ...
    { "label": { "fr": "S'absenter ce jour-là", "en": "Be absent that day" },
      ...
      "failure": { "effects": { "standing": -6, "popularity": -7, "reputation": -1 },
    ...
    { "label": { "fr": "Négocier un aménagement contre votre voix", "en": "Trade your vote for an amendment" },
      "when": { "minStanding": 52 },
      "effects": { "reseau": 1, "standing": 4, "credibilite": 1, "reputation": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Recevoir les syndicats et lâcher quelque chose", "en": "Receive the unions and give something up" },
      "effects": { "approval": 7, "reseau": 1, "reputation": 1, "standing": -8, "credibilite": -1 },
    ...
    { "label": { "fr": "Tenir, réquisitionner, et attendre", "en": "Hold, requisition, and wait" },
      "roll": { "base": 16, "stat": "sangfroid", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "axis": {"economy": 60}, "approval": 5, "standing": 10, "credibilite": 1, "popularity": 6, "energie": -3 },
    ...
    { "label": { "fr": "Faire porter le sujet par quelqu'un d'autre", "en": "Let somebody else carry it" },
      "effects": { "energie": 2, "standing": -5, "reputation": -1, "approval": -3, "credibilite": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Un texte que la majorité ne peut pas refuser", "en": "A bill the majority cannot refuse" },
      "effects": { "credibilite": 1, "reputation": 1, "standing": 3, "approval": -3, "popularity": 2 },
    ...
    { "label": { "fr": "Un texte qui met la majorité en difficulté", "en": "A bill that puts the majority in trouble" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "eloquence": 0.4, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "axis": "self", "notoriete": 1, "popularity": 6, "standing": 5, "approval": -7 },
    ...
    { "label": { "fr": "Laisser la place à un collègue qui y tient", "en": "Give the slot to a colleague who wants it" },
      "effects": { "reseau": 2, "standing": 4, "popularity": -2, "energie": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller, nuit après nuit", "en": "Do it, night after night" },
      "effects": { "notoriete": 1, "standing": 6, "energie": -4, "popularity": -3, "approval": -4 },
    ...
    { "label": { "fr": "Choisir trois amendements et les défendre vraiment", "en": "Pick three amendments and actually defend them" },
      "roll": { "base": 14, "stat": "eloquence", "plus": { "credibilite": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 2, "reputation": 1, "popularity": 5, "standing": -2, "approval": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Engager la responsabilité du gouvernement", "en": "Put the government's survival on the line" },
      "roll": { "base": 13, "stat": "sangfroid", "plus": { "reseau": 0.4 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "credibilite": 1, "standing": 6, "approval": -8, "popularity": -6, "reputation": -1 },
      ...
      "failure": { "effects": { "credibilite": -1, "standing": -12, "approval": -14, "popularity": -8, "office": "none" },
    ...
    { "label": { "fr": "Retirer le texte et le réécrire", "en": "Withdraw the bill and rewrite it" },
      "effects": { "credibilite": 1, "reputation": 1, "standing": -7, "approval": 3, "energie": -2 },
    ...
    { "label": { "fr": "Aller chercher les voix une par une", "en": "Go and get the votes one by one" },
      "roll": { "base": 16, "stat": "reseau", "plus": { "charisme": 0.35, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 2, "standing": 8, "approval": 5, "credibilite": 1, "energie": -3 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tenir la ligne publiquement", "en": "Hold the line in public" },
      "effects": { "standing": 8, "reputation": 1, "popularity": -7, "approval": 4 },
    ...
    { "label": { "fr": "Prendre vos distances, en termes choisis", "en": "Step back, in carefully chosen terms" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "popularity": 8, "eloquence": 1, "notoriete": 1, "standing": -6, "approval": -4, "appeal": { "self": -7 } },
      ...
      "failure": { "effects": { "popularity": -3, "standing": -11, "reputation": -1, "approval": -5 },
    ...
    { "label": { "fr": "Ne rien dire et travailler vos dossiers", "en": "Say nothing and work your files" },
      "effects": { "credibilite": 1, "energie": 1, "standing": -2, "popularity": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Se poser en recours, dès maintenant", "en": "Present yourself as the alternative, now" },
      "roll": { "base": 15, "stat": "credibilite", "plus": { "charisme": 0.4, "standing": 0.03 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "popularity": 10, "credibilite": 1, "notoriete": 1, "standing": 5,
                                "landscape": { "self": 1.2 } },
      ...
      "failure": { "effects": { "popularity": -6, "standing": -8, "credibilite": -1 },
    ...
    { "label": { "fr": "Tendre la main : proposer une sortie de crise", "en": "Extend a hand: offer a way out of the crisis" },
      "effects": { "reputation": 2, "credibilite": 1, "popularity": 4, "standing": -9, "approval": 6 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Faire tomber le gouvernement", "en": "Bring the government down" },
      ...
      "success": { "effects": { "axis": "self", "notoriete": 2, "popularity": 14, "standing": 8, "approval": -12,
      ...
      "failure": { "effects": { "notoriete": 1, "popularity": -8, "standing": -14, "approval": 5 },
    ...
    { "label": { "fr": "Sauver le gouvernement, voix par voix", "en": "Save the government, vote by vote" },
      "when": { "ruling": true },
      "roll": { "base": 16, "stat": "reseau", "plus": { "sangfroid": 0.4, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "reseau": 2, "standing": 12, "approval": 6, "energie": -3, "popularity": -4 },
...
{
  "id": "sponsoriser_chaine",
  "when": { "partyLead": true, "minMoney": 80000, "minTurn": 8 },
  "tag": { "fr": "L'audience", "en": "The audience" },
  "text": {
    "fr": "Le plus jeune de votre direction pose son téléphone sur la table. Sa note tient en une phrase : le parti dépense encore l'essentiel de son budget de communication là où plus personne de moins de trente-cinq ans ne regarde. Il a trois chaînes en tête, trois devis, et il attend que vous choisissiez laquelle vous financez.",
    "en": "The youngest member of your leadership puts a phone on the table. The note is one sentence long: the party still spends most of its communications budget where nobody under thirty-five is looking. He has three channels in mind, three quotes, and he is waiting for you to say which one you fund."
  },
  "choices": [
    { "label": { "fr": "Une chaîne politique de votre bord, qui travaille sérieusement", "en": "A serious political channel on your side" },
      "when": { "minMoney": 80000 },
      "roll": { "chance": 0.55, "chanceBonus": [ { "when": { "stat": { "credibilite": { "min": 13 } } }, "value": 0.18 },
                                                 { "when": { "background": ["journalism", "academia"] }, "value": 0.12 },
                                                 { "when": { "minStanding": 60 }, "value": 0.1 } ] },
      "success": { "effects": { "money": -50000, "credibilite": 1, "reputation": 1, "appeal": { "self": 4 }, "standing": 2 },
        "result": { "fr": "Deux heures de direct par semaine, des invités qui ne sont pas d'accord entre eux, et un bandeau qui dit d'où vient l'argent. Votre base regarde, prend des notes et répète. C'est un journal de parti, mais il est bon.",
                    "en": "Two hours live a week, guests who disagree with each other, and a banner saying where the money comes from. Your base watches, takes notes and repeats. It is a party paper, but it is a good one." } },
      "failure": { "effects": { "reputation": -1, "appeal": { "others": -3 }, "standing": -2 },
        "result": { "fr": "Ils refusent l'argent et publient le devis. Le message dit qu'une chaîne financée par un parti n'est plus une chaîne, et il est signé par des gens de votre camp, ce qui lui donne toute sa force.",
                    "en": "They turn the money down and publish the quote. The post says that a channel funded by a party stops being a channel, and it is signed by people from your own side, which is what gives it its force." } } },
    { "label": { "fr": "Une chaîne de divertissement, qui touche le plus grand nombre", "en": "An entertainment channel, for the biggest reach" },
      "when": { "minMoney": 200000 },
      "roll": { "chance": 0.5, "chanceBonus": [ { "when": { "comms": 2 }, "value": 0.16 },
                                                { "when": { "stat": { "charisme": { "min": 13 } } }, "value": 0.14 },
                                                { "when": { "background": ["comms", "celebrity"] }, "value": 0.12 } ] },
      "success": { "effects": { "money": -170000, "notoriete": 3, "appeal": { "others": 4 }, "credibilite": -1 },
        "result": { "fr": "Onze minutes au milieu d'une émission qui n'a rien à voir avec la politique, et deux millions de vues en quatre jours. On ne parle pas de votre programme. On parle de vous, ce qui n'est pas la même chose et se compte quand même.",
                    "en": "Eleven minutes in the middle of a show that has nothing to do with politics, and two million views in four days. Nobody talks about your manifesto. They talk about you, which is not the same thing and counts all the same." } },
      "failure": { "effects": { "money": -170000, "credibilite": -1, "appeal": { "others": -3 }, "notoriete": 1 },
        "result": { "fr": "L'animateur vous met en boîte pendant vingt minutes et vous riez avec lui, parce qu'il n'y a rien d'autre à faire. La séquence tourne, découpée, sans le contexte. Votre porte-parole passe la semaine à expliquer que vous saviez très bien où vous alliez.",
                    "en": "The host takes you apart for twenty minutes and you laugh along, because there is nothing else to do. The clip travels, cut, without the context. Your spokesperson spends the week explaining that you knew exactly what you were doing." } } },
    { "label": { "fr": "Refuser : ces choses-là ne marchent pas, et payer une tournée à l'ancienne", "en": "Refuse: none of this works, and pay for an old-fashioned tour" },
      "roll": { "chance": 0.75, "chanceBonus": [ { "when": { "party": ["conservatives"] }, "value": 0.15 },
                                                 { "when": { "origin": ["dynasty"] }, "value": 0.15 },
                                                 { "when": { "stat": { "reseau": { "min": 12 } } }, "value": 0.1 } ] },
      "success": { "effects": { "money": -35000, "standing": 4, "appeal": { "self": 2 }, "energie": -1 },
        "result": { "fr": "Quarante fédérations, un car, des salles municipales et un buffet à chaque étape. Personne n'en parlera jamais nulle part, et les quarante secrétaires départementaux s'en souviendront pendant six ans.",
                    "en": "Forty branches, a coach, town halls and a buffet at every stop. Nobody will ever mention it anywhere, and the forty county secretaries will remember it for six years." } },
      "failure": { "effects": { "money": -35000, "standing": -1, "appeal": { "others": -1 }, "energie": -1 },
        "result": { "fr": "Le car fait ses quarante étapes devant des salles à moitié vides. Le plus jeune de votre direction ne dit rien, et son silence dure jusqu'au bureau politique suivant.",
                    "en": "The coach does its forty stops in front of half-empty rooms. The youngest member of your leadership says nothing, and the silence lasts until the next executive meeting." } } },
    { "label": { "fr": "Une chaîne de montages, pour la génération d'après", "en": "A clip-farm channel, for the next generation" },
      "when": { "minMoney": 80000 },
      "roll": { "chance": 0.52, "chanceBonus": [ { "when": { "maxAge": 45 }, "value": 0.15 },
                                                 { "when": { "background": ["comms", "celebrity"] }, "value": 0.15 },
                                                 { "when": { "personality": ["provocative"] }, "value": 0.12 } ] },
      "success": { "effects": { "money": -30000, "notoriete": 2, "appeal": { "others": 3 }, "credibilite": -1, "reputation": -1 },
        "result": { "fr": "Neuf secondes, une phrase de vous sortie d'un débat de 2019, une musique et un fond qui bouge. Quatre cent mille partages. Des gens qui ne voteront pas avant six ans connaissent votre nom, votre voix et une opinion que vous n'avez jamais eue.",
                    "en": "Nine seconds, one sentence of yours pulled from a 2019 debate, a music bed and a moving background. Four hundred thousand shares. People who will not vote for six years know your name, your voice and an opinion you have never held." } },
      "failure": { "effects": { "money": -30000, "notoriete": 1, "credibilite": -1, "reputation": -2, "appeal": { "others": -4 } },
        "result": { "fr": "Le montage qui marche est celui où l'on vous a coupé au mauvais endroit. Il tourne deux millions de fois, financé par vous, et votre propre chaîne met quatre jours à comprendre qu'elle doit le retirer.",
                    "en": "The clip that works is the one where they cut you in the wrong place. It travels two million times, paid for by you, and your own channel takes four days to work out that it has to take it down." } } },
    { "label": { "fr": "Ne financer personne et le faire vous-même", "en": "Fund nobody and do it yourself" },
      "when": { "background": ["celebrity", "comms"] },
      "roll": { "chance": 0.58, "chanceBonus": [ { "when": { "stat": { "charisme": { "min": 14 } } }, "value": 0.16 },
                                                 { "when": { "stat": { "notoriete": { "min": 14 } } }, "value": 0.14 } ] },
      "success": { "effects": { "money": -20000, "notoriete": 2, "appeal": { "others": 3 }, "standing": -4 },
        "result": { "fr": "Un studio dans une pièce de votre permanence, deux personnes, et vous devant la caméra sans intermédiaire. Vous savez faire, c'est votre ancien métier, et cela se voit. Le bureau politique découvre l'existence de la chaîne en même temps que le pays.",
                    "en": "A studio in one room of your constituency office, two people, and you in front of the camera with nobody in between. You know how, it is your old trade, and it shows. The executive committee learns the channel exists at the same time as the country." } },
      "failure": { "effects": { "money": -20000, "standing": -5, "reputation": -1, "appeal": { "others": -2 } },
        "result": { "fr": "Vous savez faire, mais pas cela, et pas maintenant. Les six premières vidéos sont regardées par des journalistes politiques et par personne d'autre. La septième est un communiqué lu à la caméra, et vous arrêtez.",
                    "en": "You know how, but not this, and not now. The first six videos are watched by political journalists and by nobody else. The seventh is a press release read to camera, and you stop." } } }
  ]
}
];

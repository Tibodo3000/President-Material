...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter le débat", "en": "Take the debate" },
      ...
      "success": { "effects": { "landscape": { "self": 1.2 }, "eloquence": 1, "notoriete": 1, "reputation": 1,
                                "popularity": 14, "standing": 2, "energie": -2, "trait": "orateur" },
    ...
    { "label": { "fr": "Décliner avec dédain", "en": "Decline with disdain" },
      "effects": { "landscape": { "self": -0.5 }, "strike": "lache", "notoriete": -1, "sangfroid": 1,
                   "popularity": -5, "standing": 5, "energie": 2, "credibilite": 1 },
    ...
    { "label": { "fr": "En faire un spectacle", "en": "Turn it into a show" },
      ...
      "roll": { "base": 13, "stat": "charisme", "plus": { "notoriete": 0.5 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "landscape": { "self": -0.6 }, "charisme": 1, "notoriete": 1, "popularity": 13, "reputation": -1 },
      ...
      "failure": { "effects": { "landscape": { "self": -1 }, "reputation": -1, "popularity": -8, "standing": -6 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Répondre par une formule cinglante", "en": "Fire back" },
      ...
      "success": { "effects": { "landscape": { "self": 0.8, "scene": -0.8 }, "eloquence": 1, "notoriete": 1, "popularity": 9, "appeal": { "scene": -8 }, "standing": 3 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Prendre publiquement sa défense", "en": "Publicly defend him" },
      ...
      "effects": { "landscape": { "scene": 0.6 }, "reputation": 2, "popularity": 9, "standing": -5 },
    ...
    { "label": { "fr": "Vérifier les faits avant tout le monde", "en": "Check the facts before anyone else" },
      ...
      "roll": { "base": 13, "stat": "reseau", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "landscape": { "scene": -0.8, "self": 0.5 }, "notoriete": 1, "reputation": 1, "popularity": 7, "appeal": { "scene": -5 }, "standing": 6 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Sceller le pacte", "en": "Seal the pact" },
      "roll": { "base": 15, "stat": "reseau", "plus": { "sangfroid": 0.35, "standing": 0.04 }, "bonus": [ { "when": { "personality": ["calculating"] }, "value": 2 }, { "when": { "trait": ["reseauteur"] }, "value": 1.5 }, { "when": { "trait": ["traitre"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"reseau": 2, "standing": 11, "popularity": -5, "landscape": {"self": 0.6}},
      ...
      "failure": { "effects": {"standing": -9, "reseau": -2, "reputation": -1, "credibilite": -1},
        "result": { "fr": "Le pacte tient six semaines, jusqu'à ce que l'un des deux camps découvre ce que l'autre avait obtenu en plus. Ce n'était pas grand-chose, et cela suffit, parce qu'un pacte de couloir ne survit jamais à sa première asymétrie.",
                    "en": "The pact holds for six weeks, until one of the two camps finds out what the other got on top. It was not much, and it is enough, because a corridor pact never survives its first asymmetry." } } },
    { "label": { "fr": "Refuser et le rendre public", "en": "Refuse and make it public" },
      "effects": { "notoriete": 1, "reputation": 1, "popularity": 11, "standing": -6, "reseau": -2,
                   "appeal": { "scene": -9 }, "landscape": { "self": -0.4, "scene": 0.4 } },
    ...
    { "label": { "fr": "Signer, puis faire fuiter le pacte", "en": "Sign, then leak the pact" },
      ...
      "effects": { "notoriete": 1, "popularity": 7, "standing": -4, "reputation": -1, "strike": "traitre" },

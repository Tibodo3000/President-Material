...

{
  ...
  "choices": [
    { "label": { "fr": "Coller toutes les nuits pendant six semaines", "en": "Fly-post every night for six weeks" },
      "roll": { "base": 14, "stat": "energie", "plus": { "reseau": 0.3, "sangfroid": 0.2 }, "bonus": [ { "when": { "personality": ["hardworking"] }, "value": 2.5 }, { "when": { "trait": ["robuste"] }, "value": 1.5 }, { "when": { "trait": ["fragile"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": {"score": 5, "standing": 7, "energie": -3, "reseau": 1},
      ...
      "failure": { "effects": {"score": 1, "energie": -4, "standing": 2, "popularity": -2},
        "result": { "fr": "Six semaines, huit mille affiches et deux escabeaux pour quatre personnes. Le service de la voirie en retire la moitié pour affichage sauvage et facture le nettoyage à la section, qui n'a pas de trésorerie.",
                    "en": "Six weeks, eight thousand posters and two stepladders between four people. The highways department takes half of them down as illegal flyposting and bills the branch for the cleaning, and the branch has no money." } } },
    { "label": { "fr": "Organiser la section et déléguer", "en": "Organise the branch and delegate" },
      "effects": { "score": 2, "standing": 3, "reseau": 1, "energie": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Défendre le bilan sans une nuance", "en": "Defend the record without a single caveat" },
      "effects": { "score": 4, "credibilite": 1, "popularity": -6, "standing": 5, "energie": -2 },
    ...
    { "label": { "fr": "Prendre vos distances avec le gouvernement", "en": "Put some distance between yourself and the government" },
      "effects": { "score": -4, "popularity": 8, "standing": -9, "reputation": -1, "appeal": { "self": -8 } },
    ...
    { "label": { "fr": "Annoncer trois mesures avant le scrutin", "en": "Announce three measures before the vote" },
      ...
      "failure": { "effects": { "score": -3, "popularity": -8, "credibilite": -1, "standing": -4 },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Faire un discours qu'on retiendra", "en": "Give a speech people will remember" },
      "roll": { "base": 16, "stat": "eloquence", "plus": { "charisme": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 3, "eloquence": 1, "notoriete": 1, "popularity": 10, "standing": -3,
                                "landscape": { "self": 0.6 } },
...

{
  ...
  "choices": [
    ...
    { "label": { "fr": "Négocier plus dur", "en": "Push for a better deal" },
      "roll": { "base": 17, "stat": "reseau", "plus": { "standing": 0.05, "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "score": 5, "standing": 9, "reseau": 1, "credibilite": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller et le porter à bout de bras", "en": "Go, and carry them" },
      "roll": { "base": 15, "stat": "eloquence", "plus": { "credibilite": 0.35, "energie": 0.25 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "personality": ["hardworking"] }, "value": 1.5 }, { "when": { "trait": ["bete_scene"] }, "value": 2 } ], "dice": 16 },
      "success": { "effects": {"score": 5, "standing": 6, "popularity": -3, "energie": -2},
      ...
      "failure": { "effects": {"score": -2, "energie": -3, "popularity": -4, "standing": 2},
        "result": { "fr": "Vous défendez pendant quarante minutes un programme que vous n'avez pas écrit, devant quelqu'un qui l'a lu plus attentivement que vous. La séquence tourne, et c'est votre visage qui est dessus.",
                    "en": "For forty minutes you defend a manifesto you did not write, against somebody who has read it more carefully than you have. The clip travels, and it is your face on it." } } },
    { "label": { "fr": "Y aller et parler surtout de vous", "en": "Go, and mostly talk about yourself" },
      "effects": { "score": -4, "popularity": 8, "notoriete": 1, "standing": -10, "reputation": -1,
                   "landscape": { "self": -0.5 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Y aller avec vos équipes", "en": "Go out with your teams" },
      "roll": { "base": 14, "stat": "charisme", "plus": { "energie": 0.3, "reseau": 0.25 }, "bonus": [ { "when": { "background": ["activism"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 2 }, { "when": { "personality": ["charming"] }, "value": 1.5 } ], "dice": 16 },
      "success": { "effects": {"score": 5, "standing": 4, "popularity": 3, "energie": -2, "reseau": 1},
      ...
      "failure": { "effects": {"score": 1, "energie": -3, "popularity": -2, "standing": -2},
        "result": { "fr": "Quatre cents portes, cent onze réponses et deux conversations qui valaient le déplacement. Le fichier fourni par le siège date de la dernière municipale : un tiers des noms ont déménagé, et deux sont morts.",
                    "en": "Four hundred doors, a hundred and eleven answers and two conversations that were worth the trip. The canvassing list supplied by head office dates from the last local elections: a third of the names have moved, and two have died." } } },
    { "label": { "fr": "Envoyer vos équipes et rester au téléphone", "en": "Send your teams and stay on the phone" },
      "effects": { "score": 1, "reseau": 1, "energie": 1, "standing": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Aller chercher les électeurs des éliminés", "en": "Go after the eliminated candidates' voters" },
      "roll": { "base": 15, "stat": "charisme", "plus": { "reseau": 0.3, "eloquence": 0.25 }, "bonus": [ { "when": { "personality": ["charming"] }, "value": 2 }, { "when": { "trait": ["reseauteur"] }, "value": 1.5 }, { "when": { "trait": ["radical"] }, "value": -2.5 } ], "dice": 16 },
      "success": { "effects": {"score": 6, "standing": 5, "energie": -2, "reputation": -1, "reseau": 1},
      ...
      "failure": { "effects": {"score": -3, "standing": -5, "appeal": {"self": -6}, "energie": -2},
        "result": { "fr": "Vous passez quatre jours à parler à des gens qui viennent de perdre, en leur expliquant que leur défaite est une chance. Deux de leurs cadres le racontent, mot pour mot, et vos propres militants découvrent ce qu'on leur a promis en échange.",
                    "en": "You spend four days talking to people who have just lost, explaining that their defeat is an opportunity. Two of their senior figures repeat it, word for word, and your own activists find out what was promised in exchange." } } },
    ...
    { "label": { "fr": "Préparer l'après, quel que soit le résultat", "en": "Prepare for the aftermath, whatever the result" },
      "effects": { "score": -1, "reseau": 1, "standing": 3, "credibilite": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Le soutenir quand même, publiquement", "en": "Back them anyway, publicly" },
      "effects": { "score": 4, "standing": 9, "reputation": 1, "credibilite": 1, "popularity": -2,
    ...
    { "label": { "fr": "Parler en off, sans se découvrir", "en": "Speak off the record, staying covered" },
      ...
      "success": { "effects": { "score": -2, "standing": 7, "notoriete": 1, "popularity": 4,
                                "landscape": { "self": -0.6 } },
      ...
      "failure": { "effects": { "score": -6, "standing": -14, "reputation": -1, "strike": "traitre",
                                "landscape": { "self": -0.9 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "La lui laisser sans votre nom", "en": "Leave it with him, unsigned" },
      "roll": { "base": 13, "stat": "credibilite", "plus": { "reseau": 0.4 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["clairvoyant"] }, "value": 1.5 }, { "when": { "trait": ["casserole"] }, "value": -1.5 }, { "when": { "trait": ["menteur"] }, "value": -1.5 } ], "dice": 16 },
    ...
    { "label": { "fr": "La publier sous votre nom dans un journal", "en": "Publish it under your own name in a paper" },
      ...
      "success": { "effects": { "score": -2, "eloquence": 1, "notoriete": 1, "popularity": 8, "standing": -9, "credibilite": 1, "appeal": { "self": -6 } },
      ...
      "failure": { "effects": { "score": -5, "standing": -13, "reputation": -1, "strike": "traitre",
                                "landscape": { "self": -0.6 } },
    ...
    { "label": { "fr": "La donner en off à un journaliste", "en": "Hand it to a reporter, off the record" },
      ...
      "success": { "effects": { "score": -3, "notoriete": 1, "standing": 2, "reseau": 1 },
      ...
      "failure": { "effects": { "score": -4, "standing": -11, "reputation": -1, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Verser le double du montant suggéré", "en": "Pay double the suggested amount" },
      ...
      "success": { "effects": { "score": 4, "money": -70000, "standing": 11, "reseau": 1,
                                "landscape": { "self": 0.4 } },
    ...
    { "label": { "fr": "Garder votre argent pour votre propre campagne", "en": "Keep your money for your own campaign" },
      ...
      "failure": { "effects": { "score": -4, "standing": -12, "reputation": -1,
                                "landscape": { "self": -0.5 } },
    ...
    { "label": { "fr": "Trouver l'argent ailleurs, et vite", "en": "Find the money elsewhere, and fast" },
      ...
      "roll": { "base": 17, "stat": "reseau", "plus": { "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "score": 6, "standing": 12, "reseau": 1, "notoriete": 1,
                                "landscape": { "self": 0.6 } },
      ...
      "failure": { "effects": { "score": -2, "standing": -5, "reputation": -1, "energie": -2,
...

{
  ...
  "choices": [
    { "label": { "fr": "Le donner entier", "en": "Hand it over whole" },
      ...
      "failure": { "effects": { "score": 3, "standing": 2, "reseau": -2, "reputation": -1 },
    ...
    { "label": { "fr": "Refuser : c'est votre outil de travail", "en": "Refuse: it is your working tool" },
      ...
      "success": { "effects": { "score": -3, "standing": -3, "reseau": 1, "credibilite": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Prendre les douze secondes", "en": "Take the twelve seconds" },
      ...
      "success": { "effects": { "score": 3, "charisme": 1, "notoriete": 1, "popularity": 6, "standing": -3 },
    ...
    { "label": { "fr": "Les refuser et rester derrière la caméra", "en": "Turn them down and stay behind the camera" },
      ...
      "success": { "effects": { "score": 5, "standing": 6, "reseau": 1, "landscape": { "self": 0.4 } },
      ...
      "failure": { "effects": { "score": -1, "standing": -3, "energie": -2, "notoriete": -1 },
    ...
    { "label": { "fr": "Exiger un plan sur votre bilan municipal", "en": "Demand a shot of your own record" },
      ...
      "success": { "effects": { "score": 1, "popularity": 7, "notoriete": 1, "standing": -6, "credibilite": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Les envoyer tous, et y aller avec eux", "en": "Send them all, and go with them" },
      ...
      "success": { "effects": { "score": 6, "standing": 9, "energie": -3, "reseau": 1,
                                "landscape": { "self": 0.6 } },
...

{
  ...
  "choices": [
    { "label": { "fr": "Le faire fuiter", "en": "Leak it" },
      ...
      "success": { "effects": { "score": -3, "notoriete": 2, "popularity": 11, "standing": -7,
                                "landscape": { "self": -0.5 } },
      ...
      "failure": { "effects": { "score": -7, "standing": -16, "reputation": -1, "strike": "traitre",
                                "landscape": { "self": -0.9 } },
    ...
    { "label": { "fr": "L'apporter vous-même au candidat", "en": "Take it to the candidate yourself" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "credibilite": 0.35 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 5, "standing": 10, "credibilite": 1, "reseau": 1,
                                "energie": -1, "notoriete": -1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Accepter et l'avaler proprement", "en": "Accept, and swallow it cleanly" },
      "roll": { "base": 14, "stat": "eloquence", "plus": { "sangfroid": 0.4 }, "bonus": [ { "when": { "trait": ["orateur"] }, "value": 2 }, { "when": { "trait": ["voix"] }, "value": 1.5 }, { "when": { "trait": ["zozote"] }, "value": -1.5 }, { "when": { "trait": ["anglais_mediocre"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 5, "standing": 9, "reseau": 1, "popularity": -4, "reputation": -1 },
      ...
      "failure": { "effects": { "score": -3, "standing": 3, "popularity": -10, "credibilite": -1,
                                "strike": "menteur" },
    ...
    { "label": { "fr": "Accepter, et ne rien dire du tout", "en": "Accept, and say nothing at all" },
      "when": { "personality": ["calculating"] },
      "roll": { "chance": 0.6, "chanceBonus": [ { "when": { "minStanding": 60 }, "value": 0.2 } ] },
      "success": { "effects": { "score": 2, "standing": 7, "reseau": 1, "credibilite": 1 },
    ...
    { "label": { "fr": "Refuser et le dire à la sortie", "en": "Refuse, and say so on the way out" },
      "roll": { "base": 15, "stat": "reputation", "plus": { "popularity": 0.05 }, "bonus": [ { "when": { "trait": ["intouchable"] }, "value": 2 }, { "when": { "trait": ["casserole"] }, "value": -2 }, { "when": { "trait": ["repris_de_justice"] }, "value": -2 } ], "dice": 16 },
      "success": { "effects": { "score": -2, "popularity": 10, "standing": -8, "credibilite": 1, "appeal": { "self": -6 },
                                "reputation": 1 },
    ...
    { "label": { "fr": "Demander le nom du ministère avant de répondre", "en": "Ask which ministry, before answering" },
      "roll": { "base": 17, "stat": "reseau", "plus": { "standing": 0.05, "sangfroid": 0.3 }, "bonus": [ { "when": { "trait": ["reseauteur"] }, "value": 2 }, { "when": { "trait": ["memoire_des_noms"] }, "value": 1.5 }, { "when": { "trait": ["appareil"] }, "value": 1.5 }, { "when": { "trait": ["renegat"] }, "value": -1.5 } ], "dice": 16 },
      "success": { "effects": { "score": 4, "standing": 12, "reseau": 1, "notoriete": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Tenir jusqu'au bout comme si de rien n'était", "en": "Hold the line to the end as if nothing were happening" },
      "roll": { "base": 15, "stat": "sangfroid", "plus": { "energie": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 4, "standing": 10, "credibilite": 1, "energie": -2,
                                "landscape": { "self": 0.5 } },
    ...
    { "label": { "fr": "Commencer à préparer l'après", "en": "Start preparing for the aftermath" },
      ...
      "success": { "effects": { "score": -3, "standing": 9, "reseau": 2, "credibilite": 1 },
    ...
    { "label": { "fr": "Dire tout haut que c'est perdu", "en": "Say out loud that it is lost" },
      ...
      "success": { "effects": { "score": -4, "popularity": 11, "notoriete": 1, "standing": -10, "appeal": { "self": -11 },
                                "reputation": 1 },
...

{
  ...
  "choices": [
    { "label": { "fr": "Monter au siège et rester derrière la porte le temps qu'il faudra", "en": "Go to headquarters and stay outside that door for as long as it takes" },
      "roll": { "base": 18, "stat": "charisme", "plus": { "reseau": 0.45, "standing": 0.04 }, "bonus": [ { "when": { "trait": ["beau"] }, "value": 1.5 }, { "when": { "trait": ["stature"] }, "value": 1.5 }, { "when": { "trait": ["ingrat"] }, "value": -1.5 }, { "when": { "trait": ["obese"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 4, "standing": 6, "reseau": 1, "credibilite": 1, "energie": -2 },
    ...
    { "label": { "fr": "Réunir le bureau politique et faire annuler l'accord", "en": "Convene the board and have the pact annulled" },
      "when": { "minStanding": 52 },
      "roll": { "base": 18, "stat": "sangfroid", "plus": { "standing": 0.08, "reseau": 0.3 }, "bonus": [ { "when": { "trait": ["teflon"] }, "value": 2 }, { "when": { "trait": ["intrepide"] }, "value": 1.5 }, { "when": { "trait": ["lache"] }, "value": -2 }, { "when": { "trait": ["tete_en_lair"] }, "value": -1 } ], "dice": 16 },
      "success": { "effects": { "score": 3, "standing": 8, "credibilite": 1, "reputation": -1,
                                "landscape": { "self": -1.4 } },
      ...
      "triumph": { "effects": { "score": 4, "standing": 10, "credibilite": 1, "reputation": -1,
    ...
    { "label": { "fr": "Soutenir l'accord publiquement", "en": "Back the pact publicly" },
      "effects": { "score": 5, "standing": -8, "credibilite": -1, "reputation": -1,
    ...
    { "label": { "fr": "Donner à la presse l'heure exacte à laquelle il s'est enfermé", "en": "Give the press the exact time he locked himself in" },
      ...
      "effects": { "score": -5, "standing": -6, "notoriete": 2, "popularity": 6, "reputation": -1,

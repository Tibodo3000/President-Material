...
const translations = {
  ...
  fr: {
    ...
    general_title: "Votre popularité, électorat par électorat. Survolez pour la déclinaison.",
    ...
    seat_bastion_note: "Il tient même quand le camp s'effondre. Personne ne retiendra que vous l'avez gagné",
    seat_ordinaire: "Un siège ordinaire, à disputer",
    seat_ordinaire_note: "Ce qu'on donne à tout le monde : une vraie élection, portée ou coulée par le vent national",
    seat_imprenable: "Une circonscription imprenable",
    seat_imprenable_note: "Il y faudrait une vague. On ne vous en voudra pas d'y échouer, et tout le pays le saura si vous gagnez",
    ...
    force_trend_hint: "Depuis un an, événements compris",
    force_cause_choice: "vos choix",
    force_cause_election: "urnes",
    force_cause_drift: "époque",
    force_support: "Soutient",
    fx_dissolve: "Assemblée dissoute",
    fx_censure: "Gouvernement renversé",
    ...
    /* -- Les verdicts : le mot qui tient en travers d'une soirée -- */
    verdict_win: "Victoire",
    verdict_kept: "Mandat conservé",
    verdict_loss: "Défaite",
    verdict_seat_lost: "Mandat perdu",
    verdict_house_won: "La maison est à vous",
    verdict_house_lost: "La maison vous échappe",
    verdict_runoff_in: "Second tour",
    verdict_out_first: "Fin au premier tour",
    verdict_elysee: "L'Élysée",
    verdict_runoff_lost: "Défaite au second tour",
    verdict_nomination: "Investiture",
    verdict_nomination_lost: "Investiture refusée",
    verdict_large: "Raz-de-marée",
    verdict_narrow: "À quelques centaines de voix",
    verdict_honorable: "Plus haut que votre camp ne vaut ici",
    verdict_rout: "Déroute",
    ...
    score_house: "Ce que la maison vous doit",
    score_legacy: "Ce que vous laissez",
    score_office_short: "Fonction",
    score_ballots_short: "Urnes",
    score_country_short: "Pays",
    score_house_short: "Maison",
    score_legacy_short: "Marques",
    end_meta_years: "{n} ans en politique",
    score_office_detail: "{n} ans de mandat",
    ...
    score_house_down: "le camp a perdu {n} points depuis vos débuts",
    score_house_flat: "le camp pèse ce qu'il pesait à vos débuts",
    score_legacy_detail: "{a} atouts, {m} marques",
    score_legacy_none: "rien qui dépasse",

    rank_boulevard: "Un nom de boulevard",
    rank_figure: "Une figure du régime",
    rank_lourd: "Un poids lourd de la Ve",
    rank_nationale: "Une carrière nationale",
    rank_notable: "Une notabilité locale",
    rank_federation: "Un nom que la fédération connaît",
    rank_organigramme: "Une ligne dans un organigramme",

    end_timeline_title: "La frise",
    frise_office: "{pos}",
    frise_lead_on: "Prend la direction du parti",
    frise_lead_off: "Rend la direction du parti",
    frise_party: "Quitte {from} pour {to}",
    frise_elected: "{elec} · élu",
    frise_elected_as: "{elec} · élu {pos}",
    frise_pres_out: "Présidentielle · éliminé au premier tour, {n} % des voix",
    frise_pres_lost: "Présidentielle · battu au second tour, {n} % des voix",
    frise_president: "{name} ({party}) entre à l'Élysée",
    frise_president_again: "{name} ({party}) est réélu{e}",
    frise_beaten: "{elec} · battu",
    frise_kept: "{elec} · réélu",
    frise_lost_seat: "{elec} · le siège est perdu",
    frise_house_won: "{elec} · la maison est à vous",
    frise_house_lost: "{elec} · la maison change de mains",
    frise_decline_1: "Santé · premiers signes",
    frise_decline_2: "Santé · ce n'est plus de la fatigue",
    frise_decline_3: "Santé · le retrait devient une question de temps",
  ...
  en: {
    ...
    general_title: "Your popularity, electorate by electorate. Hover for the breakdown.",
    ...
    seat_bastion_note: "It holds even when the party collapses. Nobody will remember you won it",
    seat_ordinaire: "An ordinary seat, to be fought for",
    seat_ordinaire_note: "What everyone else gets: a real election, carried or sunk by the national wind",
    seat_imprenable: "An unwinnable constituency",
    seat_imprenable_note: "It would take a wave. Nobody will hold a defeat against you, and the whole country will know if you win",
    ...
    force_trend_hint: "Over the past year, events included",
    force_cause_choice: "your choices",
    force_cause_election: "ballots",
    force_cause_drift: "the times",
    force_support: "Supports",
    fx_dissolve: "Assembly dissolved",
    fx_censure: "Government brought down",
    ...
    /* -- Verdicts: the word that runs across an election night -- */
    verdict_win: "Victory",
    verdict_kept: "Seat held",
    verdict_loss: "Defeat",
    verdict_seat_lost: "Seat lost",
    verdict_house_won: "The house is yours",
    verdict_house_lost: "The house slips away",
    verdict_runoff_in: "Through to the runoff",
    verdict_out_first: "Out in the first round",
    verdict_elysee: "The palace",
    verdict_runoff_lost: "Beaten in the runoff",
    verdict_nomination: "Nominated",
    verdict_nomination_lost: "Nomination refused",
    verdict_large: "A landslide",
    verdict_narrow: "By a few hundred votes",
    verdict_honorable: "Higher than your side is worth here",
    verdict_rout: "A rout",
    ...
    score_house: "What the machine owes you",
    score_legacy: "What you leave behind",
    score_office_short: "Office",
    score_ballots_short: "Ballots",
    score_country_short: "Country",
    score_house_short: "Machine",
    score_legacy_short: "Marks",
    end_meta_years: "{n} years in politics",
    score_office_detail: "{n} years holding office",
    ...
    score_house_down: "the camp lost {n} points since you started",
    score_house_flat: "the camp weighs what it did when you started",
    score_legacy_detail: "{a} assets, {m} marks",
    score_legacy_none: "nothing that sticks out",

    rank_boulevard: "A boulevard will bear your name",
    rank_figure: "A figure of the regime",
    rank_lourd: "A heavyweight of the Republic",
    rank_nationale: "A national career",
    rank_notable: "A local notable",
    rank_federation: "A name the federation knows",
    rank_organigramme: "A line on an org chart",

    end_timeline_title: "The record",
    frise_office: "{pos}",
    frise_lead_on: "Takes the party leadership",
    frise_lead_off: "Gives up the party leadership",
    frise_party: "Leaves {from} for {to}",
    frise_elected: "{elec} · elected",
    frise_elected_as: "{elec} · elected {pos}",
    frise_pres_out: "Presidential · knocked out in the first round on {n}%",
    frise_pres_lost: "Presidential · beaten in the runoff on {n}%",
    frise_president: "{name} ({party}) takes office",
    frise_president_again: "{name} ({party}) is re-elected",
    frise_beaten: "{elec} · beaten",
    frise_kept: "{elec} · re-elected",
    frise_lost_seat: "{elec} · the seat is lost",
    frise_house_won: "{elec} · the house is yours",
    frise_house_lost: "{elec} · the house changes hands",
    frise_decline_1: "Health · first signs",
    frise_decline_2: "Health · no longer just tiredness",
    frise_decline_3: "Health · stepping down is a matter of time",

...
const ENDING_DATA = [
  ...
  /* ---------- Victoires ----------
     Les quatre premières sont d'origine. Les huit suivantes ajoutent la seule
     chose qui manquait : d'où l'on vient. Elles nomment le camp mené à
     l'Élysée, font une phrase au métier de départ, et s'arrêtent là — une fin
     ne raconte pas une péripétie que la partie n'a pas jouée.
     La liste est parcourue dans l'ordre : la générique ferme la marche. */
...

  {
    ...
    "text": {
      "fr": "Vous menez {party_the} à l'Élysée. Vous avez passé quinze ans à commenter les présidents ; ce soir, ce sont vos anciens confrères qui vous tendent le micro.",
      "en": "You take {party_the} to the presidency. You spent fifteen years commenting on presidents; tonight it is your former colleagues holding out the microphone."
    }
  },

  {
    ...
    "text": {
      "fr": "Vous menez {party_the} à l'Élysée. Vous venez du privé, vous avez dit toute la campagne qu'on dirige un pays comme une entreprise, et vous allez découvrir qu'on n'y licencie personne.",
      "en": "You take {party_the} to the presidency. You come from business, you said all campaign that a country is run like a company, and you are about to find out that nobody here can be fired."
    }
  },

  {
    ...
    "text": {
      "fr": "Vous menez {party_the} à l'Élysée. Il existe des photos de vous derrière une banderole devant ce bâtiment ; vous en montez les marches ce soir.",
      "en": "You take {party_the} to the presidency. There are photographs of you behind a banner outside this building; tonight you are walking up its steps."
    }
  },

  {
    ...
    "text": {
      "fr": "Vous menez {party_the} à l'Élysée. Le pays vous appelait par votre prénom avant votre premier meeting, et il vient de vous confier le pays.",
      "en": "You take {party_the} to the presidency. The country was on first-name terms with you before your first rally, and it has just handed you the country."
    }
  },

  {
    ...
    "text": {
      "fr": "Vous menez {party_the} à l'Élysée. Vous avez fait toute votre carrière dans l'administration : vous prenez vos fonctions dans un bâtiment que vous connaissez par cœur.",
      "en": "You take {party_the} to the presidency. You spent your whole career in the civil service: you take office in a building you know by heart."
    }
  },

  {
    ...
    "text": {
      "fr": "Vous menez {party_the} à l'Élysée. Vous avez plaidé pendant vingt ans, et vous héritez de la Constitution.",
      "en": "You take {party_the} to the presidency. You spent twenty years in court, and you have just inherited the constitution."
    }
  },

  {
    ...
    "text": {
      "fr": "Vous menez {party_the} à l'Élysée. Vous aviez écrit un livre sur l'exercice du pouvoir ; vos adversaires en ont un exemplaire annoté sur leur bureau.",
      "en": "You take {party_the} to the presidency. You once wrote a book on the exercise of power; your opponents have an annotated copy on their desks."
    }
  },

  {
    ...
    "text": {
      "fr": "Vous menez {party_the} à l'Élysée. Vous avez fabriqué des campagnes pour d'autres pendant vingt ans, et celle-ci était la vôtre.",
      "en": "You take {party_the} to the presidency. You built campaigns for other people for twenty years, and this one was yours."
    }
  },

  {
    ...
    "text": {
      "fr": "Vous menez {party_the} à l'Élysée. La campagne est finie, et tout le reste commence lundi.",
      "en": "You take {party_the} to the presidency. The campaign is over, and everything else starts on Monday."
    }
  },

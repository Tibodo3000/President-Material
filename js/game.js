...
/* ==========================================================================
   La carte d'ouverture d'un scrutin
   ==========================================================================
   Trois choses, dans cet ordre, et rien d'autre : ce qu'on élit, qui est en
   face, et ce qui se joue pour vous. La troisième est celle qui manquait le
   plus : le joueur découvrait après coup qu'il défendait un siège, ou qu'il
   n'était candidat à rien.
   ========================================================================== */
...
function renderCard() {
  ...
  // L'ouverture d'un scrutin : le premier des deux temps d'une échéance.
  if (card.kind === "scrutin") { renderScrutinCard(host, card); return; }
  ...
  // LA PRÉSIDENTIELLE DES AUTRES, en trois temps puis le dépouillement.
...
function handleClick(event) {
  ...
  if (target.hasAttribute("data-support-count")) {
    const before = snapshot(game);
  ...
  // On entre dans le scrutin qu'on vient de présenter. Le tour ne bouge pas :
  // c'est la même échéance, lue puis jouée.
  if (target.hasAttribute("data-scrutin")) {
